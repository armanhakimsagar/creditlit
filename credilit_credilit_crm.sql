...
--
-- Host: localhost:3306
-- Generation Time: Sep 08, 2025 at 06:24 PM
...
--
-- Database: `credilit_credilit_crm`
--
...
CREATE TABLE `2023` (
  ...
  `birth` varchar(7) DEFAULT NULL,
  `blood` varchar(3) DEFAULT NULL,
  `rel` varchar(5) DEFAULT NULL,
  `admi` varchar(10) DEFAULT NULL,
  ...
  `gname` varchar(28) DEFAULT NULL,
  `gcell` varchar(222) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `2023_n`
--
...
CREATE TABLE `academic_years` (
  ...
  `status` enum('active','cancel','inactive') DEFAULT NULL,
...
INSERT INTO `academic_years` (`id`, `start_date`, `end_date`, `year`, `status`, `is_trash`, `created_at`, `updated_at`, `created_by`, `updated_by`, `is_current`) VALUES
(1, '2018-11-01', '2018-11-29', '2018', 'active', 0, '2022-11-29 06:03:25', '2023-01-05 03:05:26', 1, NULL, 0),
(2, '2019-11-01', '2019-11-29', '2019', 'active', 0, '2019-11-29 06:03:25', '2023-01-05 03:05:26', 1, NULL, 0),
(3, '2020-11-01', '2020-11-29', '2020', 'active', 0, '2020-11-29 06:03:25', '2023-01-05 03:05:26', 1, NULL, 0),
(4, '2022-11-01', '2022-11-29', '2021', 'active', 0, '2022-11-29 06:03:25', '2023-01-05 03:05:26', 1, NULL, 0),
(5, '2022-01-01', '2022-12-31', '2022', 'active', 0, '2022-11-03 11:00:43', '2023-01-05 03:05:26', 1, NULL, 0),
(6, '2023-01-01', '2023-12-31', '2023', 'active', 0, '2022-11-29 06:03:25', '2023-01-05 03:05:26', 1, NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `accountcategorys`
--

CREATE TABLE `accountcategorys` (
  `id` int(10) UNSIGNED NOT NULL,
  `AccountTypeId` int(10) UNSIGNED DEFAULT NULL,
  `TypeName` varchar(191) DEFAULT NULL,
...
--
-- Dumping data for table `accountcategorys`
--

INSERT INTO `accountcategorys` (`id`, `AccountTypeId`, `TypeName`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `is_trash`) VALUES
(1, 1, 'Hand Cash', 'active', 1, NULL, '2020-11-03 00:47:12', '2020-11-03 00:47:12', 0),
(2, 1, 'Mobile Banking', 'active', 1, 1, '2020-11-03 00:47:26', '2022-11-12 21:13:32', 0),
(3, 2, 'Banking system', 'active', 1, NULL, '2022-11-12 19:35:09', NULL, 0),
(4, 2, 'Bkash', 'active', 1, 1, '2022-11-12 21:02:20', '2022-11-12 21:13:39', 0),
(5, 2, 'Cheque', 'active', 1, 1, '2022-11-14 21:41:47', '2022-11-15 15:33:23', 0),
(6, 2, 'Rocket', 'active', 1, NULL, '2022-11-14 21:42:08', NULL, 0);
...
CREATE TABLE `accountlists` (
  ...
  `AccountTypeId` int(10) UNSIGNED DEFAULT NULL,
  `AccountCategoryId` int(10) UNSIGNED DEFAULT NULL,
  `ShortName` varchar(191) DEFAULT NULL,
  `BankName` varchar(191) DEFAULT NULL,
  `BankBranch` varchar(191) DEFAULT NULL,
  `AccountName` varchar(191) DEFAULT NULL,
  `AccountNumber` varchar(191) DEFAULT NULL,
  `ManagedByUserName` varchar(191) DEFAULT NULL,
  `ManagedbyUserId` int(10) UNSIGNED DEFAULT NULL,
  `DefaultOutlet` varchar(191) DEFAULT NULL,
  `status` enum('active','inactive','cancel') DEFAULT NULL,
  `is_trash` int(11) NOT NULL DEFAULT 0,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_by` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Dumping data for table `accountlists`
--

INSERT INTO `accountlists` (`id`, `AccountId`, `AccountTypeId`, `AccountCategoryId`, `ShortName`, `BankName`, `BankBranch`, `AccountName`, `AccountNumber`, `ManagedByUserName`, `ManagedbyUserId`, `DefaultOutlet`, `status`, `is_trash`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'AC-221115-000001', 1, 1, 'Nayeem mia', 'SIBL', 'Uttara, Dhaka', 'deposit', '4654613112', NULL, NULL, NULL, 'active', 1, NULL, 1, NULL, '2022-11-14 22:28:36'),
(2, 'AC-221115-000002', 2, 5, 'masum vai', 'DBBL', 'dhaka', 'dfssadf', '453564565', NULL, NULL, NULL, 'active', 1, 1, NULL, '2022-11-14 22:10:32', NULL),
(3, 'AC-221115-000003', 2, 4, 'Shakil vai', 'SEBL', 'dhaka', 'jdslkflddsf', '4354365456', NULL, NULL, NULL, 'active', 1, 1, NULL, '2022-11-14 22:29:34', NULL),
(4, 'AC-221116-000004', 2, 5, 'Tonmoy Vai', 'SIBL', 'DHAKA', 'rewwer', '453654647', NULL, NULL, NULL, 'active', 1, 1, NULL, '2022-11-16 20:02:06', NULL),
(5, 'AC-230209-000005', 2, 3, 'Jannatul Mawa', 'FISIB', 'Azampur', 'Jannatul Mayoa', '014012600000946', NULL, NULL, NULL, 'active', 0, 1, NULL, '2023-02-09 09:44:22', NULL),
(6, 'AC-230209-000006', 2, 3, 'Saifullah', 'FSIB', 'Azampur', 'Abul Khair Saifullah', '014012600000837', NULL, NULL, NULL, 'active', 0, 1, NULL, '2023-02-09 09:46:27', NULL),
(7, 'AC-230209-000007', 2, 3, 'Sohel', 'FSIB', 'Azampur', 'Sohel Al Mamun', '126-845', NULL, NULL, NULL, 'active', 0, 1, NULL, '2023-02-09 09:47:35', NULL);
...
INSERT INTO `accounttypes` (`id`, `TypeName`, `created_at`, `updated_at`) VALUES
(1, 'Cash', NULL, NULL),
(2, 'Bank', NULL, NULL);
...
CREATE TABLE `addresses` (
  `id` int(11) NOT NULL,
  `address_cat_id` int(11) DEFAULT NULL,
  `contact_id` int(11) DEFAULT NULL,
  `contact_type` int(11) DEFAULT NULL,
  `address_type` enum('care_of','address','mobile','phone','email','fax','website') DEFAULT NULL,
  `value` varchar(255) DEFAULT NULL,
  `value_code` varchar(255) DEFAULT NULL,
  `value_ext` varchar(255) DEFAULT NULL,
...
CREATE TABLE `attendance` (
  ...
  `in_gate_name` varchar(255) DEFAULT NULL,
  `in_time` time DEFAULT NULL,
  `out_gate_name` varchar(255) DEFAULT NULL,
  `out_time` time DEFAULT NULL,
  `type` varchar(255) DEFAULT NULL,
  `contact_type` enum('student','stuff') NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL
...
--
-- Table structure for table `batch_import_table`
--

CREATE TABLE `batch_import_table` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `type` enum('attendance') DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `cash_banks` (
  `id` int(10) UNSIGNED NOT NULL,
  `invoice_date` varchar(68) DEFAULT NULL,
  ...
  `source_flag` varchar(128) DEFAULT NULL,
  `status` enum('active','inactive','cancel') DEFAULT NULL,
...
INSERT INTO `cash_banks` (`id`, `invoice_date`, `invoice_no`, `cheque_no`, `amount`, `payment_type`, `note`, `dealer_id`, `customer_id`, `supplier_id`, `source_flag`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, '14-07-2025', 'INV-250714-600001', NULL, -500.00, 'cash', NULL, 1, NULL, NULL, 'other_expense', 'active', '1', NULL, '2025-07-14 04:47:46', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `cash_banks_version`
--

CREATE TABLE `cash_banks_version` (
  `id` int(10) UNSIGNED NOT NULL,
  `invoice_date` varchar(68) DEFAULT NULL,
  `invoice_no` varchar(128) DEFAULT NULL,
  `cheque_no` varchar(128) DEFAULT NULL,
...
CREATE TABLE `companies` (
  ...
  `studentDefaultItem` text DEFAULT NULL,
  `studentReadmissionDefaultItem` text DEFAULT NULL,
  `ReportFontSizeEnable` int(11) NOT NULL DEFAULT 0,
  `ReportFontSize` int(11) DEFAULT 0,
  `repeatedDefaultItem` varchar(255) DEFAULT NULL,
  `company_name_bn` varchar(255) DEFAULT NULL,
  `principal_details_in_certificate` text DEFAULT NULL,
  `salary_system` enum('1','2') NOT NULL DEFAULT '1' COMMENT '1="Basic To Gross"\r\n2 = "Gross to Basic"',
  `water_pressure_photo` varchar(255) DEFAULT NULL,
  `water_pressure_height` int(11) DEFAULT NULL,
  `water_pressure_margin_top` int(11) DEFAULT NULL,
  `water_pressure_margin_left` int(11) DEFAULT NULL,
  `principle_signature` varchar(255) DEFAULT NULL,
  `principle_signature_height` int(11) DEFAULT NULL,
  `admit_card_design` varchar(255) NOT NULL DEFAULT '1' COMMENT '1="Design for DAMM"\r\n2 ="Design for Innovation"',
  `ownerMobileNumber` text DEFAULT NULL,
  `rollEnableOnAdmitCard` int(11) NOT NULL DEFAULT 0,
  `late_fine_system` enum('1','2') NOT NULL DEFAULT '1' COMMENT '1="Fixed"\r\n2 = "Custom"',
  `enable_multiple_payment` int(11) NOT NULL DEFAULT 0,
  `DefaultPaymentMethod` int(11) DEFAULT NULL,
  `enable_student_type_in_receipt` int(11) NOT NULL DEFAULT 0,
  `studentCollectionSetItem` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dollarExhangeRateBDT` varchar(255) DEFAULT NULL,
  `invoiceVatPercent` varchar(255) DEFAULT NULL,
...
INSERT INTO `companies` (`id`, `company_name`, `address`, `phone`, `email`, `image`, `dealer_id`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `header`, `footer`, `signature`, `data`, `brand_image`, `studentDefaultItem`, `studentReadmissionDefaultItem`, `ReportFontSizeEnable`, `ReportFontSize`, `repeatedDefaultItem`, `company_name_bn`, `principal_details_in_certificate`, `salary_system`, `water_pressure_photo`, `water_pressure_height`, `water_pressure_margin_top`, `water_pressure_margin_left`, `principle_signature`, `principle_signature_height`, `admit_card_design`, `ownerMobileNumber`, `rollEnableOnAdmitCard`, `late_fine_system`, `enable_multiple_payment`, `DefaultPaymentMethod`, `enable_student_type_in_receipt`, `studentCollectionSetItem`, `dollarExhangeRateBDT`, `invoiceVatPercent`, `accountTitle`, `AccountNo`, `bankName`, `branchName`) VALUES
(1, 'CREDILIT LIMITED', '3rd Floor, 37/A, Central Road. Dhanmondi, Dhaka 1205 Bangladesh', '01329734171', 'support@credilit.com', 'CREDILIT-LIMITED_1731488767.svg', NULL, 'active', 1, 1, '2022-12-03 05:14:20', '2024-11-13 09:06:07', NULL, NULL, NULL, NULL, '', '[\"4\"]', '[\"9\",\"10\",\"21\",\"22\",\"23\",\"26\"]', 0, 18, NULL, 'দারুল আজহার মডেল মাদরাসা', '<p><b><span times=\"\" new=\"\" roman\";\"=\"\" style=\"color: rgb(212, 212, 212); letter-spacing: 0.1px;\">﻿</span><span times=\"\" new=\"\" roman\";\"=\"\" style=\"color: rgb(212, 212, 212); letter-spacing: 0.1px;\">﻿</span><span style=\"letter-spacing: 0.1px; color: rgb(0, 0, 0);\">Saif Uddin Ahmed Khondoker</span></b></p><p><span style=\"letter-spacing: 0.1px; color: rgb(0, 0, 0);\"><b> Principal</b></span></p><p><span style=\"letter-spacing: 0.1px; color: rgb(0, 0, 0);\"><b> Darul Azhar Model Madrasah</b></span><br></p>', '2', '', NULL, NULL, NULL, 'principle-signature_1685363272.svg', 35, '1', NULL, 0, '1', 0, NULL, 0, '[\"4\",\"15\"]', '109.30', '15', 'Credilit Limited', '65432134567890', 'Dutch Bangla Bank Limited', 'Kawran Bazar Branch');

-- --------------------------------------------------------

--
-- Table structure for table `companynotificationsettings`
--

CREATE TABLE `companynotificationsettings` (
  `id` int(10) UNSIGNED NOT NULL,
  `CompanyId` int(10) UNSIGNED DEFAULT NULL,
  `smsEnableAfterPayment` int(11) NOT NULL DEFAULT 0,
  `smsEnableGuardianSms` int(11) NOT NULL DEFAULT 0,
  `smsEnableDynamicSms` int(11) NOT NULL DEFAULT 0,
  `smsEnableCustomer` int(10) UNSIGNED NOT NULL,
  `smsAlwaysCustomer` int(10) UNSIGNED NOT NULL,
  `smsSalesCustomer` int(10) UNSIGNED NOT NULL,
  `smsPartialCustomer` int(10) UNSIGNED NOT NULL,
  `smsInstallmentCustomer` int(10) UNSIGNED NOT NULL,
  `smsAfterStudentPaymentFormat` varchar(255) DEFAULT NULL,
  `smsSalesCustomerFormat` varchar(191) DEFAULT NULL,
  `smsPartialCustomerFormat` varchar(191) DEFAULT NULL,
  `smsInstallmentCustomerFormat` varchar(191) DEFAULT NULL,
  `smsEnableSupplier` int(10) UNSIGNED NOT NULL,
  `smsAlwaysSupplier` int(10) UNSIGNED NOT NULL,
  `smsPaymentSupplier` int(10) UNSIGNED NOT NULL,
  `smsPaymentSupplierFormat` varchar(191) DEFAULT NULL,
  `smsEnableOwner` int(10) UNSIGNED NOT NULL,
  `smsAlwaysOwner` int(10) UNSIGNED NOT NULL,
  `smsSalesOwner` int(10) UNSIGNED NOT NULL,
  `smsPartialOwner` int(10) UNSIGNED NOT NULL,
  `smsInstallmentOwner` int(10) UNSIGNED NOT NULL,
  `smsSalesOwnerFormat` varchar(191) DEFAULT NULL,
  `smsPartialOwnerFormat` varchar(191) DEFAULT NULL,
  `smsInstallmentOwnerFormat` varchar(191) DEFAULT NULL,
  `created_by` varchar(50) DEFAULT NULL,
  `updated_by` varchar(50) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `smsEnableTeacherSms` varchar(255) DEFAULT '0',
  `smsEnableDueSms` int(11) DEFAULT 0,
  `smsStudentDueFormat` text DEFAULT NULL,
  `smsEnableOwnerSms` int(11) NOT NULL DEFAULT 0,
  `ownerSmsFormat` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `companynotificationsettings`
--

INSERT INTO `companynotificationsettings` (`id`, `CompanyId`, `smsEnableAfterPayment`, `smsEnableGuardianSms`, `smsEnableDynamicSms`, `smsEnableCustomer`, `smsAlwaysCustomer`, `smsSalesCustomer`, `smsPartialCustomer`, `smsInstallmentCustomer`, `smsAfterStudentPaymentFormat`, `smsSalesCustomerFormat`, `smsPartialCustomerFormat`, `smsInstallmentCustomerFormat`, `smsEnableSupplier`, `smsAlwaysSupplier`, `smsPaymentSupplier`, `smsPaymentSupplierFormat`, `smsEnableOwner`, `smsAlwaysOwner`, `smsSalesOwner`, `smsPartialOwner`, `smsInstallmentOwner`, `smsSalesOwnerFormat`, `smsPartialOwnerFormat`, `smsInstallmentOwnerFormat`, `created_by`, `updated_by`, `created_at`, `updated_at`, `smsEnableTeacherSms`, `smsEnableDueSms`, `smsStudentDueFormat`, `smsEnableOwnerSms`, `ownerSmsFormat`) VALUES
(1, 1, 1, 1, 1, 1, 0, 0, 1, 0, 'Dear Guardian, Amount Received for {StudentName}, as {Items}. Total {PaidAmount}, Remaining Due is {TotalAmount} Taka.\r\n Acc Darul Azhar', 'Dear {Name}, thanks for you payment of {TotalPayment} for the invoice {InvoiceNumber}', 'Dear {Name}. Thanks For Your  Payment Of {TotalPayment} & Your Due {Due}. Invoice {InvoiceNumber}', 'Dear {Name}. Thanks For Your  Payment Of {TotalPayment} & Your Due {Due}. Invoice {InvoiceNumber}. Installment Remain {RemainingInstallemnt}', 0, 0, 0, 'Dear {Name}. You Revived  {TotalPayment} In {PaymentType}.Invoice {InvoiceNumber}. And Remain Due {Due}', 0, 0, 0, 0, 0, 'A payment of {TotalPayment} is received from Mr. {Name} against the invoice {InvoiceNumber}, Due {Due}.', 'A payment of {TotalPayment} is received from Mr. {Name} against the invoice {InvoiceNumber}, Due {Due}.', 'A payment of {TotalPayment} is received from Mr. {Name} against the invoice {InvoiceNumber}, Due {Due}.', '1', '1', '2020-07-16 04:48:51', '2021-04-22 12:23:12', '1', 1, 'মুহতারাম, {Due} টাকা বকেয়া আগামী ২৫ জুলাই এর মধ্যে পরিশোধ করে লেট পেমেন্ট ফি ১০০ জরিমানা পরিহার করার জন্য বিশেষভাবে অনুরোধ করা হচ্ছে। অধ্যক্ষ, DAMM', 1, 'Todays Income and Expense\r\nTotal Receive Tk. {Recieve}\r\nTotal Expense Tk. {Expense}, \r\nBalance Tk.');
...
CREATE TABLE `contacts` (
  `id` int(11) NOT NULL,
  `key_personnel_id` int(11) DEFAULT NULL,
  `contact_id` varchar(255) DEFAULT NULL,
  `first_name` varchar(191) DEFAULT NULL,
  `type` int(11) DEFAULT NULL,
  `address` text DEFAULT NULL,
  `cp_phone_no` varchar(32) DEFAULT NULL,
  `cp_email` varchar(64) DEFAULT NULL,
  `company_name` varchar(255) DEFAULT NULL,
  `education_qualification` varchar(191) DEFAULT NULL,
  ...
  `last_name` varchar(194) DEFAULT NULL,
  ...
  `employee_joining_date` varchar(255) DEFAULT NULL,
  `is_trash` int(11) NOT NULL DEFAULT 0,
  ...
  `fingerprint_card_no` text DEFAULT NULL,
  `fingerprint_card_serial_no` text DEFAULT NULL,
  `marital_status` enum('married','single','divorced','widowed') DEFAULT NULL,
  `spouse_name` varchar(255) DEFAULT NULL,
  `child_name` varchar(255) DEFAULT NULL,
  `current_job_place` varchar(255) DEFAULT NULL,
  `previous_job_place` varchar(255) DEFAULT NULL,
  `bank_id` int(11) DEFAULT NULL,
  `bank_type` enum('centralized','decentralized') DEFAULT NULL,
  `price_same_with_main_bank` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
INSERT INTO `contacts` (`id`, `key_personnel_id`, `contact_id`, `first_name`, `type`, `address`, `cp_phone_no`, `cp_email`, `company_name`, `education_qualification`, `income`, `occupation`, `nid`, `guardian_relation`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `father_name`, `permanent_address`, `last_name`, `full_name`, `date_of_birth`, `birth_certificate`, `nationality`, `blood_group`, `gender`, `religion_id`, `transport_id`, `email`, `photo`, `admission_date`, `employee_department_id`, `employee_designation_id`, `employee_joining_date`, `is_trash`, `mother_name`, `mobile`, `payment_type`, `bank_name`, `bank_account_name`, `bank_account_number`, `fingerprint_card_no`, `fingerprint_card_serial_no`, `marital_status`, `spouse_name`, `child_name`, `current_job_place`, `previous_job_place`, `bank_id`, `bank_type`, `price_same_with_main_bank`) VALUES
(1, NULL, NULL, NULL, 1, '18 Gulshan Avenue, Gulshan 1, Dhaka 1212, Bangladesh', '8809678916207', 'info@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-11-13 18:30:52', '2024-11-13 18:30:52', NULL, NULL, NULL, 'AB BANK PLC', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'decentralized', 0),
(2, 1, NULL, NULL, 2, NULL, '8801671945114', 'didaruz@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-11-13 18:40:13', '2024-11-13 18:40:13', NULL, NULL, NULL, 'Principal Branch', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1),
(3, NULL, NULL, NULL, 4, 'Pancard Club Road, Opp. Swojas Solitaire, Baner, Pune, Maharashtra 411045, India', '912067642900', 'custcare.ph@crif.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-11-13 19:00:24', '2024-12-06 17:34:58', NULL, NULL, NULL, 'Crif', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(4, 1, NULL, NULL, 2, NULL, '8801671945114', 'didaruz@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'cancel', NULL, NULL, '2024-11-14 03:43:37', '2024-11-14 03:43:50', NULL, NULL, NULL, 'Principal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1),
(5, NULL, NULL, NULL, 4, '49a Brecon Road, Abergavenny, United Kingdom, NP7 7RA, United Kingdom', '2127106608', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-11-18 12:20:52', '2024-12-06 17:38:09', NULL, NULL, NULL, 'Dynamic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(6, 2, NULL, NULL, 1, NULL, '88029846966', 'info@mutualtrustbank.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-11-28 12:24:36', '2024-11-28 12:24:36', NULL, NULL, NULL, 'MTB Bank', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'centralized', 0),
(7, 2, NULL, NULL, 2, 'MTB Centre\r\n26 Gulshan Avenue\r\nGulshan-1\r\nDhaka 1212\r\nBangladesh', '01799972514', 'md.omar@mutualtrustbank.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-11-28 12:26:31', '2024-11-28 12:26:31', NULL, NULL, NULL, 'Head Office', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, NULL, NULL),
(8, NULL, NULL, NULL, 4, 'Suite No. 212, DBS, House, 10/2, Picasso Bithi, Mullick Bazar, Park Street area, Kolkata, West Bengal 700017, India', '911126954955', 'info@mnscredit.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-06 17:32:30', '2024-12-06 17:33:12', NULL, NULL, NULL, 'MNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(9, NULL, NULL, NULL, 4, 'Liimi 1C, 10621 Tallinn, Harjumaa, Estonia', '3726233044', 'info@propartner.ee', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-06 17:41:56', '2024-12-06 17:41:56', NULL, NULL, NULL, 'ProPartner', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(10, NULL, NULL, NULL, 4, 'Building 4,Qingdao Soft Park,No.288 Ningxia Road,Shinan District,Qingdao,China,266071.', '8653266715132', 'intsales@gladtrust.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-06 17:43:48', '2024-12-06 17:43:48', NULL, NULL, NULL, 'Gladtrust', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(11, 8, NULL, NULL, 2, NULL, '01911212392', 'iffat@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-08 06:41:00', '2024-12-08 06:41:00', NULL, NULL, NULL, 'Kakrail Branch', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL),
(12, 7, NULL, NULL, 2, NULL, '01721430633', 'jhunu@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-08 06:43:18', '2024-12-08 06:43:18', NULL, NULL, NULL, 'NAWABPUR ROAD BRANCH', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL),
(13, 1, NULL, NULL, 2, NULL, '01819135626', 'ibrahimk@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-08 06:45:17', '2024-12-08 06:45:17', NULL, NULL, NULL, 'Dhanmondi Branch', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL),
(14, 5, NULL, NULL, 2, NULL, '01712381274', 'obaidulh@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-08 06:46:57', '2024-12-08 06:46:57', NULL, NULL, NULL, 'Uttara Branch', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL),
(15, 4, NULL, NULL, 2, NULL, '01711002246', 'quamrun@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-08 06:47:57', '2024-12-08 06:47:57', NULL, NULL, NULL, 'Motijheel', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL),
(16, 3, NULL, NULL, 2, NULL, '01819460192', 'ahowlader@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-08 06:49:16', '2024-12-08 06:49:16', NULL, NULL, NULL, 'Imamganj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL),
(17, 9, NULL, NULL, 2, NULL, '01756049332', 'almamun@abbl.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2024-12-08 06:52:16', '2024-12-08 06:52:16', NULL, NULL, NULL, 'ISLAMI BANKING BRANCH', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL),
(18, 10, NULL, NULL, 1, NULL, '01744948120', 'sample@sample.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2025-07-14 10:42:06', '2025-07-14 10:44:00', NULL, NULL, NULL, 'Sample Bank PLC', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'centralized', 0),
(19, 10, NULL, NULL, 2, '1866/3 Polashi Bhaban, Zahrul Nagar', '01744948120', 'shahoreyermostofa@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2025-07-14 10:46:18', '2025-07-14 10:46:18', NULL, NULL, NULL, 'Dhaka', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 18, NULL, 1),
(20, 1, NULL, NULL, 3, NULL, '01741999999', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2025-07-14 10:47:13', '2025-07-14 10:47:13', NULL, NULL, NULL, 'Sample Company Ltd', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(21, NULL, NULL, NULL, 4, '1866/3 Polashi Bhaban, Zahrul Nagar', '01744948120', 'shahoreyermostofa@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2025-07-14 10:47:43', '2025-07-14 10:47:43', NULL, NULL, NULL, 'GladTrust', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `contactwise_item_discount_price_list`
--

CREATE TABLE `contactwise_item_discount_price_list` (
  `id` int(11) NOT NULL,
  `academic_year_id` int(11) DEFAULT NULL,
  `class_id` int(11) DEFAULT NULL,
  `contact_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `actual_amount` double(10,2) DEFAULT NULL,
  `discount_amount` double(10,2) DEFAULT NULL,
  `amount` double(10,2) DEFAULT NULL,
  `affected_month` text DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `enum_month_id` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `contactwise_item_discount_price_list_version`
--

CREATE TABLE `contactwise_item_discount_price_list_version` (
  `id` int(11) NOT NULL,
  `academic_year_id` int(11) DEFAULT NULL,
  `class_id` int(11) DEFAULT NULL,
  `contact_id` int(11) DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `enum_month_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `contact_academics`
--

CREATE TABLE `contact_academics` (
  `id` int(11) NOT NULL,
  `contact_id` int(11) DEFAULT NULL,
  `class_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `contact_hierarchy`
--

CREATE TABLE `contact_hierarchy` (
  `id` int(11) NOT NULL,
  `status` enum('active','inactive','cencel') DEFAULT NULL,
  `parent_hierarchyid` int(11) DEFAULT NULL,
  `hierarchy_type` enum('1','2','3') DEFAULT NULL,
  `source_contactid` int(11) DEFAULT NULL,
  `target_contact` int(11) DEFAULT NULL,
  `relationship_type_nodeid` int(11) DEFAULT NULL,
...
--
-- Table structure for table `contact_payable_items`
--

CREATE TABLE `contact_payable_items` (
  `id` int(11) NOT NULL,
  `contact_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `class_id` int(11) DEFAULT NULL,
  ...
  `is_trash` int(11) DEFAULT 0,
  `generated_payable_list_id` int(11) DEFAULT NULL,
  `contact_discount_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- --------------------------------------------------------

--
-- Table structure for table `contact_payable_items_version`
--

CREATE TABLE `contact_payable_items_version` (
  `id` int(11) NOT NULL,
  `contact_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `class_id` int(11) DEFAULT NULL,
...
INSERT INTO `customer_pricing` (`id`, `product_id`, `customer_category_id`, `territory_id`, `customer_id`, `academic_year_id`, `class_id`, `price`, `dealer_id`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `effective_date`) VALUES
(1, 1, NULL, NULL, 1, NULL, NULL, 55, NULL, 'active', 1, NULL, '2024-11-13 20:15:03', NULL, NULL),
(2, 2, NULL, NULL, 1, NULL, NULL, 68, NULL, 'active', 1, NULL, '2024-11-13 20:15:03', NULL, NULL),
(3, 3, NULL, NULL, 1, NULL, NULL, 88, NULL, 'active', 1, NULL, '2024-11-13 20:15:03', NULL, NULL),
(4, 1, NULL, NULL, 2, NULL, NULL, 55, NULL, 'active', 1, NULL, '2024-11-13 20:15:03', NULL, NULL),
(5, 2, NULL, NULL, 2, NULL, NULL, 68, NULL, 'active', 1, NULL, '2024-11-13 20:15:03', NULL, NULL),
(6, 3, NULL, NULL, 2, NULL, NULL, 88, NULL, 'active', 1, NULL, '2024-11-13 20:15:03', NULL, NULL),
(7, 1, NULL, NULL, 18, NULL, NULL, 55, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(8, 2, NULL, NULL, 18, NULL, NULL, 68, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(9, 3, NULL, NULL, 18, NULL, NULL, 88, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(10, 4, NULL, NULL, 18, NULL, NULL, 55, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(11, 5, NULL, NULL, 18, NULL, NULL, 42, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(12, 6, NULL, NULL, 18, NULL, NULL, 4, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(13, 7, NULL, NULL, 18, NULL, NULL, 77, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(14, 1, NULL, NULL, 19, NULL, NULL, 55, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(15, 2, NULL, NULL, 19, NULL, NULL, 68, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(16, 3, NULL, NULL, 19, NULL, NULL, 88, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(17, 4, NULL, NULL, 19, NULL, NULL, 55, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(18, 5, NULL, NULL, 19, NULL, NULL, 42, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(19, 6, NULL, NULL, 19, NULL, NULL, 4, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL),
(20, 7, NULL, NULL, 19, NULL, NULL, 77, NULL, 'active', 1, NULL, '2025-07-14 10:49:41', NULL, NULL);
...
--
-- Table structure for table `due_generated`
--

CREATE TABLE `due_generated` (
  `id` int(11) NOT NULL,
  `class_id` int(11) NOT NULL,
  `month_id` int(11) NOT NULL,
  `academic_year_id` int(11) NOT NULL,
  `type` enum('1','2') NOT NULL COMMENT '1 = Due,\r\n2 = Late Fine',
  `created_by` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `due_generated_setting`
--

CREATE TABLE `due_generated_setting` (
  `id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `month_id` text DEFAULT NULL,
  `class_id` text DEFAULT NULL,
  `generated_type` int(11) DEFAULT NULL COMMENT '1= all student,\r\n2 = Setup student',
...
--
-- Table structure for table `due_generated_setting_history`
--

CREATE TABLE `due_generated_setting_history` (
  `id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `month_id` text DEFAULT NULL,
  `class_id` text DEFAULT NULL,
...
--
-- Table structure for table `due_import`
--

CREATE TABLE `due_import` (
  `id` int(11) NOT NULL,
  `sid` varchar(255) DEFAULT NULL,
  `due21` int(11) DEFAULT NULL,
  `due22` int(11) DEFAULT NULL,
  `due_contact_id` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `employee_payroll` (
  ...
  `academic_year_id` int(11) DEFAULT NULL,
  `month_id` int(11) DEFAULT NULL,
  `is_disbursed` int(11) NOT NULL DEFAULT 0,
  `status` enum('active','cancel','inactive') NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `total_salary` double(10,2) DEFAULT NULL,
  `generate_payroll_id` int(11) DEFAULT NULL,
  `gross_salary` double(10,2) DEFAULT NULL,
  `basic_salary` double(10,2) DEFAULT NULL,
  `deduction_salary` double(10,2) DEFAULT NULL,
  `other_salary` double(10,2) DEFAULT NULL,
  `allowance_salary` double(10,2) DEFAULT NULL,
  `payment_type` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
--
-- Table structure for table `employee_payroll_item_details`
--

CREATE TABLE `employee_payroll_item_details` (
  `id` int(11) NOT NULL,
  `employee_id` int(11) DEFAULT NULL,
  `payroll_id` int(11) DEFAULT NULL,
  `salary_id` int(11) DEFAULT NULL,
  `item_id` int(11) DEFAULT NULL,
  `amount_type` enum('flat','percentage') DEFAULT NULL,
  `amount` double(10,2) DEFAULT NULL,
...
CREATE TABLE `employee_salary` (
  ...
  `deduction_salary` double(10,2) NOT NULL,
  `other_salary` double(10,2) DEFAULT NULL,
  `allowance_salary` double(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
--
-- Table structure for table `employee_salary_item_details`
--

CREATE TABLE `employee_salary_item_details` (
  `id` int(11) NOT NULL,
  `employee_id` int(11) DEFAULT NULL,
  `salary_id` int(11) DEFAULT NULL,
  `item_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `employee_salary_item_details_version`
--

CREATE TABLE `employee_salary_item_details_version` (
  `id` int(11) NOT NULL,
  `employee_id` int(11) DEFAULT NULL,
  `salary_id` int(11) DEFAULT NULL,
  `employee_salary_item_details_id` int(11) DEFAULT NULL,
  `item_id` int(11) DEFAULT NULL,
  `amount_type` enum('flat','percentage') DEFAULT NULL,
  `amount` double(10,2) DEFAULT NULL,
  `total_amount` double(10,2) DEFAULT NULL,
...
--
-- Table structure for table `employee_salary_version`
--

CREATE TABLE `employee_salary_version` (
  `id` int(11) NOT NULL,
  `contact_id` int(11) DEFAULT NULL,
  `gross_salary` double(10,2) DEFAULT NULL,
  `total_salary` double(10,2) DEFAULT NULL,
...
--
-- Table structure for table `enum_address_category`
--

CREATE TABLE `enum_address_category` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_by` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Dumping data for table `enum_address_category`
--

INSERT INTO `enum_address_category` (`id`, `name`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'Home', NULL, NULL, NULL, NULL),
(2, 'Work', NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `enum_contact_type`
--

CREATE TABLE `enum_contact_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `enum_contact_type`
--

INSERT INTO `enum_contact_type` (`id`, `name`, `created_at`, `updated_at`) VALUES
(1, 'Bank', '2022-10-19 05:53:26', '2022-10-19 05:53:26'),
(2, 'Branch', '2022-10-19 05:53:26', '2022-10-19 05:53:26'),
(3, 'Company', '2022-10-19 05:54:37', '2022-10-19 05:54:37'),
(4, 'Supplier', '2022-10-19 05:54:37', '2022-10-19 05:54:37');

-- --------------------------------------------------------

--
-- Table structure for table `enum_department_types`
--

CREATE TABLE `enum_department_types` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `enum_department_types`
--

INSERT INTO `enum_department_types` (`id`, `name`, `created_at`, `updated_at`, `is_trash`, `status`, `created_by`, `updated_by`) VALUES
(1, 'Administration', NULL, '2023-07-13 14:54:23', 0, 'active', NULL, 1),
(2, 'Faculty', NULL, '2023-07-13 14:56:59', 1, 'active', NULL, 1),
(3, 'Staff', NULL, '2023-07-13 14:58:16', 1, 'active', NULL, 1),
(4, 'Urdu', NULL, NULL, 1, 'active', NULL, NULL),
(5, 'Science', NULL, NULL, 1, 'active', NULL, NULL),
(6, 'Arts', NULL, NULL, 1, 'active', NULL, NULL),
(7, 'Operation Team', '2024-02-15 00:06:05', NULL, 0, 'active', 1, NULL),
(8, 'Management Team', '2024-02-15 00:06:38', NULL, 0, 'active', 1, NULL),
(9, 'Marketing Team', '2024-02-15 00:06:52', NULL, 0, 'active', 1, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `enum_employee_types`
--

CREATE TABLE `enum_employee_types` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `enum_employee_types`
--

INSERT INTO `enum_employee_types` (`id`, `name`, `created_at`, `updated_at`, `status`, `is_trash`, `created_by`, `updated_by`) VALUES
(1, 'Teacher', NULL, '2023-07-13 15:25:21', 'active', 0, NULL, 1),
(2, 'IT Officer', NULL, '2023-07-13 15:30:22', 'active', 0, NULL, 1),
(3, 'Staff', NULL, '2023-07-13 15:25:09', 'active', 0, NULL, 1),
(4, 'Principal', NULL, '2023-07-13 15:25:33', 'active', 0, NULL, 1),
(5, 'Admin Officer', NULL, '2023-07-16 16:33:54', 'active', 0, NULL, 1),
(6, 'Advisor', NULL, '2023-07-13 15:25:57', 'active', 0, NULL, 1),
(7, 'Arabic Teacher', NULL, '2023-07-13 15:26:08', 'active', 0, NULL, 1),
(8, 'Science Sr. Teacher', NULL, '2023-07-13 15:23:10', 'active', 0, NULL, 1),
(9, 'English Teacher', NULL, '2023-07-13 15:26:25', 'active', 0, NULL, 1),
(10, 'Science Teacher', NULL, '2023-07-13 15:26:38', 'active', 0, NULL, 1),
(11, 'Math Teacher', NULL, '2023-07-13 15:26:49', 'active', 0, NULL, 1),
(12, 'Hifz Teacher', NULL, '2023-07-13 15:23:45', 'active', 0, NULL, 1),
(13, 'Nazera Teacher', NULL, '2023-07-13 15:24:26', 'active', 0, NULL, 1),
(14, 'Qari Teacher', NULL, '2023-07-13 15:24:53', 'active', 0, NULL, 1),
(15, 'Driver', NULL, '2023-07-13 15:27:01', 'active', 0, NULL, 1),
(16, 'Guard', NULL, '2023-07-13 15:27:11', 'active', 0, NULL, 1),
(17, 'Ass. Chef', NULL, '2023-07-13 15:27:28', 'active', 0, NULL, 1),
(18, 'Chief Chef', NULL, '2023-07-13 15:27:38', 'active', 0, NULL, 1),
(19, 'Cleaner', NULL, '2023-07-13 15:27:51', 'active', 0, NULL, 1),
(20, 'Account Officer', NULL, '2023-07-13 15:28:03', 'active', 0, NULL, 1),
(21, 'Kitchen Cleaner', NULL, '2023-07-13 15:28:19', 'active', 0, NULL, 1),
(22, 'English Spoken', NULL, '2023-07-13 15:28:42', 'active', 0, NULL, 1),
(23, 'Arabic Spoken', '2023-07-13 15:29:08', NULL, 'active', 0, 1, NULL),
(24, 'Arabic Sr. Teacher', '2023-07-13 15:31:09', NULL, 'active', 0, 1, NULL),
(25, 'Sr. Teacher', '2023-07-16 16:28:20', NULL, 'active', 0, 1, NULL),
(26, 'Sr. Teacher (Asst. Coordinator)', '2023-07-16 16:30:42', NULL, 'active', 0, 1, NULL),
(27, 'Arabic Asst. Teacher', '2023-07-16 17:09:58', NULL, 'active', 0, 1, NULL),
(28, 'Asst. Teacher', '2023-07-16 17:29:40', NULL, 'active', 0, 1, NULL),
(29, 'Office Assistant', '2023-07-17 16:15:14', NULL, 'active', 0, 1, NULL),
(30, 'Helping Teacher', '2023-07-17 16:25:56', NULL, 'active', 0, 1, NULL),
(31, 'Hostel Super', '2023-07-17 16:30:45', NULL, 'active', 0, 1, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `enum_month`
--

CREATE TABLE `enum_month` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `enum_month`
--

INSERT INTO `enum_month` (`id`, `name`, `created_at`, `updated_at`, `short_name`) VALUES
(1, 'January', NULL, NULL, 'Jan'),
(2, 'February', NULL, NULL, 'Feb'),
(3, 'March', NULL, NULL, 'Mar'),
(4, 'April', NULL, NULL, 'Apr'),
(5, 'May', NULL, NULL, 'May'),
(6, 'June', NULL, NULL, 'Jun'),
(7, 'July', NULL, NULL, 'Jul'),
(8, 'August', NULL, NULL, 'Aug'),
(9, 'September', NULL, NULL, 'Sep'),
(10, 'October', NULL, NULL, 'Oct'),
(11, 'November', NULL, NULL, 'Nov'),
(12, 'December', NULL, NULL, 'Dec');

-- --------------------------------------------------------

--
-- Table structure for table `enum_node_type`
--

CREATE TABLE `enum_node_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `enum_node_type`
--

INSERT INTO `enum_node_type` (`id`, `name`, `created_at`, `updated_at`) VALUES
(1, 'Location', NULL, NULL),
(2, 'POsition', NULL, NULL),
(3, 'Organization', NULL, NULL),
(4, 'Location Type', NULL, NULL),
(5, 'Customer Category', NULL, NULL),
(6, 'Relation', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `enum_participant_type`
--

CREATE TABLE `enum_participant_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `enum_relation_of_node_type`
--

CREATE TABLE `enum_relation_of_node_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `enum_relation_type_node_type`
--

CREATE TABLE `enum_relation_type_node_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `enum_sms_type`
--

CREATE TABLE `enum_sms_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `enum_sms_type`
--

INSERT INTO `enum_sms_type` (`id`, `name`, `created_at`, `updated_at`) VALUES
(1, 'Dynamic SMS', '2022-10-19 05:53:26', '2022-10-19 05:53:26'),
(2, 'Guardian SMS', '2022-10-19 05:53:26', '2022-10-19 05:53:26'),
(3, 'Teacher SMS', '2022-10-19 05:54:37', '2022-10-19 05:54:37'),
(4, 'Due SMS', '2022-10-19 05:54:37', '2022-10-19 05:54:37'),
(5, 'Payment SMS', '2022-10-19 05:54:37', '2022-10-19 05:54:37'),
(6, 'Resend SMS', '2022-10-19 05:54:37', '2022-10-19 05:54:37');
...
CREATE TABLE `exams` (
  ...
  `percentage_for_final` varchar(191) DEFAULT NULL,
  `class_id` int(10) UNSIGNED DEFAULT NULL,
  ...
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_by` int(10) UNSIGNED DEFAULT NULL,
  `is_trash` int(10) UNSIGNED NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TABLE `exam_types` (
  ...
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_by` int(10) UNSIGNED DEFAULT NULL,
  `is_trash` int(10) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TABLE `february` (
  ...
  `bank_acc` varchar(15) DEFAULT NULL,
  `gross` varchar(9) DEFAULT NULL,
  `allowance` varchar(9) DEFAULT NULL,
  `payable` varchar(11) DEFAULT NULL,
  `pf` varchar(6) DEFAULT NULL,
  `advanced` varchar(16) DEFAULT NULL,
  `stduy` varchar(12) DEFAULT NULL,
  `loan` varchar(8) DEFAULT NULL,
  `total_laon` varchar(7) DEFAULT NULL,
  `extra` varchar(14) DEFAULT NULL,
...
INSERT INTO `genders` (`id`, `name`, `status`, `created_at`, `updated_at`, `created_by`, `updated_by`, `is_trash`) VALUES
(1, 'Male', 'active', '2022-11-16 06:32:29', '0000-00-00 00:00:00', NULL, NULL, 0),
(2, 'Female', 'active', '2022-11-16 06:32:37', '0000-00-00 00:00:00', NULL, NULL, 0);
...
INSERT INTO `general` (`id`, `name`, `designation`, `bank_acc`, `gross`, `allowance`, `payable`, `pf`, `advanced`, `stduy`, `loan`, `total_laon`, `extra`, `net_salary`, `employee_id`, `designation_id`) VALUES
(1, 'Khondoker Ibrahim Joshim', 'Admin', '', '36000', '', '36000', '', NULL, '', NULL, '', '', '-2000', 6998, NULL),
(2, 'Sohel Al Mamun', 'Account Officer', '014012600000845', '17000', '', '17000', ' 1000', NULL, '', NULL, '', '', '16000', 6883, NULL),
(3, 'Mirza Zerin Sultana', 'Teacher', '014012600000173', '12000', '', '12000', ' 1000', NULL, '', NULL, '', '', '11000', 7004, NULL),
(4, 'Mrs Umme Habiba Sultana', 'Teacher', '014012600000170', '16000', '', '16000', ' 2000', NULL, '', NULL, '', '', '14000', 7002, NULL),
(5, 'Azizul Haque', 'Teacher', '014012600000174', '12000', '', '12000', ' 500 ', NULL, '', NULL, '', '', '11500', 7006, NULL),
(6, 'Rafikul Islam', 'Teacher', '014012600000823', '10000', '', '10000', ' 500 ', NULL, '', NULL, '', '', '9500', 7203, NULL),
(7, 'Mustafizur Rahman', 'Teacher', '014012600000830', '11000', '', '11000', ' 500 ', NULL, '', NULL, '', '', '10500', 7204, NULL),
(8, 'Jannatul Ferdous', 'Teacher', '014012600000964', '10000', '', '10000', ' 500 ', NULL, '', NULL, '', '', '9500', 7205, NULL),
(9, 'Md. Osman Gani', 'Teacher', '014012600000831', '18000', '', '18000', ' 500 ', NULL, '', NULL, '', '', '14500', 7007, NULL),
(10, 'Tasnim Jahan', 'Teacher', '014012600000973', '9000', '', '9000', ' 500 ', NULL, '', NULL, '', '', '8500', 7206, NULL),
(11, 'Tahmina Akter', 'Teacher', '014012600000947', '13000', '', '13000', ' 1000', NULL, '', NULL, '', '', '12000', 7010, NULL),
(12, 'Akbor Hossain', 'Teacher', '014012600000820', '12000', '', '12000', ' 500 ', NULL, '', NULL, '', '', '11500', 7207, NULL),
(13, 'Sonia AKter', 'Teacher', '014012600000971', '9000', '', '9000', ' 500 ', NULL, '', NULL, '', '', '8500', 7208, NULL),
(14, 'Jannatul Mayoa', 'Teacher', '014012600000946', '11000', '', '11000', ' 500 ', NULL, '', NULL, '', '', '10500', 7209, NULL),
(15, 'Md. Oli Uddin Bayezid', 'Teacher', '014012600000955', '13000', '', '13000', ' 1000', NULL, '', NULL, '', '', '12000', 7210, NULL),
(16, 'Hafez Kazi Zohirul Islam', 'Teacher', '014012600000840', '10000', '', '10000', ' 500 ', NULL, '', NULL, '', '', '9500', 7211, NULL),
(17, 'Mst. Motahara Parvin', 'Teacher', '014012600000957', '8000', '', '8000', ' 500 ', NULL, '', NULL, '', '', '6500', 7212, NULL),
(18, 'Shakhawat Hossain', 'Teacher', '014012600000839', '12500', '', '12500', ' 500 ', NULL, '', NULL, '', '', '12000', 7213, NULL),
(19, 'Abul Khair Saifullah', 'Teacher', '014012600000837', '11000', '', '11000', ' 500 ', NULL, '', NULL, '', '', '10500', 7214, NULL),
(20, 'Hadiul Islam', 'Teacher', '014012600000974', '15000', '', '15000', ' 1000', NULL, '', NULL, '', '', '14000', 7215, NULL),
(21, 'Md. Tanzil Alam', 'Teacher', '014012600000966', '12000', '', '12000', ' 1000', NULL, '', NULL, '', '', '11000', 7216, NULL),
(22, 'Shah Paran Maruf', 'Teacher', '014012600000829', '10000', '', '10000', ' 1000', NULL, '', NULL, '', '', '9000', 7217, NULL),
(23, 'Shamima Akter', 'Teacher', '014012600000942', '10000', '', '10000', ' 1000', NULL, '', NULL, '', '', '9000', 7218, NULL),
(24, 'Arzu Begum', 'Teacher', '014012600000982', '7000', '', '7000', ' 500 ', NULL, '', NULL, '', '', '6500', 7219, NULL),
(25, 'Md Abdullah', 'Teacher', '014012600000936', '10500', '', '10500', ' 500 ', NULL, '', NULL, '', '', '10000', 7220, NULL),
(26, 'Mohammad Abu Saleh', 'Teacher', '014012600000943', '12000', '', '12000', ' 1000', NULL, '', NULL, '', '', '6000', 7221, NULL),
(27, 'Dil Afrose Hredoy', 'Teacher', '014012600000944', '9000', '', '9000', ' 500 ', NULL, '', NULL, '', '', '6500', 7222, NULL),
(28, 'Zannatul Ferdous', 'Teacher', '014012600000939', '10000', '', '10000', ' 1000', NULL, '', NULL, '', '', '9000', 7011, NULL),
(29, 'Mohammad Riazul Shikdar', 'Teacher', '014012600000954', '12000', '', '12000', ' 500 ', NULL, '', NULL, '', '', '9500', 7224, NULL),
(30, 'Swarna Akter', 'Teacher', '014012600000965', '6000', '', '6000', ' 500 ', NULL, '', NULL, '', '', '5500', 7265, NULL),
(31, 'Mossammat Shuhada Akthar', 'Teacher', '014012600000959', '10000', '', '10000', ' 500 ', NULL, '', NULL, '', '', '8500', 7226, NULL),
(32, 'Hafez Al Amin', 'Teacher', '014012600000958', '12000', '', '12000', ' 500 ', NULL, '', NULL, '', '', '11500', 7227, NULL),
(33, 'Muslima Khanom', 'Teacher', '014012600001004', '6000', '', '6000', ' 500 ', NULL, '', NULL, '', '', '5500', 7228, NULL),
(34, 'Kari Mehdi Hassan Noman', 'Teacher', '014012600000952', '10000', '', '10000', ' 500 ', NULL, '', NULL, '', '', '9500', 7229, NULL),
(35, 'Hafiz Arafat Hossain', 'Teacher', '014012600000956', '10000', '', '10000', ' 1000', NULL, '', NULL, '', '', '9000', 7230, NULL),
(36, 'Md. Ashraf Ali', 'Teacher', '014012600000941', '10000', '', '10000', ' 500 ', NULL, '', NULL, '', '', '6500', 7231, NULL),
(37, 'Md. Boshir', 'Teacher', '014012600000976', '15000', '', '15000', ' 1000', NULL, '', NULL, '', '', '14000', 7232, NULL),
(38, 'Mansora Khatun', 'Teacher', '014012600000940', '10000', '', '10000', ' 1000', NULL, '', NULL, '', '', '9000', 7233, NULL),
(39, 'Zayeda Yasmin Sharlin', 'Teacher', '014012600000975', '9000', '', '9000', ' 500 ', NULL, '', NULL, '', '', '8500', 7234, NULL),
(40, 'Najmin Begum', 'Teacher', '014012600000950', '7000', '', '7000', '', NULL, '', NULL, '', '', '7000', 7235, NULL),
(41, 'Hafeza Rabeya Akter', 'Teacher', '', '11000', '', '11000', ' 500 ', NULL, '', NULL, '', '', '10500', 7236, NULL),
(42, 'Nuruzzaman', 'Teacher', '014012600000953', '11000', '', '11000', '', NULL, '', NULL, '', '', '8000', 7237, NULL),
(43, 'Ayasha Akter', 'Teacher', '014012600000968', '8000', '', '6800', ' 500 ', NULL, '', NULL, '', '', '7500', 7240, NULL),
(44, 'Esmat Jarin', 'Teacher', '014012600000969', '8000', '', '8000', ' 500 ', NULL, '', NULL, '', '', '7500', 7241, NULL),
(45, 'Sayma Yasmin', 'Teacher', '014012600000967', '8000', '', '8000', ' 500 ', NULL, '', NULL, '', '', '7500', 7242, NULL),
(46, 'Farjana Akther Dipa', 'Teacher', '014012600000962', '10000', '', '8000', ' 500 ', NULL, '', NULL, '', '', '9500', 7243, NULL),
(47, 'Sazida Yousuf Minha', 'Teacher', '014012600000970', '8000', '', '10000', ' 500 ', NULL, '', NULL, '', '', '7500', 7244, NULL),
(48, 'Md. Wahidul Islam', 'Teacher', '014012600000972', '15000', '', '8000', '', NULL, '', NULL, '', '', '15000', 7245, NULL),
(49, 'Md. Mostafizur Rahman Mazumder', 'Hostel Super', '014012600000945', '12000', '', '15000', ' 1000', NULL, '', NULL, '', '', '11000', 7266, NULL),
(50, 'Shautha', 'Teacher', '014012600000938', '9000', '', '12000', ' 1000', NULL, '', NULL, '', '', '8000', 7246, NULL),
(51, 'Md. Maynuddin', 'Teacher', '014012600000951', '12000', '', '9000', ' 500 ', NULL, '', NULL, '', '', '11500', 7267, NULL),
(52, 'Sabeya Sultana Liza', 'Teacher', '014012600000948', '6000', '', '12000', '', NULL, '', NULL, '', '', '6000', 7248, NULL),
(53, 'Anwar Hossain Azhari', 'Teacher', '', '25000', '', '6000', '', NULL, '', NULL, '', '', '25000', 7261, NULL),
(54, 'Md. Rasel Billah', 'Teacher', '014012600000981', '12000', '', '25000', '500', NULL, '', NULL, '', '', '11500', 7263, NULL),
(55, 'Ekramul Islam', 'Eng. Spoken', '', '10000', '', '12000', '', NULL, '', NULL, '', '', '10000', 7250, NULL),
(56, 'Monir Hossain', 'Eng. Spoken', '', '10000', '', '10000', '', NULL, '', NULL, '', '', '10000', 7251, NULL),
(57, 'Md. Mehedi Hasan', 'Driver', '014012600000181', '22000', '', '10000', '', NULL, '', NULL, '', '', '22000', 7238, NULL),
(58, 'Jakir Hossain', 'Staff', '014012600000977', '10000', '', '22000', '', NULL, '', NULL, '', '', '10000', 7252, NULL),
(59, 'Abdur Razzak', 'Guard', '014012600000979', '13000', '', '10000', '1000', NULL, '', NULL, '', '', '10000', 7253, NULL),
(60, 'Reyazul Islam', 'Ass. Chef', '014012600000978', '12000', '', '13000', '', NULL, '', NULL, '', '', '13000', 7254, NULL),
(61, 'Abdur Rahman', 'Chief Chef', '', '16000', '', '12000', '1000', NULL, '', NULL, '', '', '14000', 7255, NULL),
(62, 'Anour Hosen', 'Staff', '014012600000963', '15000', '', '16000', ' 500 ', NULL, '', NULL, '', '', '8000', 7256, NULL),
(63, 'Baby', 'Cleaner', '014012600000980', '7000', '', '15000', '500', NULL, '', NULL, '', '', '6500', 7257, NULL),
(64, 'Rashedul  Haque', 'Driver', '', '15000', '', '7000', '1500', NULL, '', NULL, '', '', '13500', 7259, NULL),
(65, 'Helal', 'Cleaner', '', '6000', '', '2000', '', NULL, '', NULL, '', '', '6000', 7268, NULL),
(66, 'Iqbal Hossain', 'Cleaner', '', '9000', '', '15000', '500', NULL, '', NULL, '', '', '8500', 7269, NULL),
(67, 'Baizid', 'Cleaner', '', '9000', '', '6000', '500', NULL, '', NULL, '', '', '8500', 7262, NULL);
...
--
-- Table structure for table `generateinvoices`
--

CREATE TABLE `generateinvoices` (
  `id` int(11) NOT NULL,
  `invoiceNo` varchar(255) NOT NULL,
  `invoiceDate` varchar(255) NOT NULL,
  `invoiceOrderId` varchar(5000) NOT NULL,
  `customer_id` int(11) DEFAULT NULL,
  `customer_type` enum('bank','branch','company') DEFAULT NULL,
  `total_amount` float NOT NULL DEFAULT 0,
  `paid_amount` float NOT NULL DEFAULT 0,
  `due_amount` float NOT NULL DEFAULT 0,
  `usdToBdt` float NOT NULL,
  `vat` float NOT NULL,
  `paymentStatus` enum('due','paid') DEFAULT 'due',
  `paymentDate` timestamp NULL DEFAULT NULL,
  `paymentCreateBy` int(11) NOT NULL,
  `is_trash` int(11) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `generateinvoices`
--

INSERT INTO `generateinvoices` (`id`, `invoiceNo`, `invoiceDate`, `invoiceOrderId`, `customer_id`, `customer_type`, `total_amount`, `paid_amount`, `due_amount`, `usdToBdt`, `vat`, `paymentStatus`, `paymentDate`, `paymentCreateBy`, `is_trash`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, '2025072679', '14 July 2025', '[\"24\"]', 18, 'bank', 4.6, 0, 4.6, 109.3, 15, 'due', NULL, 0, 0, '2025-07-14 10:58:33', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `generate_payable_list`
--

CREATE TABLE `generate_payable_list` (
  `id` int(11) NOT NULL,
  `academic_year_id` int(11) DEFAULT NULL,
  `month_id` int(11) DEFAULT NULL,
  `class_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `generate_payroll`
--
...
CREATE TABLE `gifts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `is_trash` int(11) NOT NULL DEFAULT 0,
  `status` enum('active','inactive','cancel') NOT NULL DEFAULT 'active'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `gift_type` (`id`, `name`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `is_trash`) VALUES
(1, 'Seasonals', 'active', 1, 1, '2024-01-06 19:48:51', '2024-01-06 19:55:45', 0),
(2, 'Yearly', 'active', 1, NULL, '2024-01-06 19:48:51', NULL, 0);
...
--
-- Table structure for table `head_items_account_settings_30_november_2022`
--

CREATE TABLE `head_items_account_settings_30_november_2022` (
...
--
-- Table structure for table `impr_attendance_table`
--

CREATE TABLE `impr_attendance_table` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `punch_date` date DEFAULT NULL,
  `card_no` text NOT NULL,
  ...
  `is_validate` enum('0','1') NOT NULL DEFAULT '1',
...
INSERT INTO `key_personnel` (`id`, `first_name`, `address`, `cp_phone_no`, `cp_email`, `nid`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `father_name`, `last_name`, `full_name`, `date_of_birth`, `nationality`, `blood_group`, `gender`, `photo`, `is_trash`, `mother_name`, `marital_status`, `spouse_name`, `child_name`, `current_job_place`, `previous_job_place`) VALUES
(1, 'Md.', 'Principal Branch, 30-31, Dilkusha C/A, Dhaka 1000, Bangladesh', '8801671945114', 'didaruz@abbl.com', NULL, 'active', NULL, NULL, '2024-11-13 18:38:58', '2024-11-28 12:41:47', NULL, 'Didaruzzaman', 'Md. Didaruzzaman', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, NULL, 'single', NULL, NULL, NULL, NULL),
(2, 'Omar', NULL, '01799972514', 'md.omar@mutualtrustbank.com', NULL, 'active', NULL, NULL, '2024-11-28 12:22:21', '2024-11-28 12:22:21', '-', 'Faruk', 'Omar Faruk', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, '-', 'single', NULL, NULL, NULL, NULL),
(3, 'Abdul Hannan', 'Imamganj Branch, 40, Imamganj, Dhaka 1100, Bangladesh', '8801819460192', 'ahowlader@abbl.com', NULL, 'active', NULL, NULL, '2024-11-28 12:33:14', '2024-11-28 12:33:14', NULL, 'Howlader', 'Abdul Hannan Howlader', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, NULL, 'single', NULL, NULL, NULL, NULL),
(4, 'Quamrun', 'Motijheel Branch, BDBL Building, 08 DIT Avenue, Dhaka 1000, Bangladesh', '8801711002246', 'quamrun@abbl.com', NULL, 'active', NULL, NULL, '2024-11-28 12:34:07', '2024-11-28 12:34:07', NULL, 'Nahar', 'Quamrun Nahar', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, NULL, 'single', NULL, NULL, NULL, NULL),
(5, 'MOHAMMAD OBAIDUL', 'Uttara Branch, House 11, Road 14D, Sector 4, Uttara, Dhaka 1230, Bangladesh', '8801712381274', 'obaidulh@abbl.com', NULL, 'active', NULL, NULL, '2024-11-28 12:35:09', '2024-11-28 12:35:09', NULL, 'HOQUE', 'MOHAMMAD OBAIDUL HOQUE', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, NULL, 'single', NULL, NULL, NULL, NULL),
(6, 'Md. Ibrahim', 'Dhanmondi Branch, Plot: 45 (new) 286/B (old), Road: 16 (new) 27 (old), Dhaka 1207, Bangladesh', '8801819135626', 'ibrahimk@abbl.com', NULL, 'active', NULL, NULL, '2024-11-28 12:35:58', '2024-11-28 12:35:58', NULL, 'Khalil', 'Md. Ibrahim Khalil', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, NULL, 'single', NULL, NULL, NULL, NULL),
(7, 'Khairunnahar', 'Nawabpur Branch, Nawabpur Tower, 198-202 Nawabpur Road, Nawabpur, Dhaka 1100, Bangladesh', '8801721430633', 'jhunu@abbl.com', NULL, 'active', NULL, NULL, '2024-11-28 12:39:57', '2024-11-28 12:39:57', NULL, 'Jhunu', 'Khairunnahar Jhunu', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, NULL, 'single', NULL, NULL, NULL, NULL),
(8, 'Iffat', 'Kakrail Branch, 81, VIP Road, Dhaka 1000, Bangladesh', '8801911212392', 'iffat@abbl.com', NULL, 'active', NULL, NULL, '2024-11-28 12:40:51', '2024-11-28 12:40:51', NULL, 'Jahan', 'Iffat Jahan', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, NULL, 'single', NULL, NULL, NULL, NULL),
(9, 'A.K.M Al-Mamun', NULL, '01756049332', 'almamun@abbl.com', NULL, 'active', NULL, NULL, '2024-12-08 06:51:16', '2024-12-08 06:51:16', NULL, NULL, 'A.K.M Al-Mamun ', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, NULL, 'single', NULL, NULL, NULL, NULL),
(10, 'Md Shahoreyer', NULL, '01744948120', NULL, NULL, 'active', NULL, NULL, '2025-07-14 10:43:14', '2025-07-14 10:43:14', 'Md MD', 'Mostofa', 'Md Shahoreyer Mostofa', NULL, 'Bangladeshi', NULL, 'male', 'profile.png', 0, 'MST Mst', 'single', NULL, NULL, NULL, NULL);
...
CREATE TABLE `late_fines` (
  ...
  `fine_item_id` int(11) DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `mark_attribute`
--

CREATE TABLE `mark_attribute` (
  `id` int(11) NOT NULL,
  `name` varchar(191) DEFAULT NULL,
  `status` enum('active','cancel','inactive') NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `mark_configs` (
  ...
  `mark_attribute_id` int(11) DEFAULT NULL,
  `total_mark` varchar(191) DEFAULT NULL,
...
(136, '2019_11_27_040657_create_divisions_table', 1),
(137, '2019_11_27_040723_create_districts_table', 1),
(138, '2019_11_27_040803_create_upazilas_table', 1),
(139, '2019_12_14_000001_create_personal_access_tokens_table', 1),
(140, '2021_09_13_035432_create_unions_table', 1),
(141, '2022_10_16_115529_create_exam_types_table', 1),
(142, '2022_10_16_160329_create_exams_table', 1),
(143, '2022_11_07_160230_create_permission_tables', 1);
...
--
-- Table structure for table `monthly_class_item`
--

CREATE TABLE `monthly_class_item` (
  `id` int(11) NOT NULL,
  `class_id` int(11) DEFAULT NULL,
  `academic_year_id` int(11) NOT NULL,
...
--
-- Table structure for table `monthly_class_item_version`
--

CREATE TABLE `monthly_class_item_version` (
  `id` int(11) NOT NULL,
  `class_id` int(11) DEFAULT NULL,
  `academic_year_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  ...
  `flag` varchar(255) DEFAULT NULL,
  `month_id` int(11) DEFAULT NULL,
  `monthly_class_item_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `msgnotificationsents`
--

CREATE TABLE `msgnotificationsents` (
  `id` int(10) UNSIGNED NOT NULL,
  `CompanyId` int(10) UNSIGNED DEFAULT NULL,
  `CustomerId` int(10) UNSIGNED DEFAULT NULL,
  `SupplierId` int(10) UNSIGNED DEFAULT NULL,
  `MobileNumbers` varchar(191) DEFAULT NULL,
  `SentMessage` text DEFAULT NULL,
  `NumberOfMessage` varchar(191) DEFAULT NULL,
  `IsSent` int(10) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `nodes` (
  ...
  `description` longtext DEFAULT NULL,
  `display_status` enum('active','inactive','cancel','draft','expired') DEFAULT NULL,
  `access_type` enum('public','authenticated','restricted') DEFAULT NULL,
  `node_type` int(11) DEFAULT NULL,
  `start_date` datetime DEFAULT NULL,
  `end_date` datetime DEFAULT NULL,
  `url` text DEFAULT NULL,
  `disklocation` text DEFAULT NULL,
  `json_data` longtext DEFAULT NULL,
  `code` text DEFAULT NULL,
  `display_id` text DEFAULT NULL,
  `node_type_id` int(11) DEFAULT NULL,
  `category_term_id` int(11) DEFAULT NULL,
  `weight` int(11) NOT NULL DEFAULT 1,
  `version` int(11) NOT NULL DEFAULT 1,
  `created_date` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
...
INSERT INTO `nodes` (`id`, `isTrashed`, `parent_nodeid`, `name`, `description`, `display_status`, `access_type`, `node_type`, `start_date`, `end_date`, `url`, `disklocation`, `json_data`, `code`, `display_id`, `node_type_id`, `category_term_id`, `weight`, `version`, `created_date`, `created_by`, `last_modified_date`, `last_modified_by`) VALUES
(1, 0, NULL, 'Father', NULL, 'active', NULL, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL),
(2, 0, NULL, 'Mother', NULL, 'active', NULL, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL),
(3, 0, NULL, 'Guardian', NULL, 'active', NULL, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `node_edges`
--

CREATE TABLE `node_edges` (
  `id` int(11) NOT NULL,
  `status` enum('active','inactive','cancel') DEFAULT NULL,
  `source_nodeid` int(11) DEFAULT NULL,
  `target_nodeid` int(11) DEFAULT NULL,
  `contact_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `invoice_id` int(11) DEFAULT NULL,
  `edge_type` enum('1','2','3') DEFAULT NULL,
  `access_type` enum('public','authenticated','restricted') DEFAULT NULL,
  `json_data` longtext DEFAULT NULL,
  `weight` int(11) NOT NULL DEFAULT 1,
  `created_date` datetime DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `order_invoice_no` varchar(255) DEFAULT NULL,
  `order_date` varchar(64) DEFAULT NULL,
  `cm_email` varchar(255) DEFAULT NULL,
  `cm_reg_no` varchar(255) DEFAULT NULL,
  `cm_website` varchar(255) DEFAULT NULL,
  `cm_phone` int(11) DEFAULT NULL,
  `cm_address` text DEFAULT NULL,
  `cm_note` text DEFAULT NULL,
  `customer_type` enum('bank','branch','company') DEFAULT NULL,
  `bank_id` int(11) DEFAULT NULL,
  `bank_reference` varchar(255) DEFAULT NULL,
  `key_personnel_id` int(11) DEFAULT NULL,
  `selling_price` int(11) DEFAULT NULL,
  `attachment` varchar(2555) DEFAULT NULL,
  `supplier_id` int(11) DEFAULT NULL,
  `supplier_reference` varchar(255) DEFAULT NULL,
  `buying_price` int(11) DEFAULT NULL,
  `profit` int(11) DEFAULT NULL,
  `pending_status` int(11) NOT NULL DEFAULT 0,
  `processing_status` int(11) NOT NULL DEFAULT 0,
  `query_status` int(11) NOT NULL DEFAULT 0,
  `cancel_status` int(11) NOT NULL DEFAULT 0,
  `completed_status` int(11) NOT NULL DEFAULT 0,
  `delivered_status` int(11) NOT NULL DEFAULT 0,
  `is_generate_invoice` int(11) DEFAULT 0,
  `invoice_gernerated_at` varchar(255) DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `order_status` enum('pending','processing','query','cancel','completed','delivered') DEFAULT 'pending',
  `processing_at` varchar(255) DEFAULT NULL,
  `processing_note` text DEFAULT NULL,
  `processing_by` int(11) DEFAULT NULL,
  `query_at` varchar(255) DEFAULT NULL,
  `query_note` text DEFAULT NULL,
  `query_by` int(11) DEFAULT NULL,
  ...
  `completed_note` text DEFAULT NULL,
  `completed_by` int(11) DEFAULT NULL,
  `delivered_at` varchar(255) DEFAULT NULL,
  `delivered_note` text DEFAULT NULL,
  `delivered_by` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`id`, `company_name`, `country_id`, `order_invoice_no`, `order_date`, `cm_email`, `cm_reg_no`, `cm_website`, `cm_phone`, `cm_address`, `cm_note`, `customer_type`, `bank_id`, `bank_reference`, `key_personnel_id`, `selling_price`, `attachment`, `supplier_id`, `supplier_reference`, `buying_price`, `profit`, `pending_status`, `processing_status`, `query_status`, `cancel_status`, `completed_status`, `delivered_status`, `is_generate_invoice`, `invoice_gernerated_at`, `payment_status`, `is_trash`, `created_at`, `created_by`, `updated_at`, `updated_by`, `order_status`, `processing_at`, `processing_note`, `processing_by`, `query_at`, `query_note`, `query_by`, `cancel_at`, `cancel_note`, `cancel_by`, `completed_at`, `completed_note`, `completed_by`, `delivered_at`, `delivered_note`, `delivered_by`) VALUES
(12, 'KRISHNA TRADE EXIM', 1, '#00000001', '28-11-2024', NULL, NULL, NULL, 0, '3A,RAMMOHAN MULLICK GARDEN LANE,\r\n\r\nRALKVA BUILDING,3RD FLOOR,UNIT-II,E.M.\r\n\r\nBYE PASS,BELIAGHATA,KOLKATA-700010', NULL, 'branch', 2, NULL, 1, 55, NULL, 5, NULL, 42, 13, 1, 1, 0, 1, 1, 0, 0, NULL, 'not_paid', 0, '2024-11-28 05:55:43', 1, '2024-12-08 06:17:55', 1, 'cancel', '2024-12-07 22:17:25', NULL, 1, NULL, NULL, NULL, '2024-12-08 12:17:55', NULL, 1, '2024-12-07 22:18:36', NULL, 1, NULL, NULL, NULL),
(13, 'KRISHNA TRADE EXIM', 1, '#00000002', '08-12-2024', NULL, NULL, NULL, 0, '3A,RAMMOHAN MULLICK GARDEN LANE,\r\n\r\nRALKVA BUILDING,3RD FLOOR,UNIT-II,E.M.\r\n\r\nBYE PASS,BELIAGHATA,KOLKATA-700010', NULL, 'branch', 2, NULL, 1, 55, '[\"67553cc8cc1a2_KRISHNA TRADERS.docx\",\"67553cda5a551_KRISHNA TRADERS.pdf\",\"67553d3eb00aa_KRISHNA TRADE EXIM.pdf\"]', 8, NULL, 45, 10, 1, 1, 0, 0, 1, 0, 0, NULL, 'not_paid', 0, '2024-12-08 06:22:56', 1, '2024-12-08 06:31:26', 1, 'completed', '2024-12-08 12:23:40', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2024-12-08 12:23:53', NULL, 1, NULL, NULL, NULL),
(14, 'AUTOCOM JAPAN INC.', 3, '#00000003', '08-12-2024', NULL, NULL, NULL, 2147483647, 'DAIDO SEIMEI YOKOHAMA BLDG 6F,2-14 HONCHO,NAKA-KU,YOKOHAMA,KANAGAWA,JAPAN', NULL, 'branch', 11, NULL, 8, 88, NULL, 5, NULL, 53, 35, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2024-12-08 07:17:42', 1, '2024-12-08 07:17:42', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, 'GOLD BROTHER INTERNATIONAL LIMITED', 2, '#00000004', '08-12-2024', NULL, NULL, NULL, 2147483647, 'RM 02.21/F, HIP KWAN COML BLDG,38 PITI ST YAU MA TEI, KOWLOON HONG KONG SAR', 'Ref: MEMORY STEEL CORPORATION', 'branch', 12, 'MEMORY STEEL CORPORATION', 7, 68, NULL, 5, NULL, 42, 26, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2024-12-08 07:20:26', 1, '2024-12-08 07:20:26', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(16, 'MARIYA IMPORT AND EXPORT  CO., LIMITED', 2, '#00000005', '08-12-2024', 'MILTONTRADE@163.COM', NULL, NULL, 2147483647, 'NO. 502, JIN MAO BUILDING, 699 NORTH CHOUZHOU ROAD, YIWU, CHINA.', 'China/Hong Kong Report', 'branch', 13, 'AB/DMNB/ ANANNYA/755386/NOV/2024', 1, 68, NULL, 5, NULL, 42, 26, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2024-12-08 07:23:45', 1, '2024-12-08 07:23:45', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(17, 'GUANGZHOU ONE TOUCH BUSINESS SERVICE CO.,LTD.', 6, '#00000006', '08-12-2024', NULL, NULL, NULL, 0, 'ROOM 501, ,NO.88 DINGXIN ROAD, HAIZHU\r\n\r\nDISTRICT GUANGZHOU, CHINA.', NULL, 'branch', 2, NULL, 1, NULL, '[\"67566acff22ee_GUANGZHOU ONETOUCH BUSINESS SERVICE CO.,LTD..docx\",\"67566ad7e34b0_GUANGZHOU ONETOUCH BUSINESS SERVICE CO.,LTD..pdf\"]', 10, NULL, 38, -38, 1, 1, 0, 0, 1, 0, 0, NULL, 'not_paid', 0, '2024-12-08 12:08:53', 1, '2024-12-09 03:58:15', 1, 'completed', '2024-12-09 09:57:47', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2024-12-09 09:57:53', NULL, 1, NULL, NULL, NULL),
(18, 'HIMALAYA HYGIENE INDUSTRIES PVT LTD', 157, '#00000007', '14-12-2024', NULL, NULL, NULL, 0, 'Bhaktapur, Nepal', NULL, 'branch', 7, NULL, 2, NULL, NULL, 5, NULL, NULL, 0, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2024-12-14 16:31:56', 1, '2024-12-14 16:31:56', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(19, 'GOLD BROTHER INTERNATIONAL LIMITED', 2, '#00000008', '15-12-2024', NULL, NULL, NULL, 2147483647, 'RM 02.21/F, HIP KWAN COML BLDG,38 PITI ST YAU MA TEI, KOWLOON HONG KONG SAR', NULL, 'branch', 12, NULL, 7, 68, NULL, 5, NULL, 42, 26, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2024-12-15 09:04:04', 1, '2024-12-15 09:04:04', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(20, 'TWA RETAIL SPOLKA Z. O. O., POLAND', 7, '#00000009', '15-12-2024', NULL, NULL, NULL, 0, 'SPOLKA KOMANDYTOWA UL, RYDLOWKA 20, 30-363 KRAKOW, POLSKA, POLAND.', NULL, 'branch', 14, 'CR/UTTR/39/ALEMA TEXTILES LTD./24', 5, NULL, NULL, 5, NULL, 42, -42, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2024-12-15 09:09:23', 1, '2024-12-15 09:09:23', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(21, 'KAN SP.ZOO, POLAND', 7, '#00000010', '15-12-2024', NULL, NULL, NULL, 0, 'WIACZYNSKA 8A STREET, 92-760 LODZ, POLAND.', NULL, 'branch', 14, 'CR/UTTR/40/ALEMA TEXTILES LTD./24', 5, NULL, NULL, 5, NULL, 42, -42, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2024-12-15 09:10:33', 1, '2024-12-15 09:10:33', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(22, 'GADOON TEXTILE MILLS LIMITED', 8, '#00000011', '18-01-2025', NULL, NULL, NULL, 0, '7-A MUHAMMAD ALI HOUSING SOCIETY\r\n                                                            ABDUL AZIZ HASHIM TABBA\r\n                                                            STREET, KARACHI-PAKISTAN', NULL, 'branch', 7, NULL, 2, NULL, NULL, 5, NULL, 53, -53, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2025-01-18 05:38:19', 1, '2025-01-18 05:38:19', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(23, 'LUCKY BIKE DE GMBH', 5, '#00000012', '18-01-2025', NULL, NULL, NULL, 0, 'SUNDERWEG 1, 33649 BIELEFELD\r\n                                                            GERMANY.', NULL, 'branch', 7, NULL, 2, NULL, NULL, 3, NULL, 78, -78, 1, 0, 0, 0, 0, 0, 0, NULL, 'not_paid', 0, '2025-01-18 06:21:51', 1, '2025-01-18 06:21:51', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(24, 'ABC Sample Ltd', 6, '#00000013', '14-07-2025', 'shahoreyermostofa@gmail.com', '123456', 'test.com', 1744948120, 'Dhaka', '1233456789', 'branch', 19, '9961161', 10, 4, '[\"6874e1ae4fe83_Rate_2025_05_12_1747033669.pdf\",\"6874e245cb049_BISHNUPAD BHATTACHARYA.pdf\",\"6874e24d3d946_KAZI GOLAM M\\u041e\\u041d\\u0410\\u041c\\u041cAD.pdf\"]', 21, '123626', 14, -10, 1, 1, 1, 0, 1, 1, 1, '2025-07-14 16:58:33', 'not_paid', 0, '2025-07-14 10:53:34', 1, '2025-07-14 10:56:55', 1, 'delivered', '2025-07-14 16:56:25', NULL, 1, '2025-07-14 16:56:33', NULL, 1, NULL, NULL, NULL, '2025-07-14 16:56:49', NULL, 1, '2025-07-14 16:56:55', NULL, 1);
...
CREATE TABLE `order_status` (
  ...
  `order_status` enum('pending','processing','query','cancel','completed','delivered') NOT NULL DEFAULT 'pending',
...
INSERT INTO `order_status` (`id`, `order_id`, `order_status`, `created_at`, `note`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 1, 'pending', '2024-01-07 13:32:12', 'My first testing', 1, NULL, NULL),
(2, 1, 'processing', '2024-01-07 19:19:30', 'Now it\'s processing stage', 1, NULL, NULL),
(3, 1, 'query', '2024-01-07 21:06:53', NULL, 1, NULL, NULL),
(4, 1, 'completed', '2024-01-07 21:07:00', NULL, 1, NULL, NULL),
(5, 1, 'query', '2024-01-07 21:07:10', NULL, 1, NULL, NULL),
(6, 1, 'completed', '2024-01-07 21:07:21', NULL, 1, NULL, NULL),
(7, 1, 'delivered', '2024-01-07 21:07:29', NULL, 1, NULL, NULL),
(8, 2, 'pending', '2024-01-11 23:36:12', NULL, 2, NULL, NULL),
(9, 3, 'pending', '2024-01-11 23:37:10', NULL, 2, NULL, NULL),
(10, 4, 'pending', '2024-01-11 23:37:44', NULL, 2, NULL, NULL),
(11, 5, 'pending', '2024-01-11 23:38:37', NULL, 2, NULL, NULL),
(12, 6, 'pending', '2024-01-28 23:15:50', NULL, 2, NULL, NULL),
(13, 7, 'pending', '2024-01-28 23:16:36', NULL, 2, NULL, NULL),
(15, 9, 'pending', '2024-01-28 23:23:13', NULL, 2, NULL, NULL),
(16, 10, 'pending', '2024-01-28 23:39:08', NULL, 2, NULL, NULL),
(17, 11, 'pending', '2024-01-28 23:46:23', NULL, 2, NULL, NULL),
(18, 12, 'pending', '2024-01-28 23:50:55', NULL, 2, NULL, NULL),
(19, 2, 'processing', '2024-01-30 21:11:44', NULL, 2, NULL, NULL),
(20, 2, 'completed', '2024-01-30 21:11:51', NULL, 2, NULL, NULL),
(21, 2, 'delivered', '2024-01-30 21:11:55', NULL, 2, NULL, NULL),
(22, 3, 'processing', '2024-01-30 21:12:04', NULL, 2, NULL, NULL),
(23, 3, 'completed', '2024-01-30 21:12:10', NULL, 2, NULL, NULL),
(24, 3, 'delivered', '2024-01-30 21:12:17', NULL, 2, NULL, NULL),
(25, 13, 'pending', '2024-02-02 18:12:23', NULL, 2, NULL, NULL),
(26, 13, 'processing', '2024-02-02 18:36:53', NULL, 2, NULL, NULL),
(27, 13, 'completed', '2024-02-02 18:37:04', NULL, 2, NULL, NULL),
(28, 13, 'delivered', '2024-02-02 18:37:14', NULL, 2, NULL, NULL),
(29, 10, 'processing', '2024-02-02 18:47:48', NULL, 2, NULL, NULL),
(30, 10, 'completed', '2024-02-02 18:47:53', NULL, 2, NULL, NULL),
(31, 10, 'delivered', '2024-02-02 18:48:10', NULL, 2, NULL, NULL),
(32, 14, 'pending', '2024-02-04 12:39:44', NULL, 2, NULL, NULL),
(33, 4, 'processing', '2024-02-16 12:40:12', NULL, 1, NULL, NULL),
(34, 4, 'query', '2024-02-16 12:40:37', 'shahoreyermostofa@gmail.com', 1, NULL, NULL),
(35, 4, 'completed', '2024-02-16 12:41:08', NULL, 1, NULL, NULL),
(47, 12, 'pending', '2024-11-28 11:55:43', NULL, 1, NULL, NULL),
(48, 12, 'processing', '2024-12-07 22:17:25', NULL, 1, NULL, NULL),
(49, 12, 'completed', '2024-12-07 22:18:36', NULL, 1, NULL, NULL),
(50, 12, 'cancel', '2024-12-08 12:17:55', NULL, 1, NULL, NULL),
(51, 13, 'pending', '2024-12-08 12:22:56', NULL, 1, NULL, NULL),
(52, 13, 'processing', '2024-12-08 12:23:40', NULL, 1, NULL, NULL),
(53, 13, 'completed', '2024-12-08 12:23:53', NULL, 1, NULL, NULL),
(54, 14, 'pending', '2024-12-08 13:17:42', NULL, 1, NULL, NULL),
(55, 15, 'pending', '2024-12-08 13:20:26', 'Ref: MEMORY STEEL CORPORATION', 1, NULL, NULL),
(56, 16, 'pending', '2024-12-08 13:23:45', 'China/Hong Kong Report', 1, NULL, NULL),
(57, 17, 'pending', '2024-12-08 18:08:53', NULL, 1, NULL, NULL),
(58, 17, 'processing', '2024-12-09 09:57:47', NULL, 1, NULL, NULL),
(59, 17, 'completed', '2024-12-09 09:57:53', NULL, 1, NULL, NULL),
(60, 18, 'pending', '2024-12-14 22:31:56', NULL, 1, NULL, NULL),
(61, 19, 'pending', '2024-12-15 15:04:04', NULL, 1, NULL, NULL),
(62, 20, 'pending', '2024-12-15 15:09:23', NULL, 1, NULL, NULL),
(63, 21, 'pending', '2024-12-15 15:10:33', NULL, 1, NULL, NULL),
(64, 22, 'pending', '2025-01-18 11:38:19', NULL, 1, NULL, NULL),
(65, 23, 'pending', '2025-01-18 12:21:51', NULL, 1, NULL, NULL),
(66, 24, 'pending', '2025-07-14 16:53:34', '1233456789', 1, NULL, NULL),
(67, 24, 'processing', '2025-07-14 16:56:25', NULL, 1, NULL, NULL),
(68, 24, 'query', '2025-07-14 16:56:33', NULL, 1, NULL, NULL),
(69, 24, 'completed', '2025-07-14 16:56:49', NULL, 1, NULL, NULL),
(70, 24, 'delivered', '2025-07-14 16:56:55', NULL, 1, NULL, NULL);
...
CREATE TABLE `other_payment` (
  `id` int(10) UNSIGNED NOT NULL,
  `dealer_id` int(10) UNSIGNED DEFAULT NULL,
  `sales_chart_id` int(10) UNSIGNED DEFAULT NULL,
  `payment_amount` double(10,2) DEFAULT NULL,
  `transaction_type` enum('cash','bank') DEFAULT NULL,
  `payment_invoice` varchar(128) DEFAULT NULL,
  ...
  `AccountCategoryId` int(11) NOT NULL,
  `AccountId` int(11) DEFAULT NULL,
  `receive_type` enum('regular','consumption') DEFAULT NULL,
  `enum_adjustment_type_id` int(11) DEFAULT NULL,
...
INSERT INTO `other_payment` (`id`, `dealer_id`, `sales_chart_id`, `payment_amount`, `transaction_type`, `payment_invoice`, `payment_date`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `AccountTypeId`, `AccountCategoryId`, `AccountId`, `receive_type`, `enum_adjustment_type_id`, `sales_id`, `payment_id`, `note`, `package_id`, `is_trash`) VALUES
(1, 1, 1, 500.00, 'cash', 'INV-250714-600001', '14-07-2025', 'active', 1, NULL, '2025-07-14 04:47:46', NULL, 1, 1, NULL, 'regular', NULL, NULL, NULL, NULL, NULL, 0);
...
CREATE TABLE `other_payment_details` (
  `id` int(10) UNSIGNED NOT NULL,
  `other_payment_id` int(10) UNSIGNED DEFAULT NULL,
  `product_id` int(10) UNSIGNED DEFAULT NULL,
  `consumption_quantity` int(10) UNSIGNED DEFAULT NULL,
  `status` enum('active','inactive','cancel') DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_by` int(10) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `participants` (
  `id` int(11) NOT NULL,
  `parent_participantid` int(11) DEFAULT NULL,
  `status` tinyint(1) DEFAULT NULL,
  `participant_type` enum('1','2','3') DEFAULT NULL,
  `display_status` enum('active','inactive','cancel') DEFAULT NULL,
  `source_contactid` int(11) DEFAULT NULL,
  `target_contact_id` int(11) DEFAULT NULL,
  `relation_of_nodeid` int(11) DEFAULT NULL,
  `relation_of_node_type` enum('1','2','3') DEFAULT NULL,
  `relation_type_nodeid` int(11) DEFAULT NULL,
  `relation_type_node_type` enum('1','2','3') DEFAULT NULL,
  `category_termid` int(11) DEFAULT NULL,
  ...
  `start_date` datetime DEFAULT NULL,
  `end_date` datetime DEFAULT NULL,
  `period_nodeid` int(11) DEFAULT NULL,
  `invoice_id` int(11) DEFAULT NULL,
  `invoice_type` enum('1','2','3') DEFAULT NULL,
  ...
  `status_termid` int(11) DEFAULT NULL,
  `status_effective_date` datetime DEFAULT NULL,
  `description` longtext DEFAULT NULL,
  `json_data` longtext DEFAULT NULL,
  `weight` int(11) DEFAULT NULL,
...
CREATE TABLE `payment_due` (
  ...
  `p21` varchar(4) DEFAULT NULL,
  `p22` varchar(5) DEFAULT NULL,
  `p23` varchar(5) DEFAULT NULL,
  `p26` varchar(6) DEFAULT NULL,
  `p9` varchar(4) DEFAULT NULL,
  `shift` varchar(8) DEFAULT NULL,
  `COL 13` varchar(18) DEFAULT NULL,
  `g_cell` varchar(13) DEFAULT NULL,
  `COL14` varchar(13) DEFAULT NULL,
  `gender` varchar(6) DEFAULT NULL,
  `section` varchar(7) DEFAULT NULL,
  `roll` varchar(4) DEFAULT NULL,
  `d9` varchar(6) DEFAULT NULL,
  `d4_10` varchar(9) DEFAULT NULL,
  `d21` varchar(4) DEFAULT NULL,
  `d22` varchar(5) DEFAULT NULL,
  `d23` varchar(5) DEFAULT NULL,
  `d26` varchar(6) DEFAULT NULL,
  `d19` varchar(6) DEFAULT NULL,
  `COL 24` varchar(6) DEFAULT NULL,
  `f_name` varchar(32) DEFAULT NULL,
  `m_name` varchar(26) DEFAULT NULL,
  `admi_date` varchar(10) DEFAULT NULL,
...
CREATE TABLE `payment_history` (
  ...
  `payment_amount` double(10,2) DEFAULT NULL,
  `due_amount` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Table structure for table `payment_history_version`
--

CREATE TABLE `payment_history_version` (
  `id` int(10) UNSIGNED NOT NULL,
  `payment_invoice` varchar(255) NOT NULL,
  `payment_date` varchar(64) NOT NULL,
  `customer_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `permissions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) NOT NULL,
  `user_show_name` varchar(191) NOT NULL,
...
INSERT INTO `permissions` (`id`, `name`, `user_show_name`, `guard_name`, `group_name`, `created_at`, `updated_at`) VALUES
(1, 'class.index', 'Class Index', 'web', 'Class', '2022-11-14 17:24:46', '2022-11-14 17:24:46'),
(2, 'class.create', 'Class Create', 'web', 'Class', '2022-11-14 17:24:58', '2022-11-14 17:24:58'),
(3, 'class.edit', 'Class Edit', 'web', 'Class', '2022-11-14 17:25:09', '2022-11-14 17:25:09'),
(4, 'class.update', 'Class Update', 'web', 'Class', '2022-11-14 17:25:57', '2022-11-14 17:25:57'),
(5, 'shift.index', 'Shift Index', 'web', 'Shift', '2022-11-14 17:27:24', '2022-11-14 17:27:24'),
(6, 'shift.create', 'Shift Create', 'web', 'Shift', '2022-11-14 17:27:32', '2022-11-14 17:27:32'),
(7, 'shift.edit', 'Shift Edit', 'web', 'Shift', '2022-11-14 17:27:51', '2022-11-14 17:27:51'),
(8, 'shift.update', 'Shift Update', 'web', 'Shift', '2022-11-14 17:28:00', '2022-11-14 17:28:00'),
(9, 'version.index', 'Version Index', 'web', 'Version', '2022-11-14 18:02:46', '2022-11-14 18:02:46'),
(10, 'version.create', 'Version Create', 'web', 'Version', '2022-11-14 18:03:00', '2022-11-14 18:03:00'),
(11, 'version.edit', 'Version Edit', 'web', 'Version', '2022-11-14 18:03:21', '2022-11-14 18:03:21'),
(12, 'version.update', 'Version Update', 'web', 'Version', '2022-11-14 18:03:31', '2022-11-14 18:03:31'),
(13, 'section.index', 'Section Index', 'web', 'Section', '2022-11-14 18:07:06', '2022-11-14 18:07:06'),
(14, 'section.create', 'Section Create', 'web', 'Section', '2022-11-14 18:07:13', '2022-11-14 18:07:13'),
(15, 'section.edit', 'Section Edit', 'web', 'Section', '2022-11-14 18:07:24', '2022-11-14 18:07:24'),
(16, 'section.delete', 'Section Delete', 'web', 'Section', '2022-11-14 18:07:32', '2022-11-14 18:07:32'),
(17, 'section.asign.create', 'Section Assign Permission', 'web', 'Section', '2022-11-14 19:04:03', '2022-11-14 19:04:03'),
(18, 'group.index', 'Group Index', 'web', 'Group', '2022-11-14 19:23:47', '2022-11-14 19:23:47'),
(19, 'group.create', 'Group Create', 'web', 'Group', '2022-11-14 19:24:00', '2022-11-14 19:24:00'),
(20, 'group.edit', 'Group Edit', 'web', 'Group', '2022-11-14 19:24:18', '2022-11-14 19:24:18'),
(21, 'group.delete', 'Group Delete', 'web', 'Group', '2022-11-14 19:24:32', '2022-11-14 19:24:32'),
(22, 'transport.index', 'Transport Index', 'web', 'Transport', '2022-11-14 19:49:54', '2022-11-14 19:49:54'),
(23, 'transport.create', 'Transport Create', 'web', 'Transport', '2022-11-14 19:50:10', '2022-11-14 19:50:10'),
(24, 'transport.edit', 'Transport Edit', 'web', 'Transport', '2022-11-14 19:50:17', '2022-11-14 19:50:17'),
(25, 'transport.update', 'Transport Update', 'web', 'Transport', '2022-11-14 19:50:24', '2022-11-14 19:50:24'),
(26, 'academic.year.index', 'Acadmeic Year Index', 'web', 'Academic Year', '2022-11-14 19:51:34', '2022-11-14 19:52:09'),
(27, 'academic.year.create', 'Academic Year Create', 'web', 'Academic Year', '2022-11-14 19:51:48', '2022-11-23 09:10:02'),
(28, 'academic.year.edit', 'Academic Year Edit', 'web', 'Academic Year', '2022-11-14 19:52:43', '2022-11-14 19:52:43'),
(29, 'academic.year.delete', 'Academic Year Delete', 'web', 'Academic Year', '2022-11-14 19:52:58', '2022-11-14 19:52:58'),
(30, 'student.index', 'Student Index', 'web', 'Student', '2022-11-14 20:09:03', '2022-11-14 20:09:03'),
(31, 'student.create', 'Student Create', 'web', 'Student', '2022-11-14 20:09:52', '2022-11-14 20:09:52'),
(32, 'student.edit', 'Student Edit', 'web', 'Student', '2022-11-14 20:10:11', '2022-11-14 20:10:11'),
(33, 'transfer.certificate.index', 'Transfer Certificate Index', 'web', 'Certificate', '2022-11-14 20:34:03', '2022-11-14 20:34:03'),
(34, 'testimonial.index', 'Testimonial Manage', 'web', 'Certificate', '2022-11-14 20:35:02', '2022-11-14 20:35:02'),
(35, 'studentship.index', 'Studentship Certificate', 'web', 'Certificate', '2022-11-14 20:35:51', '2022-11-15 19:22:32'),
(37, 'exam.create', 'Exam Create', 'web', 'Exam', '2022-11-14 20:58:40', '2022-11-14 21:27:58'),
(38, 'exam.edit', 'Exam Edit', 'web', 'Exam', '2022-11-14 20:58:46', '2022-11-14 20:58:46'),
(39, 'exam.delete', 'Exam Delete', 'web', 'Exam', '2022-11-14 20:59:01', '2022-11-14 20:59:01'),
(40, 'exam_type.index', 'Exam Type Index', 'web', 'Exam Type', '2022-11-14 20:59:59', '2022-11-14 21:02:17'),
(41, 'exam_type.create', 'Exam Type Create', 'web', 'Exam Type', '2022-11-14 21:00:19', '2022-11-14 21:02:40'),
(42, 'exam_type.edit', 'Exam Type Edit', 'web', 'Exam Type', '2022-11-14 21:00:37', '2022-11-14 21:00:37'),
(43, 'exam_type.delete', 'Exam Type Delete', 'web', 'Exam Type', '2022-11-14 21:00:55', '2022-11-14 21:00:55'),
(44, 'exam.index', 'Exam Index', 'web', 'Exam', '2022-11-14 21:35:46', '2022-11-14 21:35:46'),
(45, 'exam.seat.index', 'Exam Seat Manage', 'web', 'Exam', '2022-11-14 21:38:22', '2022-11-14 21:38:22'),
(46, 'admit.card.index', 'Admit Card Manage', 'web', 'Exam', '2022-11-14 21:38:50', '2022-11-14 21:39:15'),
(47, 'user.index', 'User Index', 'web', 'User', '2022-11-15 18:03:29', '2022-11-15 18:03:29'),
(48, 'user.create', 'User Create', 'web', 'User', '2022-11-15 18:03:40', '2022-11-15 18:03:40'),
(49, 'user.edit', 'User Edit', 'web', 'User', '2022-11-15 18:03:50', '2022-11-15 18:03:50'),
(50, 'user.delete', 'User Delete', 'web', 'User', '2022-11-15 18:03:58', '2022-11-15 18:04:14'),
(51, 'role.index', 'Role Index', 'web', 'Role', '2022-11-15 18:05:56', '2022-11-15 18:05:56'),
(52, 'role.create', 'Role Create', 'web', 'Role', '2022-11-15 18:07:44', '2022-11-15 18:07:44'),
(53, 'role.edit', 'Role Edit', 'web', 'Role', '2022-11-15 18:07:57', '2022-11-15 18:07:57'),
(54, 'role.delete', 'Role Delete', 'web', 'Role', '2022-11-15 18:08:11', '2022-11-15 18:08:11'),
(55, 'readmission.index', 'Re Admission Index', 'web', 'Student', '2022-11-30 11:56:14', '2022-11-30 11:56:14'),
(56, 'readmission.create', 'Re Admission Create', 'web', 'Student', '2022-11-30 11:56:35', '2022-11-30 11:56:35'),
(59, 'student.delete', 'Student Delete', 'web', 'Student', '2022-12-11 04:51:57', '2022-12-11 04:51:57'),
(60, 'employee.payroll.view', 'Employee Payroll View', 'web', 'Employee Salary', '2023-01-22 08:50:26', '2023-06-08 19:22:20'),
(61, 'employee.salary.create', 'Employee salary Create', 'web', 'Employee Salary', '2023-01-22 08:50:39', '2023-06-08 19:14:48'),
(62, 'class.delete', 'class delete', 'web', 'Class', '2023-03-22 05:29:56', '2023-03-22 05:29:56'),
(63, 'subject.index', 'Subject Index', 'web', 'Subject', '2023-04-09 01:59:19', '2023-04-09 02:00:50'),
(64, 'subject.create', 'Subject Create', 'web', 'Subject', '2023-04-09 02:02:23', '2023-04-09 02:04:42'),
(65, 'subject.store', 'Subject Store', 'web', 'Subject', '2023-04-09 02:03:12', '2023-04-09 02:04:57'),
(66, 'subject.edit', 'Subject Edit', 'web', 'Subject', '2023-04-09 02:03:29', '2023-04-09 02:05:07'),
(67, 'subject.update', 'Subject Update', 'web', 'Subject', '2023-04-09 02:03:44', '2023-04-09 02:05:21'),
(68, 'subject.destory', 'Subject Destory', 'web', 'Subject', '2023-04-09 02:04:16', '2023-04-09 02:05:35'),
(69, 'shift.delete', 'Shift Delete', 'web', 'Shift', '2023-04-12 00:55:10', '2023-04-12 00:55:10'),
(70, 'version.delete', 'Version Delete', 'web', 'Version', '2023-04-12 01:00:07', '2023-04-12 01:00:07'),
(71, 'holiday.create', 'Holiday Create', 'web', 'Holiday', '2023-05-16 17:08:43', '2023-05-16 17:08:43'),
(72, 'holiday.edit', 'Holiday Edit', 'web', 'Holiday', '2023-05-16 17:11:43', '2023-05-16 17:11:43'),
(73, 'holiday.delete', 'Holiday Delete', 'web', 'Holiday', '2023-05-16 17:11:56', '2023-05-16 17:11:56'),
(74, 'holiday.index', 'Holiday Index', 'web', 'Holiday', '2023-05-16 17:12:22', '2023-05-16 17:12:22'),
(75, 'department.index', 'Department Index', 'web', 'Department', '2023-05-22 13:11:15', '2023-05-22 13:11:15'),
(76, 'mark.attribute.delete', 'Mark Attribute Delete', 'web', 'Mark', '2023-05-25 12:55:55', '2023-05-25 12:55:55'),
(77, 'subject.assign.create', 'Subject Assign Create', 'web', 'Subject', '2023-05-31 16:20:34', '2023-05-31 16:20:34'),
(78, 'student.profile', 'Student Profile', 'web', 'Student', '2023-06-01 14:10:54', '2023-06-01 14:10:54'),
(79, 'bulk.student.edit', 'Bulk Student Edit', 'web', 'Student', '2023-06-01 16:25:34', '2023-06-01 16:25:34'),
(80, 'student.payment', 'Student Payment', 'web', 'Payment', '2023-06-01 16:52:19', '2023-06-01 16:52:19'),
(81, 'customer.payment', 'Customer Payment', 'web', 'Payment', '2023-06-01 16:59:20', '2023-06-01 16:59:20'),
(82, 'payment.list', 'Payment List', 'web', 'Payment', '2023-06-01 17:21:21', '2023-06-01 17:21:21'),
(83, 'due.list', 'Due List', 'web', 'Payment', '2023-06-01 17:23:35', '2023-06-01 17:23:35'),
(84, 'payment.list.edit', 'Payment List Edit', 'web', 'Payment', '2023-06-01 17:32:07', '2023-06-01 17:32:07'),
(86, 'due.list.edit', 'Due List Edit', 'web', 'Payment', '2023-06-01 17:43:20', '2023-06-01 17:43:20'),
(87, 'due.list.delete', 'Due List Delete', 'web', 'Payment', '2023-06-01 17:43:42', '2023-06-01 17:43:42'),
(88, 'mark.attribute.index', 'Mark Attribute Index', 'web', 'Mark', '2023-06-08 12:57:47', '2023-06-08 12:57:47'),
(89, 'mark.attribute.create', 'Mark Attribute Create', 'web', 'Mark', '2023-06-08 14:35:53', '2023-06-08 14:35:53'),
(90, 'mark.attribute.edit', 'Mark Attribute Edit', 'web', 'Mark', '2023-06-08 14:36:03', '2023-06-08 14:36:03'),
(91, 'mark.config.index', 'Mark Config Index', 'web', 'Mark', '2023-06-08 15:40:06', '2023-06-08 15:40:06'),
(92, 'student.mark.input', 'Student Mark Input', 'web', 'Mark', '2023-06-08 15:42:57', '2023-06-08 15:42:57'),
(93, 'mark.grade.index', 'Mark Grade Index', 'web', 'Mark', '2023-06-08 15:49:56', '2023-06-08 15:49:56'),
(94, 'mark.grade.create', 'Mark Grade Create', 'web', 'Mark', '2023-06-08 15:50:21', '2023-06-08 15:50:21'),
(95, 'mark.grade.delete', 'Mark Grade Delete', 'web', 'Mark', '2023-06-08 15:52:42', '2023-06-08 15:52:42'),
(96, 'student.marksheet', 'Student Marksheet', 'web', 'Mark', '2023-06-08 15:56:09', '2023-06-08 15:56:09'),
(97, 'category.index', 'Category Index', 'web', 'Category', '2023-06-08 16:01:22', '2023-06-08 16:01:22'),
(98, 'category.create', 'Category Create', 'web', 'Category', '2023-06-08 16:01:39', '2023-06-08 16:01:39'),
(99, 'category.edit', 'Category Edit', 'web', 'Category', '2023-06-08 16:02:13', '2023-06-08 16:02:13'),
(100, 'category.update', 'Category Update', 'web', 'Category', '2023-06-08 16:02:27', '2023-06-08 16:02:27'),
(101, 'item.index', 'Item Index', 'web', 'Item', '2023-06-08 16:12:09', '2023-06-08 16:12:09'),
(102, 'item.create', 'Item Create', 'web', 'Item', '2023-06-08 16:12:56', '2023-06-08 16:12:56'),
(103, 'item.edit', 'Item Edit', 'web', 'Item', '2023-06-08 16:13:33', '2023-06-08 16:13:33'),
(104, 'item.delete', 'Item Delete', 'web', 'Item', '2023-06-08 16:13:58', '2023-06-08 16:13:58'),
(105, 'monthly.item.index', 'Monthly Item Index', 'web', 'Item', '2023-06-08 17:08:32', '2023-06-08 17:08:32'),
(106, 'monthly.item.create', 'Monthly Item Create', 'web', 'Item', '2023-06-08 17:09:35', '2023-06-08 17:09:35'),
(107, 'pricing.index', 'Pricing Index', 'web', 'Item', '2023-06-08 17:33:32', '2023-06-08 17:33:32'),
(108, 'pricing.create', 'Pricing Create', 'web', 'Item', '2023-06-08 17:33:54', '2023-06-08 17:33:54'),
(109, 'monthly.item.setup.index', 'Monthly Item Setup Index', 'web', 'Item', '2023-06-08 17:37:21', '2023-06-08 17:37:21'),
(110, 'attendance.import.create', 'Attendance Import Create', 'web', 'Attendance', '2023-06-08 17:46:34', '2023-06-08 17:46:34'),
(111, 'attendance.import.edit', 'Attendance Import Edit', 'web', 'Attendance', '2023-06-08 17:46:53', '2023-06-08 17:46:53'),
(112, 'attendance.import.index', 'Attendance Import Index', 'web', 'Attendance', '2023-06-08 17:49:40', '2023-06-08 17:49:40'),
(113, 'student.daily.attendance', 'Student Daily Attendance', 'web', 'Attendance', '2023-06-08 17:53:56', '2023-06-08 17:53:56'),
(114, 'dynamic.sms', 'Dynamic SMS', 'web', 'SMS', '2023-06-08 18:09:47', '2023-06-08 18:09:47'),
(115, 'guardian.sms', 'Guardian SMS', 'web', 'SMS', '2023-06-08 18:11:31', '2023-06-08 18:11:31'),
(116, 'teacher.sms', 'Teacher SMS', 'web', 'SMS', '2023-06-08 18:12:11', '2023-06-08 18:12:11'),
(117, 'due.sms', 'Due SMS', 'web', 'SMS', '2023-06-08 18:12:28', '2023-06-08 18:12:28'),
(118, 'department.create', 'Department Create', 'web', 'Department', '2023-06-08 18:28:53', '2023-06-08 18:28:53'),
(119, 'department.edit', 'Department Edit', 'web', 'Department', '2023-06-08 18:29:00', '2023-06-08 18:29:00'),
(120, 'department.delete', 'Department Delete', 'web', 'Department', '2023-06-08 18:29:12', '2023-06-08 18:29:12'),
(121, 'designation.create', 'Designation Create', 'web', 'Designation', '2023-06-08 18:37:14', '2023-06-08 18:37:14'),
(122, 'designation.index', 'Designation Index', 'web', 'Designation', '2023-06-08 18:37:34', '2023-06-08 18:37:34'),
(123, 'designation.edit', 'Designation Edit', 'web', 'Designation', '2023-06-08 18:37:43', '2023-06-08 18:37:43'),
(124, 'designation.delete', 'Designation Delete', 'web', 'Designation', '2023-06-08 18:38:00', '2023-06-08 18:38:00'),
(125, 'employee.create', 'Employee Create', 'web', 'Employee', '2023-06-08 19:01:11', '2023-06-08 19:03:00'),
(126, 'employee.index', 'Employee Index', 'web', 'Employee', '2023-06-08 19:01:34', '2023-06-08 19:01:34'),
(127, 'employee.edit', 'Employee Edit', 'web', 'Employee', '2023-06-08 19:01:51', '2023-06-08 19:01:51'),
(128, 'employee.delete', 'Employee Delete', 'web', 'Employee', '2023-06-08 19:02:00', '2023-06-08 19:02:00'),
(129, 'salary.item.create', 'Salary Item Create', 'web', 'Salary Item', '2023-06-08 19:07:54', '2023-06-08 19:07:54'),
(130, 'salary.item.index', 'Salary Item Index', 'web', 'Salary Item', '2023-06-08 19:08:02', '2023-06-08 19:08:02'),
(131, 'salary.item.edit', 'Salary Item Edit', 'web', 'Salary Item', '2023-06-08 19:08:25', '2023-06-08 19:08:25'),
(132, 'salary.item.delete', 'Salary Item Delete', 'web', 'Salary Item', '2023-06-08 19:08:48', '2023-06-08 19:08:48'),
(133, 'employee.salary.delete', 'Employee Salary Delete', 'web', 'Employee Salary', '2023-06-08 19:16:03', '2023-06-08 19:16:03'),
(134, 'employee.payroll.index', 'Employee Payroll Index', 'web', 'Employee Salary', '2023-06-08 19:20:39', '2023-06-08 19:20:39'),
(135, 'employee.payroll.create', 'Employee Payroll Create', 'web', 'Employee Salary', '2023-06-08 19:20:57', '2023-06-08 19:20:57'),
(136, 'pay.employee.salary', 'Pay Employee Salary', 'web', 'Employee Salary', '2023-06-08 19:24:50', '2023-07-17 20:23:37'),
(137, 'employee.payroll.report', 'Employee Payroll Report', 'web', 'Employee Salary', '2023-06-08 19:25:33', '2023-06-08 19:25:33'),
(139, 'expense.chart.index', 'Expense Chart Index', 'web', 'Expense Chart', '2023-06-10 12:21:19', '2023-06-10 12:21:19'),
(141, 'expense.chart.create', 'Expense Chart Create', 'web', 'Expense Chart', '2023-06-10 12:22:38', '2023-06-10 12:22:38'),
(142, 'expense.chart.edit', 'Expense Chart Edit', 'web', 'Expense Chart', '2023-06-10 12:22:45', '2023-06-10 12:22:45'),
(143, 'expense.chart.delete', 'Expense Chart Delete', 'web', 'Expense Chart', '2023-06-10 12:22:54', '2023-06-10 12:22:54'),
(144, 'expense.index', 'Expense Index', 'web', 'Expense', '2023-06-10 12:33:58', '2023-06-10 12:33:58'),
(145, 'expense.create', 'Expense Create', 'web', 'Expense', '2023-06-10 12:34:09', '2023-06-10 12:34:09'),
(146, 'expense.edit', 'Expense Edit', 'web', 'Expense', '2023-06-10 12:34:17', '2023-06-10 12:34:17'),
(147, 'expense.delete', 'Expense Delete', 'web', 'Expense', '2023-06-10 12:34:29', '2023-06-10 12:34:29'),
(148, 'account.category.index', 'Account Category Index', 'web', 'Account Category', '2023-06-10 12:39:17', '2023-06-10 12:39:17'),
(149, 'account.category.create', 'Account Category Create', 'web', 'Account Category', '2023-06-10 12:39:26', '2023-06-10 12:39:26'),
(150, 'account.category.edit', 'Account Category Edit', 'web', 'Account Category', '2023-06-10 12:39:36', '2023-06-10 12:39:36'),
(151, 'account.category.delete', 'Account Category Delete', 'web', 'Account Category', '2023-06-10 12:39:47', '2023-06-10 12:39:47'),
(152, 'account.index', 'Account Index', 'web', 'Account', '2023-06-10 12:42:20', '2023-06-10 12:42:20'),
(153, 'account.create', 'Account Create', 'web', 'Account', '2023-06-10 12:42:34', '2023-06-10 12:42:34'),
(154, 'account.edit', 'Account Edit', 'web', 'Account', '2023-06-10 12:42:42', '2023-06-10 12:42:42'),
(155, 'account.delete', 'Account Delete', 'web', 'Account', '2023-06-10 12:42:53', '2023-06-10 12:42:53'),
(156, 'permission.index', 'Permission Index', 'web', 'Permission', '2023-06-10 12:55:45', '2023-06-10 12:55:45'),
(157, 'permission.create', 'Permission Create', 'web', 'Permission', '2023-06-10 12:55:53', '2023-06-10 12:55:53'),
(158, 'permission.edit', 'Permission Edit', 'web', 'Permission', '2023-06-10 12:56:02', '2023-06-10 12:56:02'),
(159, 'weekend.create', 'Weekend Create', 'web', 'Holiday', '2023-06-10 13:33:52', '2023-06-10 13:33:52'),
(160, 'admission.report', 'Admission Report', 'web', 'Report', '2023-06-10 13:44:23', '2023-06-10 13:44:23'),
(161, 'admission.collection.report', 'Admission Collection Report', 'web', 'Report', '2023-06-10 13:45:00', '2023-06-10 13:45:00'),
(162, 'student.collection.report', 'Student Collection Report', 'web', 'Report', '2023-06-10 13:45:20', '2023-06-10 13:45:20'),
(163, 'sms.report', 'SMS Report', 'web', 'Report', '2023-06-10 13:45:32', '2023-06-10 13:45:32'),
(164, 'expense.report', 'Expense Report', 'web', 'Report', '2023-06-10 13:46:30', '2023-06-10 13:46:30'),
(165, 'income.report', 'Income Report', 'web', 'Report', '2023-06-10 13:46:43', '2023-06-10 13:46:43'),
(166, 'cash.book.report', 'Cash Book Report', 'web', 'Report', '2023-06-10 13:47:43', '2023-06-10 13:47:43'),
(167, 'bank.book.report', 'Bank Book Report', 'web', 'Report', '2023-06-10 13:47:56', '2023-06-10 13:47:56'),
(168, 'account.clearence.report', 'Account Clearence Report', 'web', 'Report', '2023-06-10 13:48:30', '2023-06-10 13:48:30'),
(169, 'institution.index', 'Institution Index', 'web', 'Setting', '2023-06-10 14:21:59', '2023-06-10 14:21:59'),
(170, 'institution.edit', 'Institution Edit', 'web', 'Setting', '2023-06-10 14:22:14', '2023-06-10 14:22:14'),
(171, 'sms.setting', 'SMS Setting', 'web', 'Setting', '2023-06-10 14:22:33', '2023-06-10 14:22:33'),
(172, 'sid.setting', 'SID Setting', 'web', 'Setting', '2023-06-10 14:22:44', '2023-06-10 14:22:44'),
(173, 'student.id.card', 'Student ID Card', 'web', 'ID Card', '2023-06-10 14:25:15', '2023-06-10 14:25:15'),
(174, 'guardian.id.card', 'Guardian ID Card', 'web', 'ID Card', '2023-06-10 14:25:24', '2023-06-10 14:25:24'),
(175, 'employee.id.card', 'Employee ID Card', 'web', 'ID Card', '2023-06-10 14:25:35', '2023-06-10 14:25:35'),
(176, 'employee.salary.index', 'Employee Salary Index', 'web', 'Employee Salary', '2023-07-17 00:28:36', '2023-07-17 00:28:36'),
(177, 'institution.setting.edit', 'Institution Setting Edit', 'web', 'Setting', '2023-07-24 08:43:20', '2023-07-24 08:43:20'),
(178, 'fine.setting', 'Fine Setting', 'web', 'Setting', '2023-07-24 08:43:32', '2023-07-24 08:43:32');
...
INSERT INTO `pricing` (`id`, `product_id`, `customer_category_id`, `territory_id`, `customer_id`, `academic_year_id`, `class_id`, `price`, `dealer_id`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `effective_date`) VALUES
(1, 1, NULL, NULL, NULL, NULL, NULL, 55, NULL, 'active', 1, NULL, '2024-11-13 18:45:31', NULL, NULL),
(2, 2, NULL, NULL, NULL, NULL, NULL, 68, NULL, 'active', 1, NULL, '2024-11-13 18:45:31', NULL, NULL),
(3, 3, NULL, NULL, NULL, NULL, NULL, 88, NULL, 'active', 1, NULL, '2024-11-13 18:45:31', NULL, NULL);
...
CREATE TABLE `products` (
  ...
  `variant_type` int(11) DEFAULT NULL,
  `parent_id` int(11) DEFAULT NULL,
  `isVariant` int(11) NOT NULL DEFAULT 0,
  `color` int(11) DEFAULT NULL,
  `size` int(11) DEFAULT NULL,
  `value` varchar(255) DEFAULT NULL,
  `isCustom` int(11) DEFAULT 0,
  `isBundle` int(11) DEFAULT 0,
  `vat` float DEFAULT NULL,
  `isVat_percent` int(11) DEFAULT 0,
  `tax` float DEFAULT NULL,
  `isTax_percent` int(11) DEFAULT 0,
...
INSERT INTO `products` (`id`, `brand_id`, `category_id`, `type_id`, `model_id`, `unit_id`, `dealer_id`, `name`, `short_name`, `slug`, `bin_number`, `description`, `list_price`, `sell_price`, `code`, `image`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `articlecode`, `product_type`, `variant_type`, `parent_id`, `isVariant`, `color`, `size`, `value`, `isCustom`, `isBundle`, `vat`, `isVat_percent`, `tax`, `isTax_percent`, `barcode`, `stock`, `pack_size`, `is_trash`) VALUES
(1, NULL, NULL, NULL, NULL, NULL, NULL, 'India', 'IND', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-11-14 06:32:31', '2024-12-07 15:16:20', NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(2, NULL, NULL, NULL, NULL, NULL, NULL, 'Hong Kong', 'HK', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-11-14 06:43:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(3, NULL, NULL, NULL, NULL, NULL, NULL, 'Japan', 'JP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-11-14 06:43:41', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(4, NULL, NULL, NULL, NULL, NULL, NULL, 'Italy', 'It', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-11-28 00:47:09', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(5, NULL, NULL, NULL, NULL, NULL, NULL, 'Germany', 'GR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-11-28 00:47:29', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(6, NULL, NULL, NULL, NULL, NULL, NULL, 'China', 'CN', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-11-28 00:48:15', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(7, NULL, NULL, NULL, NULL, NULL, NULL, 'Poland', 'PL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-11-28 00:48:31', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(8, NULL, NULL, NULL, NULL, NULL, NULL, 'Pakistan', 'PK', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-11-28 00:48:51', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(9, NULL, NULL, NULL, NULL, NULL, NULL, 'Afghanistan', 'Afgh', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:32:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(10, NULL, NULL, NULL, NULL, NULL, NULL, 'Albania', 'Alba', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:32:35', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(11, NULL, NULL, NULL, NULL, NULL, NULL, 'Alderney (Channel Isl.)', 'Alde', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:32:54', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(12, NULL, NULL, NULL, NULL, NULL, NULL, 'Algeria', 'Algeri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:33:20', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(13, NULL, NULL, NULL, NULL, NULL, NULL, 'American Samoa', 'American Samoa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:34:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(14, NULL, NULL, NULL, NULL, NULL, NULL, 'Andorra', 'Andorra', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:34:28', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(15, NULL, NULL, NULL, NULL, NULL, NULL, 'Angola', 'Angola', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:34:38', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(16, NULL, NULL, NULL, NULL, NULL, NULL, 'Anguilla', 'Anguilla', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:34:47', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(17, NULL, NULL, NULL, NULL, NULL, NULL, 'Antigua & Barbuda', 'Antigua & Barbuda', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:34:56', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(18, NULL, NULL, NULL, NULL, NULL, NULL, 'Argentina', 'Argentina', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:35:07', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(19, NULL, NULL, NULL, NULL, NULL, NULL, 'Armenia', 'Armenia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:35:16', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(20, NULL, NULL, NULL, NULL, NULL, NULL, 'Aruba', 'Aruba', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:35:28', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(21, NULL, NULL, NULL, NULL, NULL, NULL, 'Ascension Island', 'Ascension Island', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:35:36', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(22, NULL, NULL, NULL, NULL, NULL, NULL, 'Australia', 'Australia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:35:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(23, NULL, NULL, NULL, NULL, NULL, NULL, 'Austria', 'Austria', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:36:50', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(24, NULL, NULL, NULL, NULL, NULL, NULL, 'Azerbaijan', 'Azerbaijan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:36:58', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(25, NULL, NULL, NULL, NULL, NULL, NULL, 'Bahamas', 'Bahamas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:37:08', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(26, NULL, NULL, NULL, NULL, NULL, NULL, 'Bahrain', 'Bahrain', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:37:20', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(27, NULL, NULL, NULL, NULL, NULL, NULL, 'Bangladesh', 'Bangladesh', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:37:30', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(28, NULL, NULL, NULL, NULL, NULL, NULL, 'Barbados', 'Barbados', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:37:38', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(29, NULL, NULL, NULL, NULL, NULL, NULL, 'Belarus', 'Belarus', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:37:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(30, NULL, NULL, NULL, NULL, NULL, NULL, 'Belgium', 'Belgium', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:37:53', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(31, NULL, NULL, NULL, NULL, NULL, NULL, 'Belize', 'Belize', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:38:00', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(32, NULL, NULL, NULL, NULL, NULL, NULL, 'Benin', 'Benin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:38:08', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(33, NULL, NULL, NULL, NULL, NULL, NULL, 'Bermuda', 'Bermuda', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:38:18', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(34, NULL, NULL, NULL, NULL, NULL, NULL, 'Bhutan', 'Bhutan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:38:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(35, NULL, NULL, NULL, NULL, NULL, NULL, 'Bolivia', 'Bolivia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:38:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(36, NULL, NULL, NULL, NULL, NULL, NULL, 'Bosnia & Herzegovina', 'Bosnia & Herzegovina', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:38:42', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(37, NULL, NULL, NULL, NULL, NULL, NULL, 'Botswana', 'Botswana', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:38:51', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(38, NULL, NULL, NULL, NULL, NULL, NULL, 'Brazil', 'Brazil', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:38:58', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(39, NULL, NULL, NULL, NULL, NULL, NULL, 'British Virgin Islands (BVI)', 'British Virgin Islands (BVI)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:39:05', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(40, NULL, NULL, NULL, NULL, NULL, NULL, 'Brunei Darussalam', 'Brunei Darussalam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:39:12', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(41, NULL, NULL, NULL, NULL, NULL, NULL, 'Bulgaria', 'Bulgaria', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:39:22', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(42, NULL, NULL, NULL, NULL, NULL, NULL, 'Burkina Faso', 'Burkina Faso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:39:29', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(43, NULL, NULL, NULL, NULL, NULL, NULL, 'Burundi', 'Burundi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 02:39:36', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(44, NULL, NULL, NULL, NULL, NULL, NULL, 'Cambodia', 'Cambodia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:03:20', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(45, NULL, NULL, NULL, NULL, NULL, NULL, 'Cameroon', 'Cameroon', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:03:28', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(46, NULL, NULL, NULL, NULL, NULL, NULL, 'Canada`', 'Canada`', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:03:36', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(47, NULL, NULL, NULL, NULL, NULL, NULL, 'Cape Verde', 'Cape Verde', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:03:46', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(48, NULL, NULL, NULL, NULL, NULL, NULL, 'Cayman Islands', 'Cayman Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:03:54', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(49, NULL, NULL, NULL, NULL, NULL, NULL, 'Central African Republic', 'Central African Republic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:04:01', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(50, NULL, NULL, NULL, NULL, NULL, NULL, 'Chad', 'Chad', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:04:08', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(51, NULL, NULL, NULL, NULL, NULL, NULL, 'Chile', 'Chile', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:04:15', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(52, NULL, NULL, NULL, NULL, NULL, NULL, 'China (PRC)', 'China (PRC)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:04:22', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(53, NULL, NULL, NULL, NULL, NULL, NULL, 'Christmas Island', 'Christmas Island', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:04:31', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(54, NULL, NULL, NULL, NULL, NULL, NULL, 'Cocos (Keeling) Islands', 'Cocos (Keeling) Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:04:38', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(55, NULL, NULL, NULL, NULL, NULL, NULL, 'Colombia', 'Colombia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:04:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(56, NULL, NULL, NULL, NULL, NULL, NULL, 'Comoros', 'Comoros', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:04:53', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(57, NULL, NULL, NULL, NULL, NULL, NULL, 'Congo, Dem Rep Of (formerly: Zaire)', 'Congo, Dem Rep Of (formerly: Zaire)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:05:00', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(58, NULL, NULL, NULL, NULL, NULL, NULL, 'Congo, People\'s Rep. Of', 'Congo, People\'s Rep. Of', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:05:08', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(59, NULL, NULL, NULL, NULL, NULL, NULL, 'Cook Islands', 'Cook Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:05:17', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(60, NULL, NULL, NULL, NULL, NULL, NULL, 'Costa Rica', 'Costa Rica', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:05:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(61, NULL, NULL, NULL, NULL, NULL, NULL, 'Croatia', 'Croatia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:05:32', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(62, NULL, NULL, NULL, NULL, NULL, NULL, 'Cuba', 'Cuba', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:05:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(63, NULL, NULL, NULL, NULL, NULL, NULL, 'Curacao', 'Curacao', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:05:46', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(64, NULL, NULL, NULL, NULL, NULL, NULL, 'Cyprus (Turkish Rep. Of Northern)', 'Cyprus (Turkish Rep. Of Northern)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:05:53', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(65, NULL, NULL, NULL, NULL, NULL, NULL, 'Cyprus, Rep. Of', 'Cyprus, Rep. Of', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:06:01', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(66, NULL, NULL, NULL, NULL, NULL, NULL, 'Czech Republic', 'Czech Republic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:06:09', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(67, NULL, NULL, NULL, NULL, NULL, NULL, 'Denmark', 'Denmark', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:06:16', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(68, NULL, NULL, NULL, NULL, NULL, NULL, 'Djibouti', 'Djibouti', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:06:26', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(69, NULL, NULL, NULL, NULL, NULL, NULL, 'Dominica', 'Dominica', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:06:33', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(70, NULL, NULL, NULL, NULL, NULL, NULL, 'Dominican Republic', 'Dominican Republic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:06:40', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(71, NULL, NULL, NULL, NULL, NULL, NULL, 'East Timor', 'East Timor', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:06:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(72, NULL, NULL, NULL, NULL, NULL, NULL, 'Ecuador', 'Ecuador', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:06:56', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(73, NULL, NULL, NULL, NULL, NULL, NULL, 'Egypt', 'Egypt', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:07:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(74, NULL, NULL, NULL, NULL, NULL, NULL, 'El Salvador', 'El Salvador', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:07:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(75, NULL, NULL, NULL, NULL, NULL, NULL, 'Equatorial Guinea', 'Equatorial Guinea', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:07:17', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(76, NULL, NULL, NULL, NULL, NULL, NULL, 'Eritrea', 'Eritrea', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:07:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(77, NULL, NULL, NULL, NULL, NULL, NULL, 'Estonia', 'Estonia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:07:32', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(78, NULL, NULL, NULL, NULL, NULL, NULL, 'Ethiopia', 'Ethiopia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:07:40', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(79, NULL, NULL, NULL, NULL, NULL, NULL, 'Falkland Islands', 'Falkland Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:07:47', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(80, NULL, NULL, NULL, NULL, NULL, NULL, 'Faroe Islands', 'Faroe Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:07:54', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(81, NULL, NULL, NULL, NULL, NULL, NULL, 'Fiji', 'Fiji', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:08:01', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(82, NULL, NULL, NULL, NULL, NULL, NULL, 'Finland', 'Finland', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:08:08', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(83, NULL, NULL, NULL, NULL, NULL, NULL, 'France', 'France', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:08:18', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(84, NULL, NULL, NULL, NULL, NULL, NULL, 'French Guiana', 'French Guiana', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:08:27', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(85, NULL, NULL, NULL, NULL, NULL, NULL, 'French Polynesia', 'French Polynesia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:08:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(86, NULL, NULL, NULL, NULL, NULL, NULL, 'Gabon', 'Gabon', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:08:40', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(87, NULL, NULL, NULL, NULL, NULL, NULL, 'Gambia', 'Gambia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:08:47', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(88, NULL, NULL, NULL, NULL, NULL, NULL, 'Georgia', 'Georgia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:08:54', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(89, NULL, NULL, NULL, NULL, NULL, NULL, 'Ghana', 'Ghana', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:09:13', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(90, NULL, NULL, NULL, NULL, NULL, NULL, 'Gibraltar', 'Gibraltar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:09:19', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(91, NULL, NULL, NULL, NULL, NULL, NULL, 'Greece', 'Greece', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:09:27', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(92, NULL, NULL, NULL, NULL, NULL, NULL, 'Greenland', 'Greenland', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:09:35', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(93, NULL, NULL, NULL, NULL, NULL, NULL, 'Grenada', 'Grenada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:09:42', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(94, NULL, NULL, NULL, NULL, NULL, NULL, 'Guadeloupe', 'Guadeloupe', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:09:50', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(95, NULL, NULL, NULL, NULL, NULL, NULL, 'Guam', 'Guam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:09:56', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(96, NULL, NULL, NULL, NULL, NULL, NULL, 'Guatemala', 'Guatemala', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:10:03', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(97, NULL, NULL, NULL, NULL, NULL, NULL, 'Guernsey (Channel Isl.)', 'Guernsey (Channel Isl.)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:10:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(98, NULL, NULL, NULL, NULL, NULL, NULL, 'Guinea Bissau', 'Guinea Bissau', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:10:17', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(99, NULL, NULL, NULL, NULL, NULL, NULL, 'Guinea, Rep. Of', 'Guinea, Rep. Of', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:10:27', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(100, NULL, NULL, NULL, NULL, NULL, NULL, 'Guyana', 'Guyana', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:10:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(101, NULL, NULL, NULL, NULL, NULL, NULL, 'Haiti', 'Haiti', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:10:41', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(102, NULL, NULL, NULL, NULL, NULL, NULL, 'Honduras', 'Honduras', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:10:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(103, NULL, NULL, NULL, NULL, NULL, NULL, 'Hungary', 'Hungary', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:10:56', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(104, NULL, NULL, NULL, NULL, NULL, NULL, 'Iceland', 'Iceland', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:11:03', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(105, NULL, NULL, NULL, NULL, NULL, NULL, 'Indonesia', 'Indonesia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:11:12', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(106, NULL, NULL, NULL, NULL, NULL, NULL, 'Iran', 'Iran', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:11:19', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(107, NULL, NULL, NULL, NULL, NULL, NULL, 'Iraq', 'Iraq', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:11:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(108, NULL, NULL, NULL, NULL, NULL, NULL, 'Ireland (Eire)', 'Ireland (Eire)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:11:36', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(109, NULL, NULL, NULL, NULL, NULL, NULL, 'Isle of Man', 'Isle of Man', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:11:44', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(110, NULL, NULL, NULL, NULL, NULL, NULL, 'Israel', 'Israel', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:11:50', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(111, NULL, NULL, NULL, NULL, NULL, NULL, 'Ivory Coast (Cote D’Ivoire)', 'Ivory Coast (Cote D’Ivoire)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:12:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(112, NULL, NULL, NULL, NULL, NULL, NULL, 'Jamaica', 'Jamaica', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:12:17', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(113, NULL, NULL, NULL, NULL, NULL, NULL, 'Jersey (Channel Isl.)', 'Jersey (Channel Isl.)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:12:31', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(114, NULL, NULL, NULL, NULL, NULL, NULL, 'Jordan', 'Jordan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:12:38', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(115, NULL, NULL, NULL, NULL, NULL, NULL, 'Kazakhstan', 'Kazakhstan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:12:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(116, NULL, NULL, NULL, NULL, NULL, NULL, 'Kenya', 'Kenya', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:12:55', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(117, NULL, NULL, NULL, NULL, NULL, NULL, 'Kiribati', 'Kiribati', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:13:02', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(118, NULL, NULL, NULL, NULL, NULL, NULL, 'Korea, North', 'Korea, North', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:13:09', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(119, NULL, NULL, NULL, NULL, NULL, NULL, 'Korea, South', 'Korea, South', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:13:16', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(120, NULL, NULL, NULL, NULL, NULL, NULL, 'Kosovo', 'Kosovo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:13:23', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(121, NULL, NULL, NULL, NULL, NULL, NULL, 'Kuwait', 'Kuwait', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:13:31', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(122, NULL, NULL, NULL, NULL, NULL, NULL, 'Kyrgyzstan', 'Kyrgyzstan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:13:38', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(123, NULL, NULL, NULL, NULL, NULL, NULL, 'Laos', 'Laos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:13:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(124, NULL, NULL, NULL, NULL, NULL, NULL, 'Latvia', 'Latvia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:13:53', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(125, NULL, NULL, NULL, NULL, NULL, NULL, 'Lebanon', 'Lebanon', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:14:00', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(126, NULL, NULL, NULL, NULL, NULL, NULL, 'Lesotho', 'Lesotho', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:14:07', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(127, NULL, NULL, NULL, NULL, NULL, NULL, 'Liberia', 'Liberia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:14:13', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(128, NULL, NULL, NULL, NULL, NULL, NULL, 'Libya', 'Libya', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:14:21', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(129, NULL, NULL, NULL, NULL, NULL, NULL, 'Liechtenstein', 'Liechtenstein', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:14:28', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(130, NULL, NULL, NULL, NULL, NULL, NULL, 'Lithuania', 'Lithuania', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:14:35', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(131, NULL, NULL, NULL, NULL, NULL, NULL, 'Luxembourg', 'Luxembourg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(132, NULL, NULL, NULL, NULL, NULL, NULL, 'Macau', 'Macau', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(133, NULL, NULL, NULL, NULL, NULL, NULL, 'Macedonia', 'Macedonia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(134, NULL, NULL, NULL, NULL, NULL, NULL, 'Madagascar', 'Madagascar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(135, NULL, NULL, NULL, NULL, NULL, NULL, 'Malawi', 'Malawi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(136, NULL, NULL, NULL, NULL, NULL, NULL, 'Malaysia', 'Malaysia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(137, NULL, NULL, NULL, NULL, NULL, NULL, 'Maldives', 'Maldives', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(138, NULL, NULL, NULL, NULL, NULL, NULL, 'Mali', 'Mali', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(139, NULL, NULL, NULL, NULL, NULL, NULL, 'Malta', 'Malta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:15:48', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(140, NULL, NULL, NULL, NULL, NULL, NULL, 'Marshall Islands', 'Marshall Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(141, NULL, NULL, NULL, NULL, NULL, NULL, 'Martinique', 'Martinique', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(142, NULL, NULL, NULL, NULL, NULL, NULL, 'Mauritania', 'Mauritania', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(143, NULL, NULL, NULL, NULL, NULL, NULL, 'Mauritius', 'Mauritius', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(144, NULL, NULL, NULL, NULL, NULL, NULL, 'Mayotte', 'Mayotte', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(145, NULL, NULL, NULL, NULL, NULL, NULL, 'Mexico', 'Mexico', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(146, NULL, NULL, NULL, NULL, NULL, NULL, 'Micronesia, Fed. States Of', 'Micronesia, Fed. States Of', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(147, NULL, NULL, NULL, NULL, NULL, NULL, 'Moldova', 'Moldova', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(148, NULL, NULL, NULL, NULL, NULL, NULL, 'Monaco', 'Monaco', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:17:34', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(149, NULL, NULL, NULL, NULL, NULL, NULL, 'Mongolia', 'Mongolia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(150, NULL, NULL, NULL, NULL, NULL, NULL, 'Montenegro', 'Montenegro', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(151, NULL, NULL, NULL, NULL, NULL, NULL, 'Montserrat', 'Montserrat', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(152, NULL, NULL, NULL, NULL, NULL, NULL, 'Morocco', 'Morocco', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(153, NULL, NULL, NULL, NULL, NULL, NULL, 'Mozambique', 'Mozambique', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(154, NULL, NULL, NULL, NULL, NULL, NULL, 'Myanmar', 'Myanmar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(155, NULL, NULL, NULL, NULL, NULL, NULL, 'Namibia', 'Namibia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(156, NULL, NULL, NULL, NULL, NULL, NULL, 'Nauru', 'Nauru', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(157, NULL, NULL, NULL, NULL, NULL, NULL, 'Nepal', 'Nepal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(158, NULL, NULL, NULL, NULL, NULL, NULL, 'Netherlands', 'Netherlands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(159, NULL, NULL, NULL, NULL, NULL, NULL, 'Netherlands Antilles', 'Netherlands Antilles', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:19:11', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(160, NULL, NULL, NULL, NULL, NULL, NULL, 'New Caledonia', 'New Caledonia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(161, NULL, NULL, NULL, NULL, NULL, NULL, 'New Zealand', 'New Zealand', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(162, NULL, NULL, NULL, NULL, NULL, NULL, 'Nicaragua', 'Nicaragua', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(163, NULL, NULL, NULL, NULL, NULL, NULL, 'Niger', 'Niger', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(164, NULL, NULL, NULL, NULL, NULL, NULL, 'Nigeria', 'Nigeria', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(165, NULL, NULL, NULL, NULL, NULL, NULL, 'Niue', 'Niue', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(166, NULL, NULL, NULL, NULL, NULL, NULL, 'Norfolk Island', 'Norfolk Island', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(167, NULL, NULL, NULL, NULL, NULL, NULL, 'Norway', 'Norway', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(168, NULL, NULL, NULL, NULL, NULL, NULL, 'Oman', 'Oman', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(169, NULL, NULL, NULL, NULL, NULL, NULL, 'Palau', 'Palau', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:20:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(170, NULL, NULL, NULL, NULL, NULL, NULL, 'Palestine, Autononymous Region', 'Palestine, Autononymous Region', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(171, NULL, NULL, NULL, NULL, NULL, NULL, 'Panama', 'Panama', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(172, NULL, NULL, NULL, NULL, NULL, NULL, 'Papua New Guinea', 'Papua New Guinea', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(173, NULL, NULL, NULL, NULL, NULL, NULL, 'Paraguay', 'Paraguay', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(174, NULL, NULL, NULL, NULL, NULL, NULL, 'Peru', 'Peru', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(175, NULL, NULL, NULL, NULL, NULL, NULL, 'Philippines', 'Philippines', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(176, NULL, NULL, NULL, NULL, NULL, NULL, 'Portugal', 'Portugal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(177, NULL, NULL, NULL, NULL, NULL, NULL, 'Puerto Rico', 'Puerto Rico', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(178, NULL, NULL, NULL, NULL, NULL, NULL, 'Qatar', 'Qatar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:21:49', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(179, NULL, NULL, NULL, NULL, NULL, NULL, 'Reunion Island', 'Reunion Island', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(180, NULL, NULL, NULL, NULL, NULL, NULL, 'Romania', 'Romania', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(181, NULL, NULL, NULL, NULL, NULL, NULL, 'Russian Federation', 'Russian Federation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(182, NULL, NULL, NULL, NULL, NULL, NULL, 'Rwanda', 'Rwanda', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(183, NULL, NULL, NULL, NULL, NULL, NULL, 'Saipan', 'Saipan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(184, NULL, NULL, NULL, NULL, NULL, NULL, 'Samoa (Western Samoa)', 'Samoa (Western Samoa)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(185, NULL, NULL, NULL, NULL, NULL, NULL, 'San Marino', 'San Marino', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(186, NULL, NULL, NULL, NULL, NULL, NULL, 'Sao Tome & Principe', 'Sao Tome & Principe', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(187, NULL, NULL, NULL, NULL, NULL, NULL, 'Saudi Arabia', 'Saudi Arabia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(188, NULL, NULL, NULL, NULL, NULL, NULL, 'Senegal', 'Senegal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(189, NULL, NULL, NULL, NULL, NULL, NULL, 'Serbia', 'Serbia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(190, NULL, NULL, NULL, NULL, NULL, NULL, 'Seychelles', 'Seychelles', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:23:14', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(191, NULL, NULL, NULL, NULL, NULL, NULL, 'Sierra Leone', 'Sierra Leone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(192, NULL, NULL, NULL, NULL, NULL, NULL, 'Singapore', 'Singapore', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(193, NULL, NULL, NULL, NULL, NULL, NULL, 'Slovakia', 'Slovakia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(194, NULL, NULL, NULL, NULL, NULL, NULL, 'Slovenia', 'Slovenia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(195, NULL, NULL, NULL, NULL, NULL, NULL, 'Solomon Islands', 'Solomon Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(196, NULL, NULL, NULL, NULL, NULL, NULL, 'Somalia', 'Somalia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(197, NULL, NULL, NULL, NULL, NULL, NULL, 'South Africa', 'South Africa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(198, NULL, NULL, NULL, NULL, NULL, NULL, 'Spain', 'Spain', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(199, NULL, NULL, NULL, NULL, NULL, NULL, 'Sri Lanka', 'Sri Lanka', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(200, NULL, NULL, NULL, NULL, NULL, NULL, 'St. Barthelemy', 'St. Barthelemy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(201, NULL, NULL, NULL, NULL, NULL, NULL, 'St. Helena', 'St. Helena', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(202, NULL, NULL, NULL, NULL, NULL, NULL, 'St. Kitts & Nevis', 'St. Kitts & Nevis', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0);
INSERT INTO `products` (`id`, `brand_id`, `category_id`, `type_id`, `model_id`, `unit_id`, `dealer_id`, `name`, `short_name`, `slug`, `bin_number`, `description`, `list_price`, `sell_price`, `code`, `image`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `articlecode`, `product_type`, `variant_type`, `parent_id`, `isVariant`, `color`, `size`, `value`, `isCustom`, `isBundle`, `vat`, `isVat_percent`, `tax`, `isTax_percent`, `barcode`, `stock`, `pack_size`, `is_trash`) VALUES
(203, NULL, NULL, NULL, NULL, NULL, NULL, 'St. Lucia', 'St. Lucia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:24:39', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(204, NULL, NULL, NULL, NULL, NULL, NULL, 'St. Martin (French)', 'St. Martin (French)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(205, NULL, NULL, NULL, NULL, NULL, NULL, 'St. Pierre & Miquelon', 'St. Pierre & Miquelon', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(206, NULL, NULL, NULL, NULL, NULL, NULL, 'St. Vincent & Grenardines', 'St. Vincent & Grenardines', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(207, NULL, NULL, NULL, NULL, NULL, NULL, 'Sudan', 'Sudan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(208, NULL, NULL, NULL, NULL, NULL, NULL, 'Suriname', 'Suriname', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(209, NULL, NULL, NULL, NULL, NULL, NULL, 'Swaziland', 'Swaziland', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(210, NULL, NULL, NULL, NULL, NULL, NULL, 'Sweden', 'Sweden', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(211, NULL, NULL, NULL, NULL, NULL, NULL, 'Syria', 'Syria', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(212, NULL, NULL, NULL, NULL, NULL, NULL, 'Switzerland', 'Switzerland', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(213, NULL, NULL, NULL, NULL, NULL, NULL, 'Tahiti (French Polynesia)', 'Tahiti (French Polynesia)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(214, NULL, NULL, NULL, NULL, NULL, NULL, 'Taiwan', 'Taiwan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(215, NULL, NULL, NULL, NULL, NULL, NULL, 'Tajikistan', 'Tajikistan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(216, NULL, NULL, NULL, NULL, NULL, NULL, 'Tanzania', 'Tanzania', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:26:10', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(217, NULL, NULL, NULL, NULL, NULL, NULL, 'Thailand', 'Thailand', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:27:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(218, NULL, NULL, NULL, NULL, NULL, NULL, 'Togo', 'Togo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:27:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(219, NULL, NULL, NULL, NULL, NULL, NULL, 'Tokelau Islands', 'Tokelau Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:27:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(220, NULL, NULL, NULL, NULL, NULL, NULL, 'Tonga', 'Tonga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:27:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(221, NULL, NULL, NULL, NULL, NULL, NULL, 'Trinidad & Tobago', 'Trinidad & Tobago', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:27:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(222, NULL, NULL, NULL, NULL, NULL, NULL, 'Tunisia', 'Tunisia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:27:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(223, NULL, NULL, NULL, NULL, NULL, NULL, 'Turkey', 'Turkey', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:27:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(224, NULL, NULL, NULL, NULL, NULL, NULL, 'Turkmenistan', 'Turkmenistan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:27:04', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(225, NULL, NULL, NULL, NULL, NULL, NULL, 'Turks & Caicos Islands', 'Turks & Caicos Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(226, NULL, NULL, NULL, NULL, NULL, NULL, 'Tuvalu', 'Tuvalu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(227, NULL, NULL, NULL, NULL, NULL, NULL, 'Uganda', 'Uganda', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(228, NULL, NULL, NULL, NULL, NULL, NULL, 'Ukraine', 'Ukraine', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(229, NULL, NULL, NULL, NULL, NULL, NULL, 'United Arab Emirates (UAE)', 'UAE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(230, NULL, NULL, NULL, NULL, NULL, NULL, 'United Kingdom', 'UK', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(231, NULL, NULL, NULL, NULL, NULL, NULL, 'United States Of America', 'USA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(232, NULL, NULL, NULL, NULL, NULL, NULL, 'Uruguay', 'Uruguay', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(233, NULL, NULL, NULL, NULL, NULL, NULL, 'US Virgin Islands (USVI)', 'US Virgin Islands (USVI)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:28:25', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(234, NULL, NULL, NULL, NULL, NULL, NULL, 'Uzbekistan', 'Uzbekistan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:30:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(235, NULL, NULL, NULL, NULL, NULL, NULL, 'Vietnam', 'Vietnam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:30:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(236, NULL, NULL, NULL, NULL, NULL, NULL, 'Wallis & Futuna Islands', 'Wallis & Futuna Islands', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:30:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(237, NULL, NULL, NULL, NULL, NULL, NULL, 'Western Sahara', 'Western Sahara', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:30:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(238, NULL, NULL, NULL, NULL, NULL, NULL, 'Yemen', 'Yemen', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:30:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(239, NULL, NULL, NULL, NULL, NULL, NULL, 'Zambia', 'Zambia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:30:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(240, NULL, NULL, NULL, NULL, NULL, NULL, 'Zimbabwe', 'Zimbabwe', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:30:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0),
(241, NULL, NULL, NULL, NULL, NULL, NULL, 'Venezuela', 'Venezuela', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 1, NULL, '2024-12-07 03:30:45', NULL, NULL, 1, NULL, NULL, 0, NULL, NULL, '1', 0, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, 0);
...
INSERT INTO `religions` (`id`, `name`, `status`, `created_at`, `updated_at`, `created_by`, `updated_by`, `is_trash`) VALUES
(1, 'Islam', 'active', '2022-10-19 04:30:04', '0000-00-00 00:00:00', 1, 1, 0),
(2, 'Hindu', 'active', '2022-10-19 04:30:04', '0000-00-00 00:00:00', 1, 1, 0),
(3, 'Buddhism', 'active', '2022-10-19 04:30:04', '0000-00-00 00:00:00', 1, 1, 0),
(4, 'Christan', 'active', '2022-10-19 04:30:04', '0000-00-00 00:00:00', 1, 1, 0);
...
INSERT INTO `roles` (`id`, `name`, `guard_name`, `status`, `is_trash`, `created_at`, `updated_at`) VALUES
(1, 'Super Admin', 'web', 'active', 0, '2022-11-14 09:28:30', '2023-07-30 10:55:27'),
(2, 'Teacher', 'web', 'active', 0, '2022-11-14 09:36:19', '2022-11-14 09:36:19'),
(3, 'Admin2', 'web', 'active', 0, '2022-11-16 02:43:35', '2022-11-16 02:43:35'),
(4, 'Viewer', 'web', 'active', 0, '2023-06-16 16:38:10', '2023-06-16 16:38:10');
...
CREATE TABLE `salary_item` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `type` enum('1','2','3') DEFAULT '1' COMMENT '1 = gross, 2 = deduction, 3 = allowance',
  `amount_type` enum('flat','percentage') DEFAULT NULL,
  `amount` int(11) DEFAULT NULL,
  `status` enum('active','inactive','cancel') NOT NULL,
  `is_trash` int(11) NOT NULL,
...
CREATE TABLE `sales` (
  `id` int(10) UNSIGNED NOT NULL,
  `sales_type` enum('full','partial','installment') DEFAULT NULL,
  `customer_id` int(10) UNSIGNED DEFAULT NULL,
  `dealer_id` int(10) UNSIGNED DEFAULT NULL,
  `prev_customer_credit` varchar(64) DEFAULT NULL,
  `sales_invoice_no` varchar(128) DEFAULT NULL,
  `sales_invoice_date` varchar(64) DEFAULT NULL,
  `status` enum('active','inactive','cancel') DEFAULT NULL,
  ...
  `merge_amount` float DEFAULT NULL,
  `delivery_type` enum('regular','currier') DEFAULT NULL,
  `previous_due` float DEFAULT 0,
  `due_product_relation_id` int(11) DEFAULT NULL,
  `booking_amount` float DEFAULT NULL,
  `condition_payment` float DEFAULT NULL,
  `delivery_date` varchar(255) DEFAULT NULL,
  `delivery_status` enum('Delivered','NotDelivered') NOT NULL,
  `work_order` varchar(255) DEFAULT NULL,
  `workorder_date` varchar(255) DEFAULT NULL,
  `delivery_place` varchar(255) DEFAULT NULL,
  `vehicle_type` varchar(255) DEFAULT NULL,
  `grn` varchar(255) DEFAULT NULL,
  `subtotal` float DEFAULT NULL,
  `discount_option` varchar(11) DEFAULT NULL,
  `discount` float DEFAULT 0,
  `paid_amount` double(10,2) DEFAULT 0.00,
  `total_due` double(10,2) DEFAULT 0.00,
  `display_name` varchar(255) DEFAULT NULL,
  `isOld` int(11) DEFAULT 0,
  `adjustment_amount` double(10,2) DEFAULT NULL,
  `sales_data_type` varchar(255) DEFAULT NULL,
  `total_interest_amount` double(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
INSERT INTO `sales_chart` (`id`, `dealer_id`, `name`, `slug`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `withdraw`, `is_trash`) VALUES
(1, NULL, 'Office Expanse', 'office-expanse', 'active', 1, NULL, '2025-07-14 04:47:28', NULL, 0, 0);
...
CREATE TABLE `sales_payment` (
  ...
  `dealer_id` int(10) UNSIGNED DEFAULT NULL,
  `sales_payment_date` varchar(64) NOT NULL,
  `absolute_amount` double(10,2) DEFAULT NULL,
  `sales_discount` double(10,2) DEFAULT NULL,
  `discount_option` varchar(64) DEFAULT NULL,
  `interest_rate` double(10,2) DEFAULT NULL,
  `interest_amount` double(10,2) DEFAULT NULL,
  `installment_no` int(10) UNSIGNED DEFAULT NULL,
  `rate_per_installment` double(10,2) DEFAULT NULL,
  `grand_total` double(10,2) DEFAULT NULL,
  `down_payment` double(10,2) DEFAULT NULL,
  `due_payment` double(10,2) DEFAULT NULL,
  `advance_payment` double(10,2) DEFAULT NULL,
  `settlement_amount` double(10,2) DEFAULT NULL,
  `last_installment_date` varchar(64) DEFAULT NULL,
  `write_of` int(11) NOT NULL,
  `note` text DEFAULT NULL,
  `status` enum('active','inactive','cancel') DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_by` int(10) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `payment_relation_id` int(11) DEFAULT NULL,
  `refund_amount` double(10,2) DEFAULT NULL,
  `payment_type` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
--
-- Table structure for table `sales_payment_version`
--

CREATE TABLE `sales_payment_version` (
  `id` int(10) UNSIGNED NOT NULL,
  `sales_id` int(10) UNSIGNED DEFAULT NULL,
  `dealer_id` int(10) UNSIGNED DEFAULT NULL,
  `sales_payment_date` varchar(64) NOT NULL,
...
--
-- Table structure for table `sales_product_relation`
--

CREATE TABLE `sales_product_relation` (
  `id` int(10) UNSIGNED NOT NULL,
  `customer_category_id` int(11) NOT NULL,
  `sales_id` int(10) UNSIGNED DEFAULT NULL,
  `product_id` int(10) UNSIGNED DEFAULT NULL,
  `quantity` int(10) UNSIGNED DEFAULT NULL,
  `discount_option` enum('cash','percentage') DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `sales_group_id` int(11) NOT NULL DEFAULT 1,
  ...
  `makerCountry` varchar(255) DEFAULT NULL,
  `package_qty` int(11) DEFAULT NULL,
  `value` double DEFAULT NULL,
  `total_value` double(10,6) DEFAULT NULL,
  `loose_qty` int(11) DEFAULT NULL,
  `product_sales_type` int(11) DEFAULT 1 COMMENT '1=regular,2=bonus ',
  `bonus_parent_product_id` int(11) DEFAULT NULL,
  `actual_price` varchar(255) DEFAULT NULL,
  `remain_due` varchar(255) DEFAULT NULL,
  `note` text DEFAULT NULL,
  `month_id` varchar(191) DEFAULT NULL,
  `academic_year_id` varchar(191) DEFAULT NULL,
  `contact_payable_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `sales_product_relation_version`
--

CREATE TABLE `sales_product_relation_version` (
  `id` int(10) UNSIGNED NOT NULL,
  `customer_category_id` int(11) NOT NULL,
  `sales_id` int(10) UNSIGNED DEFAULT NULL,
  `product_id` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Table structure for table `sales_version`
--

CREATE TABLE `sales_version` (
  `id` int(10) UNSIGNED NOT NULL,
  `sales_type` enum('full','partial','installment') DEFAULT NULL,
  `customer_id` int(10) UNSIGNED DEFAULT NULL,
  `dealer_id` int(10) UNSIGNED DEFAULT NULL,
  ...
  `delivery_status` enum('Delivered','NotDelivered') NOT NULL,
  `work_order` varchar(255) DEFAULT NULL,
  `workorder_date` int(11) DEFAULT NULL,
  `delivery_place` varchar(255) DEFAULT NULL,
  `vehicle_type` varchar(255) DEFAULT NULL,
  `grn` varchar(255) DEFAULT NULL,
  `subtotal` float DEFAULT NULL,
...
--
-- Table structure for table `section_relations`
--

CREATE TABLE `section_relations` (
  `id` int(11) NOT NULL,
  `class_id` int(11) NOT NULL,
  `section_id` int(11) DEFAULT NULL,
  `academic_year_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `sid_config`
--

CREATE TABLE `sid_config` (
  `id` int(11) NOT NULL,
  `prefix` varchar(255) DEFAULT NULL,
  `year` varchar(255) DEFAULT NULL,
  `month` varchar(255) DEFAULT NULL,
  `sign_align_date` varchar(255) DEFAULT NULL,
  `digits` varchar(255) DEFAULT NULL,
  `restart_every_year` int(11) DEFAULT NULL,
  `defaultManualCustomizeSID` int(11) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `sms_batch_table`
--

CREATE TABLE `sms_batch_table` (
  `id` int(11) NOT NULL,
  `date` varchar(64) DEFAULT NULL,
  `enum_type` enum('dynamic','guardian','teacher','due','resend') DEFAULT NULL,
  `number_of_sms` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL
...
--
-- Table structure for table `student_imp`
--

CREATE TABLE `student_imp` (
  `id` int(11) NOT NULL,
  `name` text DEFAULT NULL,
  `class` text DEFAULT NULL,
  `guardian` text DEFAULT NULL,
  `phone_m` text DEFAULT NULL,
  `phone_f` text DEFAULT NULL,
...
CREATE TABLE `student_marks` (
  ...
  `lab_mark` int(11) DEFAULT NULL,
  `total_mark` decimal(10,2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE `student_marks_details` (
  ...
  `attribute_mark_id` int(11) DEFAULT NULL,
  `attribute_marks` int(11) DEFAULT NULL,
...
--
-- Table structure for table `student_marks_details_version`
--

CREATE TABLE `student_marks_details_version` (
  `id` int(11) NOT NULL,
  `student_marks_details_id` int(11) DEFAULT NULL,
  `student_info_id` int(11) DEFAULT NULL,
  `attribute_mark_id` int(11) DEFAULT NULL,
  `attribute_marks` int(11) DEFAULT NULL,
  `date` varchar(191) DEFAULT NULL,
...
CREATE TABLE `subjects` (
  ...
  `status` enum('active','cancel','inactive') CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
...
--
-- Table structure for table `subject_relations`
--
...
INSERT INTO `supplier_pricing` (`id`, `product_id`, `customer_category_id`, `territory_id`, `customer_id`, `academic_year_id`, `class_id`, `price`, `dealer_id`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `effective_date`) VALUES
(1, 1, NULL, NULL, NULL, NULL, NULL, 40, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(2, 2, NULL, NULL, NULL, NULL, NULL, 65, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(3, 1, NULL, NULL, NULL, NULL, NULL, 42, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(4, 2, NULL, NULL, NULL, NULL, NULL, 42, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(5, 3, NULL, NULL, NULL, NULL, NULL, 53, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(6, 18, NULL, NULL, NULL, NULL, NULL, 70, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(7, 23, NULL, NULL, NULL, NULL, NULL, 35, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(8, 30, NULL, NULL, NULL, NULL, NULL, 80, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(9, 38, NULL, NULL, NULL, NULL, NULL, 70, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(10, 51, NULL, NULL, NULL, NULL, NULL, 70, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(11, 52, NULL, NULL, NULL, NULL, NULL, 43, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(12, 65, NULL, NULL, NULL, NULL, NULL, 30, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(13, 73, NULL, NULL, NULL, NULL, NULL, 64, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(14, 83, NULL, NULL, NULL, NULL, NULL, 60, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(15, 105, NULL, NULL, NULL, NULL, NULL, 85, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(16, 108, NULL, NULL, NULL, NULL, NULL, 30, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(17, 230, NULL, NULL, NULL, NULL, NULL, 30, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(18, 4, NULL, NULL, NULL, NULL, NULL, 30, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(19, 192, NULL, NULL, NULL, NULL, NULL, 65, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(20, 187, NULL, NULL, NULL, NULL, NULL, 64, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(21, 1, NULL, NULL, NULL, NULL, NULL, 45, 8, 'active', 1, NULL, '2024-12-08 06:10:45', NULL, NULL),
(22, 7, NULL, NULL, NULL, NULL, NULL, 42, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(23, 230, NULL, NULL, NULL, NULL, NULL, 42, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(24, 6, NULL, NULL, NULL, NULL, NULL, 53, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(25, 8, NULL, NULL, NULL, NULL, NULL, 53, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(26, 5, NULL, NULL, NULL, NULL, NULL, 42, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(27, 4, NULL, NULL, NULL, NULL, NULL, 42, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(28, 192, NULL, NULL, NULL, NULL, NULL, 49, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(29, 187, NULL, NULL, NULL, NULL, NULL, 53, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(30, 6, NULL, NULL, NULL, NULL, NULL, 38, 10, 'active', 1, NULL, '2024-12-15 09:06:47', NULL, NULL),
(31, 157, NULL, NULL, NULL, NULL, NULL, 53, 5, 'active', 1, NULL, '2024-12-14 16:31:08', NULL, NULL),
(32, 5, NULL, NULL, NULL, NULL, NULL, 78.2, 3, 'active', 1, NULL, '2025-01-18 06:10:08', NULL, NULL),
(33, 1, NULL, NULL, NULL, NULL, NULL, 10, 21, 'active', 1, NULL, '2025-07-14 10:48:16', NULL, NULL),
(34, 2, NULL, NULL, NULL, NULL, NULL, 50, 21, 'active', 1, NULL, '2025-07-14 10:48:16', NULL, NULL),
(35, 3, NULL, NULL, NULL, NULL, NULL, 40, 21, 'active', 1, NULL, '2025-07-14 10:48:16', NULL, NULL),
(36, 4, NULL, NULL, NULL, NULL, NULL, 42, 21, 'active', 1, NULL, '2025-07-14 10:48:16', NULL, NULL),
(37, 5, NULL, NULL, NULL, NULL, NULL, 44, 21, 'active', 1, NULL, '2025-07-14 10:48:16', NULL, NULL),
(38, 6, NULL, NULL, NULL, NULL, NULL, 14, 21, 'active', 1, NULL, '2025-07-14 10:48:16', NULL, NULL);
...
(492, 47, 'Kotwali', NULL, NULL, NULL, NULL),
(493, 47, 'Mohammadpur', NULL, NULL, NULL, NULL),
(494, 47, 'Lalbagh', NULL, NULL, NULL, NULL),
(495, 47, 'Sutrapur', NULL, NULL, NULL, NULL),
(496, 47, 'Motijgil', NULL, NULL, NULL, NULL),
(497, 47, 'Demra', NULL, NULL, NULL, NULL),
(498, 47, 'Sabujbagh', NULL, NULL, NULL, NULL),
(499, 47, 'Mirpur', NULL, NULL, NULL, NULL),
(500, 47, 'Gulshan', NULL, NULL, NULL, NULL),
(501, 47, 'Uttara', NULL, NULL, NULL, NULL),
(502, 47, 'Pallabi', NULL, NULL, NULL, NULL),
(503, 47, 'Cantonment', NULL, NULL, NULL, NULL),
(504, 47, 'Dhanmondi', NULL, NULL, NULL, NULL),
(505, 47, 'Tejgaon', NULL, NULL, NULL, NULL),
(506, 47, 'Ramna', NULL, NULL, NULL, NULL);
...
CREATE TABLE `users` (
  ...
  `type` enum('admin','dealer','outlet','sub-dealer') DEFAULT NULL,
  `status` enum('active','inactive','cancel') DEFAULT NULL,
...
INSERT INTO `users` (`id`, `email`, `password`, `first_name`, `last_name`, `mobile_no`, `nid`, `image`, `roles_id`, `outlet_id`, `type`, `status`, `remember_token`, `parent_id`, `created_by`, `updated_by`, `created_at`, `updated_at`, `expiry_date`, `email_verified_at`) VALUES
(1, 'admin@gmail.com', '$2y$10$Hkv/npS1WjRPKGPYBRThRu.A4QHPxqT34LtfJWWlBzmVQs5nFGZie', 'Super', 'Admin', '0', '0', NULL, 1, NULL, 'admin', 'active', 'RmWKtYtt0bWFxiO0eVjNlfD6ljTpUfsVvk5AgeH4M33DjIEaFRdfyIpnSUig', NULL, NULL, '1', NULL, '2023-03-06 00:51:53', '2040-12-01', NULL),
(2, 'support@easca-invoice.com', '$2y$10$WNXhuZnKL.X//jPlHbBd2efEZbAj44OGqjUw7Xe4Bj8ZF/oxc86.a', 'Support', 'Support', '0', '0', NULL, 4, NULL, 'admin', 'active', 'BIRzzmFY7QCgUlLa3fKcYLvsgxdvuQAurmP0n7Y7qI6tRcBml5jm8LEaOFOl', '1', '1', '2', '2020-03-05 19:11:58', '2023-06-16 16:42:40', '2040-08-31', NULL),
(6, 'ashraf@damm', '$2y$10$GzxYSTxqcjVNCs9lRQxLpe00146va5MPfBcps9DMtWyXVP7SlVRr6', 'Ashraf', 'Ali', '01860079842', NULL, 'profile.png', 2, NULL, 'admin', 'active', NULL, NULL, NULL, NULL, '2023-07-17 17:27:13', '2023-07-17 17:27:13', NULL, NULL);
...
CREATE TABLE `user_product_relation` (
  `id` int(10) UNSIGNED NOT NULL,
  `product_relation_id` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `user_product_relation` (`id`, `product_relation_id`, `auth_id`, `name`, `parent_id`, `type`, `slug`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `is_trash`) VALUES
(1, 1, NULL, '[\"India\"]', NULL, 'product', NULL, 'active', 1, NULL, '2024-11-13 18:32:31', '2024-12-07 15:16:20', 0),
(2, 2, NULL, 'Hong Kong', NULL, 'product', NULL, 'active', 1, NULL, '2024-11-13 18:43:11', '2024-11-13 18:43:11', 0),
(3, 3, NULL, 'Japan', NULL, 'product', NULL, 'active', 1, NULL, '2024-11-13 18:43:41', '2024-11-13 18:43:41', 0),
(4, 4, NULL, 'Italy', NULL, 'product', NULL, 'active', 1, NULL, '2024-11-28 12:47:09', '2024-11-28 12:47:09', 0),
(5, 5, NULL, 'Germany', NULL, 'product', NULL, 'active', 1, NULL, '2024-11-28 12:47:29', '2024-11-28 12:47:29', 0),
(6, 6, NULL, 'China', NULL, 'product', NULL, 'active', 1, NULL, '2024-11-28 12:48:15', '2024-11-28 12:48:15', 0),
(7, 7, NULL, 'Poland', NULL, 'product', NULL, 'active', 1, NULL, '2024-11-28 12:48:31', '2024-11-28 12:48:31', 0),
(8, 8, NULL, 'Pakistan', NULL, 'product', NULL, 'active', 1, NULL, '2024-11-28 12:48:52', '2024-11-28 12:48:52', 0),
(9, 9, NULL, 'Afghanistan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:32:11', '2024-12-07 14:32:11', 0),
(10, 10, NULL, 'Albania', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:32:35', '2024-12-07 14:32:35', 0),
(11, 11, NULL, 'Alderney (Channel Isl.)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:32:54', '2024-12-07 14:32:54', 0),
(12, 12, NULL, 'Algeria', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:33:20', '2024-12-07 14:33:20', 0),
(13, 13, NULL, 'American Samoa', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:34:14', '2024-12-07 14:34:14', 0),
(14, 14, NULL, 'Andorra', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:34:28', '2024-12-07 14:34:28', 0),
(15, 15, NULL, 'Angola', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:34:38', '2024-12-07 14:34:38', 0),
(16, 16, NULL, 'Anguilla', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:34:47', '2024-12-07 14:34:47', 0),
(17, 17, NULL, 'Antigua & Barbuda', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:34:56', '2024-12-07 14:34:56', 0),
(18, 18, NULL, 'Argentina', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:35:07', '2024-12-07 14:35:07', 0),
(19, 19, NULL, 'Armenia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:35:16', '2024-12-07 14:35:16', 0),
(20, 20, NULL, 'Aruba', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:35:28', '2024-12-07 14:35:28', 0),
(21, 21, NULL, 'Ascension Island', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:35:36', '2024-12-07 14:35:36', 0),
(22, 22, NULL, 'Australia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:35:45', '2024-12-07 14:35:45', 0),
(23, 23, NULL, 'Austria', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:36:50', '2024-12-07 14:36:50', 0),
(24, 24, NULL, 'Azerbaijan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:36:58', '2024-12-07 14:36:58', 0),
(25, 25, NULL, 'Bahamas', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:37:08', '2024-12-07 14:37:08', 0),
(26, 26, NULL, 'Bahrain', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:37:20', '2024-12-07 14:37:20', 0),
(27, 27, NULL, 'Bangladesh', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:37:30', '2024-12-07 14:37:30', 0),
(28, 28, NULL, 'Barbados', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:37:38', '2024-12-07 14:37:38', 0),
(29, 29, NULL, 'Belarus', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:37:45', '2024-12-07 14:37:45', 0),
(30, 30, NULL, 'Belgium', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:37:53', '2024-12-07 14:37:53', 0),
(31, 31, NULL, 'Belize', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:38:00', '2024-12-07 14:38:00', 0),
(32, 32, NULL, 'Benin', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:38:08', '2024-12-07 14:38:08', 0),
(33, 33, NULL, 'Bermuda', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:38:18', '2024-12-07 14:38:18', 0),
(34, 34, NULL, 'Bhutan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:38:25', '2024-12-07 14:38:25', 0),
(35, 35, NULL, 'Bolivia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:38:34', '2024-12-07 14:38:34', 0),
(36, 36, NULL, 'Bosnia & Herzegovina', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:38:42', '2024-12-07 14:38:42', 0),
(37, 37, NULL, 'Botswana', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:38:51', '2024-12-07 14:38:51', 0),
(38, 38, NULL, 'Brazil', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:38:58', '2024-12-07 14:38:58', 0),
(39, 39, NULL, 'British Virgin Islands (BVI)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:39:05', '2024-12-07 14:39:05', 0),
(40, 40, NULL, 'Brunei Darussalam', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:39:12', '2024-12-07 14:39:12', 0),
(41, 41, NULL, 'Bulgaria', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:39:22', '2024-12-07 14:39:22', 0),
(42, 42, NULL, 'Burkina Faso', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:39:29', '2024-12-07 14:39:29', 0),
(43, 43, NULL, 'Burundi', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 14:39:36', '2024-12-07 14:39:36', 0),
(44, 44, NULL, 'Cambodia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:03:20', '2024-12-07 15:03:20', 0),
(45, 45, NULL, 'Cameroon', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:03:28', '2024-12-07 15:03:28', 0),
(46, 46, NULL, 'Canada`', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:03:36', '2024-12-07 15:03:36', 0),
(47, 47, NULL, 'Cape Verde', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:03:46', '2024-12-07 15:03:46', 0),
(48, 48, NULL, 'Cayman Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:03:54', '2024-12-07 15:03:54', 0),
(49, 49, NULL, 'Central African Republic', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:04:01', '2024-12-07 15:04:01', 0),
(50, 50, NULL, 'Chad', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:04:08', '2024-12-07 15:04:08', 0),
(51, 51, NULL, 'Chile', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:04:15', '2024-12-07 15:04:15', 0),
(52, 52, NULL, 'China (PRC)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:04:22', '2024-12-07 15:04:22', 0),
(53, 53, NULL, 'Christmas Island', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:04:31', '2024-12-07 15:04:31', 0),
(54, 54, NULL, 'Cocos (Keeling) Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:04:38', '2024-12-07 15:04:38', 0),
(55, 55, NULL, 'Colombia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:04:45', '2024-12-07 15:04:45', 0),
(56, 56, NULL, 'Comoros', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:04:53', '2024-12-07 15:04:53', 0),
(57, 57, NULL, 'Congo, Dem Rep Of (formerly: Zaire)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:05:00', '2024-12-07 15:05:00', 0),
(58, 58, NULL, 'Congo, People\'s Rep. Of', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:05:08', '2024-12-07 15:05:08', 0),
(59, 59, NULL, 'Cook Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:05:17', '2024-12-07 15:05:17', 0),
(60, 60, NULL, 'Costa Rica', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:05:25', '2024-12-07 15:05:25', 0),
(61, 61, NULL, 'Croatia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:05:32', '2024-12-07 15:05:32', 0),
(62, 62, NULL, 'Cuba', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:05:39', '2024-12-07 15:05:39', 0),
(63, 63, NULL, 'Curacao', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:05:46', '2024-12-07 15:05:46', 0),
(64, 64, NULL, 'Cyprus (Turkish Rep. Of Northern)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:05:53', '2024-12-07 15:05:53', 0),
(65, 65, NULL, 'Cyprus, Rep. Of', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:06:01', '2024-12-07 15:06:01', 0),
(66, 66, NULL, 'Czech Republic', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:06:09', '2024-12-07 15:06:09', 0),
(67, 67, NULL, 'Denmark', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:06:16', '2024-12-07 15:06:16', 0),
(68, 68, NULL, 'Djibouti', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:06:26', '2024-12-07 15:06:26', 0),
(69, 69, NULL, 'Dominica', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:06:33', '2024-12-07 15:06:33', 0),
(70, 70, NULL, 'Dominican Republic', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:06:40', '2024-12-07 15:06:40', 0),
(71, 71, NULL, 'East Timor', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:06:49', '2024-12-07 15:06:49', 0),
(72, 72, NULL, 'Ecuador', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:06:56', '2024-12-07 15:06:56', 0),
(73, 73, NULL, 'Egypt', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:07:04', '2024-12-07 15:07:04', 0),
(74, 74, NULL, 'El Salvador', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:07:10', '2024-12-07 15:07:10', 0),
(75, 75, NULL, 'Equatorial Guinea', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:07:17', '2024-12-07 15:07:17', 0),
(76, 76, NULL, 'Eritrea', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:07:25', '2024-12-07 15:07:25', 0),
(77, 77, NULL, 'Estonia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:07:32', '2024-12-07 15:07:32', 0),
(78, 78, NULL, 'Ethiopia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:07:40', '2024-12-07 15:07:40', 0),
(79, 79, NULL, 'Falkland Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:07:47', '2024-12-07 15:07:47', 0),
(80, 80, NULL, 'Faroe Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:07:54', '2024-12-07 15:07:54', 0),
(81, 81, NULL, 'Fiji', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:08:01', '2024-12-07 15:08:01', 0),
(82, 82, NULL, 'Finland', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:08:08', '2024-12-07 15:08:08', 0),
(83, 83, NULL, 'France', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:08:18', '2024-12-07 15:08:18', 0),
(84, 84, NULL, 'French Guiana', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:08:27', '2024-12-07 15:08:27', 0),
(85, 85, NULL, 'French Polynesia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:08:34', '2024-12-07 15:08:34', 0),
(86, 86, NULL, 'Gabon', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:08:40', '2024-12-07 15:08:40', 0),
(87, 87, NULL, 'Gambia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:08:47', '2024-12-07 15:08:47', 0),
(88, 88, NULL, 'Georgia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:08:54', '2024-12-07 15:08:54', 0),
(89, 89, NULL, 'Ghana', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:09:13', '2024-12-07 15:09:13', 0),
(90, 90, NULL, 'Gibraltar', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:09:19', '2024-12-07 15:09:19', 0),
(91, 91, NULL, 'Greece', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:09:27', '2024-12-07 15:09:27', 0),
(92, 92, NULL, 'Greenland', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:09:35', '2024-12-07 15:09:35', 0),
(93, 93, NULL, 'Grenada', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:09:42', '2024-12-07 15:09:42', 0),
(94, 94, NULL, 'Guadeloupe', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:09:50', '2024-12-07 15:09:50', 0),
(95, 95, NULL, 'Guam', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:09:56', '2024-12-07 15:09:56', 0),
(96, 96, NULL, 'Guatemala', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:10:03', '2024-12-07 15:10:03', 0),
(97, 97, NULL, 'Guernsey (Channel Isl.)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:10:10', '2024-12-07 15:10:10', 0),
(98, 98, NULL, 'Guinea Bissau', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:10:17', '2024-12-07 15:10:17', 0),
(99, 99, NULL, 'Guinea, Rep. Of', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:10:27', '2024-12-07 15:10:27', 0),
(100, 100, NULL, 'Guyana', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:10:34', '2024-12-07 15:10:34', 0),
(101, 101, NULL, 'Haiti', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:10:41', '2024-12-07 15:10:41', 0),
(102, 102, NULL, 'Honduras', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:10:48', '2024-12-07 15:10:48', 0),
(103, 103, NULL, 'Hungary', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:10:56', '2024-12-07 15:10:56', 0),
(104, 104, NULL, 'Iceland', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:11:03', '2024-12-07 15:11:03', 0),
(105, 105, NULL, 'Indonesia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:11:12', '2024-12-07 15:11:12', 0),
(106, 106, NULL, 'Iran', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:11:19', '2024-12-07 15:11:19', 0),
(107, 107, NULL, 'Iraq', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:11:25', '2024-12-07 15:11:25', 0),
(108, 108, NULL, 'Ireland (Eire)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:11:36', '2024-12-07 15:11:36', 0),
(109, 109, NULL, 'Isle of Man', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:11:44', '2024-12-07 15:11:44', 0),
(110, 110, NULL, 'Israel', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:11:50', '2024-12-07 15:11:50', 0),
(111, 111, NULL, 'Ivory Coast (Cote D’Ivoire)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:12:10', '2024-12-07 15:12:10', 0),
(112, 112, NULL, 'Jamaica', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:12:17', '2024-12-07 15:12:17', 0),
(113, 113, NULL, 'Jersey (Channel Isl.)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:12:31', '2024-12-07 15:12:31', 0),
(114, 114, NULL, 'Jordan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:12:38', '2024-12-07 15:12:38', 0),
(115, 115, NULL, 'Kazakhstan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:12:49', '2024-12-07 15:12:49', 0),
(116, 116, NULL, 'Kenya', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:12:55', '2024-12-07 15:12:55', 0),
(117, 117, NULL, 'Kiribati', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:13:02', '2024-12-07 15:13:02', 0),
(118, 118, NULL, 'Korea, North', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:13:09', '2024-12-07 15:13:09', 0),
(119, 119, NULL, 'Korea, South', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:13:16', '2024-12-07 15:13:16', 0),
(120, 120, NULL, 'Kosovo', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:13:23', '2024-12-07 15:13:23', 0),
(121, 121, NULL, 'Kuwait', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:13:31', '2024-12-07 15:13:31', 0),
(122, 122, NULL, 'Kyrgyzstan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:13:38', '2024-12-07 15:13:38', 0),
(123, 123, NULL, 'Laos', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:13:45', '2024-12-07 15:13:45', 0),
(124, 124, NULL, 'Latvia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:13:53', '2024-12-07 15:13:53', 0),
(125, 125, NULL, 'Lebanon', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:14:00', '2024-12-07 15:14:00', 0),
(126, 126, NULL, 'Lesotho', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:14:07', '2024-12-07 15:14:07', 0),
(127, 127, NULL, 'Liberia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:14:13', '2024-12-07 15:14:13', 0),
(128, 128, NULL, 'Libya', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:14:21', '2024-12-07 15:14:21', 0),
(129, 129, NULL, 'Liechtenstein', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:14:28', '2024-12-07 15:14:28', 0),
(130, 130, NULL, 'Lithuania', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:14:35', '2024-12-07 15:14:35', 0),
(131, 131, NULL, 'Luxembourg', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(132, 132, NULL, 'Macau', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(133, 133, NULL, 'Macedonia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(134, 134, NULL, 'Madagascar', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(135, 135, NULL, 'Malawi', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(136, 136, NULL, 'Malaysia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(137, 137, NULL, 'Maldives', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(138, 138, NULL, 'Mali', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(139, 139, NULL, 'Malta', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:15:48', '2024-12-07 15:15:48', 0),
(140, 140, NULL, 'Marshall Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(141, 141, NULL, 'Martinique', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(142, 142, NULL, 'Mauritania', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(143, 143, NULL, 'Mauritius', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(144, 144, NULL, 'Mayotte', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(145, 145, NULL, 'Mexico', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(146, 146, NULL, 'Micronesia, Fed. States Of', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(147, 147, NULL, 'Moldova', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(148, 148, NULL, 'Monaco', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:17:34', '2024-12-07 15:17:34', 0),
(149, 149, NULL, 'Mongolia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(150, 150, NULL, 'Montenegro', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(151, 151, NULL, 'Montserrat', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(152, 152, NULL, 'Morocco', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(153, 153, NULL, 'Mozambique', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(154, 154, NULL, 'Myanmar', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(155, 155, NULL, 'Namibia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(156, 156, NULL, 'Nauru', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(157, 157, NULL, 'Nepal', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(158, 158, NULL, 'Netherlands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(159, 159, NULL, 'Netherlands Antilles', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:19:11', '2024-12-07 15:19:11', 0),
(160, 160, NULL, 'New Caledonia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(161, 161, NULL, 'New Zealand', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(162, 162, NULL, 'Nicaragua', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(163, 163, NULL, 'Niger', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(164, 164, NULL, 'Nigeria', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(165, 165, NULL, 'Niue', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(166, 166, NULL, 'Norfolk Island', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(167, 167, NULL, 'Norway', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(168, 168, NULL, 'Oman', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(169, 169, NULL, 'Palau', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:20:39', '2024-12-07 15:20:39', 0),
(170, 170, NULL, 'Palestine, Autononymous Region', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(171, 171, NULL, 'Panama', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(172, 172, NULL, 'Papua New Guinea', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(173, 173, NULL, 'Paraguay', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(174, 174, NULL, 'Peru', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(175, 175, NULL, 'Philippines', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(176, 176, NULL, 'Portugal', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(177, 177, NULL, 'Puerto Rico', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(178, 178, NULL, 'Qatar', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:21:49', '2024-12-07 15:21:49', 0),
(179, 179, NULL, 'Reunion Island', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(180, 180, NULL, 'Romania', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(181, 181, NULL, 'Russian Federation', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(182, 182, NULL, 'Rwanda', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(183, 183, NULL, 'Saipan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(184, 184, NULL, 'Samoa (Western Samoa)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(185, 185, NULL, 'San Marino', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(186, 186, NULL, 'Sao Tome & Principe', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(187, 187, NULL, 'Saudi Arabia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(188, 188, NULL, 'Senegal', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(189, 189, NULL, 'Serbia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(190, 190, NULL, 'Seychelles', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:23:14', '2024-12-07 15:23:14', 0),
(191, 191, NULL, 'Sierra Leone', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(192, 192, NULL, 'Singapore', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(193, 193, NULL, 'Slovakia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(194, 194, NULL, 'Slovenia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(195, 195, NULL, 'Solomon Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(196, 196, NULL, 'Somalia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(197, 197, NULL, 'South Africa', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(198, 198, NULL, 'Spain', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(199, 199, NULL, 'Sri Lanka', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(200, 200, NULL, 'St. Barthelemy', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(201, 201, NULL, 'St. Helena', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(202, 202, NULL, 'St. Kitts & Nevis', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(203, 203, NULL, 'St. Lucia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:24:39', '2024-12-07 15:24:39', 0),
(204, 204, NULL, 'St. Martin (French)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(205, 205, NULL, 'St. Pierre & Miquelon', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(206, 206, NULL, 'St. Vincent & Grenardines', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(207, 207, NULL, 'Sudan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(208, 208, NULL, 'Suriname', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(209, 209, NULL, 'Swaziland', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(210, 210, NULL, 'Sweden', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(211, 211, NULL, 'Syria', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(212, 212, NULL, 'Switzerland', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(213, 213, NULL, 'Tahiti (French Polynesia)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(214, 214, NULL, 'Taiwan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(215, 215, NULL, 'Tajikistan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(216, 216, NULL, 'Tanzania', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:26:10', '2024-12-07 15:26:10', 0),
(217, 217, NULL, 'Thailand', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:27:04', '2024-12-07 15:27:04', 0),
(218, 218, NULL, 'Togo', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:27:04', '2024-12-07 15:27:04', 0),
(219, 219, NULL, 'Tokelau Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:27:04', '2024-12-07 15:27:04', 0),
(220, 220, NULL, 'Tonga', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:27:04', '2024-12-07 15:27:04', 0),
(221, 221, NULL, 'Trinidad & Tobago', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:27:04', '2024-12-07 15:27:04', 0),
(222, 222, NULL, 'Tunisia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:27:04', '2024-12-07 15:27:04', 0),
(223, 223, NULL, 'Turkey', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:27:04', '2024-12-07 15:27:04', 0),
(224, 224, NULL, 'Turkmenistan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:27:04', '2024-12-07 15:27:04', 0),
(225, 225, NULL, 'Turks & Caicos Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(226, 226, NULL, 'Tuvalu', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(227, 227, NULL, 'Uganda', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(228, 228, NULL, 'Ukraine', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(229, 229, NULL, 'United Arab Emirates (UAE)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(230, 230, NULL, 'United Kingdom', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(231, 231, NULL, 'United States Of America', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(232, 232, NULL, 'Uruguay', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(233, 233, NULL, 'US Virgin Islands (USVI)', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:28:25', '2024-12-07 15:28:25', 0),
(234, 234, NULL, 'Uzbekistan', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:30:45', '2024-12-07 15:30:45', 0),
(235, 235, NULL, 'Vietnam', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:30:45', '2024-12-07 15:30:45', 0),
(236, 236, NULL, 'Wallis & Futuna Islands', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:30:45', '2024-12-07 15:30:45', 0),
(237, 237, NULL, 'Western Sahara', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:30:45', '2024-12-07 15:30:45', 0),
(238, 238, NULL, 'Yemen', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:30:45', '2024-12-07 15:30:45', 0),
(239, 239, NULL, 'Zambia', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:30:45', '2024-12-07 15:30:45', 0),
(240, 240, NULL, 'Zimbabwe', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:30:45', '2024-12-07 15:30:45', 0),
(241, 241, NULL, 'Venezuela', NULL, 'product', NULL, 'active', 1, NULL, '2024-12-07 15:30:45', '2024-12-07 15:30:45', 0);
...
INSERT INTO `versions` (`id`, `name`, `status`, `created_at`, `updated_at`, `created_by`, `updated_by`, `is_trash`) VALUES
(1, 'Bangla', 'active', NULL, NULL, NULL, NULL, 0),
(2, 'English', 'active', NULL, NULL, NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `weekend_configurations`
--

CREATE TABLE `weekend_configurations` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `2023`
--
ALTER TABLE `2023`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `2023_n`
--
ALTER TABLE `2023_n`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `accountcategorys`
--
ALTER TABLE `accountcategorys`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `batch_import_table`
--
ALTER TABLE `batch_import_table`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cash_banks_version`
--
ALTER TABLE `cash_banks_version`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `companynotificationsettings`
--
ALTER TABLE `companynotificationsettings`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `contactwise_item_discount_price_list`
--
ALTER TABLE `contactwise_item_discount_price_list`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `contactwise_item_discount_price_list_version`
--
ALTER TABLE `contactwise_item_discount_price_list_version`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `contact_academics`
--
ALTER TABLE `contact_academics`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `contact_hierarchy`
--
ALTER TABLE `contact_hierarchy`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `contact_payable_items`
--
ALTER TABLE `contact_payable_items`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `contact_payable_items_version`
--
ALTER TABLE `contact_payable_items_version`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `due_generated`
--
ALTER TABLE `due_generated`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `due_generated_setting`
--
ALTER TABLE `due_generated_setting`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `due_generated_setting_history`
--
ALTER TABLE `due_generated_setting_history`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `due_import`
--
ALTER TABLE `due_import`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `employee_payroll_item_details`
--
ALTER TABLE `employee_payroll_item_details`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `employee_salary_item_details`
--
ALTER TABLE `employee_salary_item_details`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `employee_salary_item_details_version`
--
ALTER TABLE `employee_salary_item_details_version`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `employee_salary_version`
--
ALTER TABLE `employee_salary_version`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_address_category`
--
ALTER TABLE `enum_address_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_contact_type`
--
ALTER TABLE `enum_contact_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_department_types`
--
ALTER TABLE `enum_department_types`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_employee_types`
--
ALTER TABLE `enum_employee_types`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_month`
--
ALTER TABLE `enum_month`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_node_type`
--
ALTER TABLE `enum_node_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_participant_type`
--
ALTER TABLE `enum_participant_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_relation_of_node_type`
--
ALTER TABLE `enum_relation_of_node_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_relation_type_node_type`
--
ALTER TABLE `enum_relation_type_node_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enum_sms_type`
--
ALTER TABLE `enum_sms_type`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `generateinvoice`
--
ALTER TABLE `generateinvoice`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `generateinvoices`
--
ALTER TABLE `generateinvoices`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `generate_payable_list`
--
ALTER TABLE `generate_payable_list`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `generate_payroll`
--
...
--
-- Indexes for table `impr_attendance_table`
--
ALTER TABLE `impr_attendance_table`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `mark_attribute`
--
ALTER TABLE `mark_attribute`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `monthly_class_item`
--
ALTER TABLE `monthly_class_item`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `monthly_class_item_version`
--
ALTER TABLE `monthly_class_item_version`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `msgnotificationsents`
--
ALTER TABLE `msgnotificationsents`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `other_payment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `other_payment_sales_chart_id_foreign` (`sales_chart_id`);

--
-- Indexes for table `other_payment_details`
--
ALTER TABLE `other_payment_details`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `payment_history_version`
--
ALTER TABLE `payment_history_version`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `sales_chart`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `sales_chart_slug_unique` (`slug`);
...
ALTER TABLE `sales_payment`
  ...
  ADD KEY `sales_payment_dealer_id_foreign` (`dealer_id`);

--
-- Indexes for table `sales_payment_version`
--
ALTER TABLE `sales_payment_version`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sales_payment_sales_id_foreign` (`sales_id`),
  ADD KEY `sales_payment_dealer_id_foreign` (`dealer_id`);

--
-- Indexes for table `sales_product_relation`
--
ALTER TABLE `sales_product_relation`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sales_product_relation_sales_id_foreign` (`sales_id`),
  ADD KEY `sales_product_relation_product_id_foreign` (`product_id`);

--
-- Indexes for table `sales_product_relation_version`
--
ALTER TABLE `sales_product_relation_version`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sales_product_relation_sales_id_foreign` (`sales_id`),
  ADD KEY `sales_product_relation_product_id_foreign` (`product_id`);

--
-- Indexes for table `sales_version`
--
ALTER TABLE `sales_version`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sales_customer_id_foreign` (`customer_id`);
...
--
-- Indexes for table `section_relations`
--
ALTER TABLE `section_relations`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `sid_config`
--
ALTER TABLE `sid_config`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sms_batch_table`
--
ALTER TABLE `sms_batch_table`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `student_imp`
--
ALTER TABLE `student_imp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `student_marks_details_version`
--
ALTER TABLE `student_marks_details_version`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `subject_relations`
--
...
--
-- Indexes for table `weekend_configurations`
--
ALTER TABLE `weekend_configurations`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `accountcategorys`
--
ALTER TABLE `accountcategorys`
...
--
-- AUTO_INCREMENT for table `batch_import_table`
--
ALTER TABLE `batch_import_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `cash_banks_version`
--
ALTER TABLE `cash_banks_version`
...
--
-- AUTO_INCREMENT for table `companynotificationsettings`
--
ALTER TABLE `companynotificationsettings`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `contactwise_item_discount_price_list`
--
ALTER TABLE `contactwise_item_discount_price_list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `contactwise_item_discount_price_list_version`
--
ALTER TABLE `contactwise_item_discount_price_list_version`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `contact_academics`
--
ALTER TABLE `contact_academics`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `contact_hierarchy`
--
ALTER TABLE `contact_hierarchy`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `contact_payable_items`
--
ALTER TABLE `contact_payable_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `contact_payable_items_version`
--
ALTER TABLE `contact_payable_items_version`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `due_generated`
--
ALTER TABLE `due_generated`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `due_generated_setting`
--
ALTER TABLE `due_generated_setting`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `due_generated_setting_history`
--
ALTER TABLE `due_generated_setting_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `due_import`
--
ALTER TABLE `due_import`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `employee_payroll_item_details`
--
ALTER TABLE `employee_payroll_item_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `employee_salary_item_details`
--
ALTER TABLE `employee_salary_item_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `employee_salary_item_details_version`
--
ALTER TABLE `employee_salary_item_details_version`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `employee_salary_version`
--
ALTER TABLE `employee_salary_version`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `enum_address_category`
--
ALTER TABLE `enum_address_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `enum_contact_type`
--
ALTER TABLE `enum_contact_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `enum_department_types`
--
ALTER TABLE `enum_department_types`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `enum_employee_types`
--
ALTER TABLE `enum_employee_types`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `enum_month`
--
ALTER TABLE `enum_month`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `enum_node_type`
--
ALTER TABLE `enum_node_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `enum_participant_type`
--
ALTER TABLE `enum_participant_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `enum_relation_of_node_type`
--
ALTER TABLE `enum_relation_of_node_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `enum_relation_type_node_type`
--
ALTER TABLE `enum_relation_type_node_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `enum_sms_type`
--
ALTER TABLE `enum_sms_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `generateinvoice`
--
ALTER TABLE `generateinvoice`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `generateinvoices`
--
ALTER TABLE `generateinvoices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `generate_payable_list`
--
ALTER TABLE `generate_payable_list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `generate_payroll`
--
ALTER TABLE `generate_payroll`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `impr_attendance_table`
--
ALTER TABLE `impr_attendance_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `mark_attribute`
--
ALTER TABLE `mark_attribute`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `monthly_class_item`
--
ALTER TABLE `monthly_class_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `monthly_class_item_version`
--
ALTER TABLE `monthly_class_item_version`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `msgnotificationsents`
--
ALTER TABLE `msgnotificationsents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `node_edges`
--
ALTER TABLE `node_edges`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `other_payment_details`
--
ALTER TABLE `other_payment_details`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `payment_history_version`
--
ALTER TABLE `payment_history_version`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `salary_item`
--
ALTER TABLE `salary_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `sales_payment_version`
--
ALTER TABLE `sales_payment_version`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sales_product_relation`
--
ALTER TABLE `sales_product_relation`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sales_product_relation_version`
--
ALTER TABLE `sales_product_relation_version`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sales_version`
--
ALTER TABLE `sales_version`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `section_relations`
--
ALTER TABLE `section_relations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `sid_config`
--
ALTER TABLE `sid_config`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sms_batch_table`
--
ALTER TABLE `sms_batch_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `student_imp`
--
ALTER TABLE `student_imp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `student_marks_details`
--
ALTER TABLE `student_marks_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `student_marks_details_version`
--
ALTER TABLE `student_marks_details_version`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `subject_relations`
--
ALTER TABLE `subject_relations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `weekend_configurations`
--
ALTER TABLE `weekend_configurations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
