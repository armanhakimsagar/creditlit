...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Certificate::label.TRANSFER_CERTIFICATE')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i>@lang('Certificate::label.TRANSFER_CERTIFICATE')
        </h1>
                        ...
                        <div class="">
                            <div class="table-responsive">
                                ...
                                <div class="float-right"><button type="submit"
                                        class="btn btn-success ml-auto mt-5 waves-effect stprimarybutton waves-themed generate-button btn-sm"
