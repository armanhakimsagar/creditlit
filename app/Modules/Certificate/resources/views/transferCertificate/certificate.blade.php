                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="img-responsive company-logo text-center">
                                    <img src="{{ asset(config('app.asset') . 'image/transferCertificate/small.svg') }}"
                        ...
                        <div class="testimonial">
                            ...
                            <div class="col-xs-12">
                                <div class="testimonial-content">
                                    <!--<h1 class="testimonial-title"><span>Transfer Certificate</span></h1>-->
                                    <p>This is to certify that <strong
                                        ...
                                        @endif of <br>(Father) <strong
                                            class="info-strong father-name"><em>{{ $certificate->father_name }}</em></strong>
                                        (Mother)
                                        <strong
                                            class="info-strong mother-name"><em>{{ $certificate->mother_name }}</em></strong>
                                        <br>address <strong><em><span class="address input-bold">Vill.:
                                                    {{ $certificate->area }} P.S.:
                                                    {{ $certificate->upazila_name }}, Dist.:
                                                    {{ $certificate->district_name }}, Div.:
                                                    {{ $certificate->division_name }}</span></em></strong><br>
                                        ...
                                        <!-- has passed the Final Examination in the year
                      <strong class="info-strong"></strong> and obtained G.P.A. <input type="text" class='custom-input'/> in the scale of 5.00.</p>    -->
                                    </p>
                                    <p>
                                        ...
                                        @endif date of birth is <strong class="info-strong">
                                            {{ date('d-m-Y', strtotime($certificate->date_of_birth)) }}.</strong> </p>
                                    <p>
                                        @if ($certificate->student_gender == 'male')
                                            He
                                        @else
                                            She
                                        @endif cleared all the dues upto
                                    ...
                                    <p></p>
                                    <div class="row tc-footer">
                                        <div class="col-xs-6">
                                            <div class="tc-content-left">
                                                <p>1. The reason for leaving School/College</p>
                                                <ul>
                                                    <li>a. Change of living place</li>
                                                    <li>b. Desire of guardian</li>
                                                    <li>c. Other reasons</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="tc-content-right">
                                                <div class="top-content">
                                                    <p>2. Elective Subject</p>
                                                    <ul>
                                                        <li>a. </li>
                                                        <li>b. </li>
                                                        <li>c. </li>
