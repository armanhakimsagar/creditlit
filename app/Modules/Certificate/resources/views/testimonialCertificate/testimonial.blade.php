    ...
    <style>
       ...
       */
        ...
        /*.testimonial-content:before{
            position: absolute;
            content: url('https://ems.darulazharbd.com/images/watermark.png');
            top: 15%;
            left: 37%;
        }*/
...
<body class="print_div" id="print-div1" data-new-gr-c-s-check-loaded="14.1084.0" data-gr-ext-installed=""
    data-new-gr-c-s-loaded="14.1084.0">
    <div class="text-center">
        <button class="btn btn-info btn-md avoid print" id="print"
            style="margin: 1em 0; float: right;color: #fff;background-color: #17a2b8; border-color: #17a2b8;"
            type="button">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="img-responsive company-logo text-center">
                                    <img src="{{ asset(config('app.asset') . 'image/testimonial/smalltestmonial.svg') }}"
                                        alt="testimonial-header.svg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial">
                            ...
                            <div class="col-xs-12">
                                <div class="testimonial-content">
                                    <!--
                    <h1 class="testimonial-title"><span>Testimonial</span></h1> -->
                                    <p>This is to certify that <strong
                                            class="info-strong"><em>{{ $certificate->student_name }}</em></strong>
                                        is @if ($certificate->student_gender == 'male')
                                            son
                                        @else
                                            daughter
                                        @endif of <strong
                                            class="info-strong"><em>{{ $certificate->father_name }}</em></strong> and
                                        <strong class="info-strong"><em>{{ $certificate->mother_name }}</em></strong>


                                        was a student of {{ $companyDetails->company_name }}


                                        bearing Roll No <strong
                                            class="info-strong"><em>{{ $certificate->class_roll }}</em></strong>
                                        Section <strong
                                            class="info-strong"><em>{{ $certificate->section_name }}</em></strong>
                                        Class <strong
                                            class="info-strong"><em>{{ $certificate->class_name }}</em></strong>
                                        and Session <strong
                                            class="info-strong"><em>{{ $certificate->year }}</em></strong>.
                                        @if ($certificate->student_gender == 'male')
                                            He
                                        @else
                                            She
                                        @endif has passed the Final Examination in the year
                                        <strong class="info-strong"><em>{{ $certificate->year }}</em></strong>.
                                        <!-- and obtained G.P.A. <strong> 5.00</strong> in the scale of 5.00.-->
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        @else
                                            She
                                        @endif is a diligent student and possesses fine moral
                                        character. To the best of my
                                        knowledge, @if ($certificate->student_gender == 'male')
                                            he
                                        @else
                                            she
                                        @endif did not take part in any activity subversive of the
                                        state or of
                                        nation and in any in disciplinary activity against the school during
                                        @if ($certificate->student_gender == 'male')
                                            his
                                        @else
                                            her
                                        @endif
                                        educational period here.
                                    </p>
                                    <p>I wish @if ($certificate->student_gender == 'male')
                                            his
                                        @else
                                            her
                                        @endif every success in life.</p>
