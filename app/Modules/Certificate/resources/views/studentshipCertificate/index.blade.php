...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">@lang('Certificate::label.CERTIFICATE')</li>
        <li class="breadcrumb-item active">@lang('Certificate::label.STUDENTSHIP')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i>@lang('Certificate::label.STUDENTSHIP_CERTIFICATE')
        </h1>
                    ...
                    <div class="body">
                        <div class="">
                            <div class="table-responsive">
                                {!! Form::open([
                                    'id' => 'studentshipCertificate',
                                    'route' => 'generate.studentship.certificate',
                                ...
                                <div class="float-right"><button type="submit"
                                        class="btn btn-sm btn-success ml-auto mt-5 waves-effect waves-themed generate-button"
            ...
            $(document).on('click', '#searchBtn', function() {
                ...
                if ($("#class_id").val() != 0 && $("#academicYearId").val() != 0) {
                    ...
                    var table = $('#yajraTable').DataTable({
                        ...
                        iDisplayLength: 50,
                        ajax: {
                            "url": "{{ route('transfer.certificate.index') }}",
                            "data": function(e) {
