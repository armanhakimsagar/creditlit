    ...
    <div class="col-md-3l-12">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i> @lang('Contact::label.KEY_PERSONNEL') @lang('Student::label.DETAILS')
            </h1>
            <a style="margin-left: 10px;" href="{{ route('keypersonnel.create') }}"
                class="btn btn-primary btn-sm waves-effect pull-right">@lang('Student::label.ADD') @lang('Contact::label.KEY_PERSONNEL')</a>
        </div>
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <div class="col-4">
                    <h2>
                        @lang('Contact::label.KEY_PERSONNEL') <span class="fw-300"><i>@lang('Student::label.LIST')</i></span>
                    </h2>
                </div>
                <div class="col-8">
                    <a href="{{ route('keypersonnel.trash') }}" class="btn btn-danger btn-sm waves-effect float-right"
                                    ...
                                    <table class="table table-bordered table-striped ytable" id="yajraTable">
                                        <thead class="thead-themed">
                                            <tr>
                                                ...
                                                <th> Spouse Name</th>
                                                <th> Child Name</th>
                                                <th> Current Bank/Branch or Company Name</th>
                                                <th> Previous Bank/Branch or Company Name</th>
                                                <th> Status</th>
                                                <th> Action</th>
                                            </tr>
                                        </thead>
            ...
            $(function() {
                ...
                var table = $('#yajraTable').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'current_job_place',
                            name: 'current_job_place'
                        },
                        {
                            data: 'previous_job_place',
                            name: 'previous_job_place'
                        },
                        {
                            data: 'status',
                            name: 'status'
