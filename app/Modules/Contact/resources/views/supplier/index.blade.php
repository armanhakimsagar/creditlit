    ...
    <div class="col-md-3l-12">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i> @lang('Contact::label.SUPPLIER') @lang('Student::label.DETAILS')
            </h1>
            <a style="margin-left: 10px;" href="{{ route('supplier.create') }}"
                class="btn btn-primary btn-sm waves-effect pull-right">@lang('Student::label.ADD') @lang('Contact::label.SUPPLIER')</a>
        </div>
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <div class="col-4">
                    <h2>
                        @lang('Contact::label.SUPPLIER') <span class="fw-300"><i>@lang('Student::label.LIST')</i></span>
                    </h2>
                </div>
                <div class="col-8">
                    <a href="{{ route('supplier.trash') }}" class="btn btn-danger btn-sm waves-effect float-right"
