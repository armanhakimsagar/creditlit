...
@section('body')
    ...
    <div class="subheader">
        ...
        <a style="margin-left: 10px;" href="{{ route('gift.index') }}"
            class="btn btn-success btn-sm waves-effect pull-right">@lang('Student::label.ALL') @lang('Contact::label.GIFT')</a>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel pb-5">
                <div class="panel-hdr">
                    <h2>
                        @lang('Contact::label.GIFT') @lang('Student::label.INFO') :
                    </h2>
                </div>
