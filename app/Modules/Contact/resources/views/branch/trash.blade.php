...
@section('body')
    ...
    <div class="col-md-3l-12">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('Contact::label.BRANCH') @lang('Student::label.TRASH')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i> @lang('Contact::label.BRANCH') @lang('Student::label.TRASH')
            </h1>
            <a style="margin-left: 10px;" href="{{ route('branch.index') }}"
                class="btn btn-primary btn-sm waves-effect pull-right">@lang('Student::label.ALL') @lang('Contact::label.BRANCH')</a>
        </div>
