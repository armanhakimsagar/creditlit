...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Contact::label.SELECTED') @lang('Contact::label.BRANCH') @lang('Contact::label.ALL') @lang('Report::label.ORDER')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-list'></i> @lang('Contact::label.SELECTED') @lang('Contact::label.BRANCH') @lang('Contact::label.ALL')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="panel-content">
                        {!! Form::open([
                            'route' => 'selected.branch.order.filter',
                            'method' => 'get',
                        ...
                        <div class="row"id="notPrintDiv">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label class="col-form-label">Branch Name</label><span class="required"> *</span>

                                        {!! Form::Select('customer_id', $branchId, isset($request->customer_id) ? $request->customer_id : null, [
                                            'id' => 'customer_id',
