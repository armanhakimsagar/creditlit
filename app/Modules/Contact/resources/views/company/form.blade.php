                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mt-3">
                        <div class="form-group">
                            <div class="form-line">
                                {!! Form::label('full_name', 'Company Name:', ['class' => 'col-form-label']) !!}<span class="required"> *</span>
                    ...
                    <div class="col-lg-3 col-md-6 mt-3">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                {!! Form::Select('key_personnel', $keyPersonnel, isset($company) ? $company->key_personnel_id : null, [
                                    'id' => 'keyPersonnel',
