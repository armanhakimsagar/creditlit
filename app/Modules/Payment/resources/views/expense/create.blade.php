...
@section('body')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Payment::label.ADD') @lang('Payment::label.EXPENSE')</li>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('Payment::label.EXPENSE')<span class="fw-300"><i>@lang('Payment::label.ADD')</i></span>
                    </h2>
