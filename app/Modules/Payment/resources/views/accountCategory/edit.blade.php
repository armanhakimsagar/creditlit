    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('Payment::label.ACCOUNT') @lang('Payment::label.CATEGORY')<span class="fw-300"><i>@lang('Payment::label.UPDATE')</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        {!! Form::model($accountCategory, [
                            'method' => 'PATCH',
                            'route' => ['account.category.update', $accountCategory->id],
                            ' class' => '',
                            'id' => 'accountCategory',
                        ]) !!}
