    ...
    <div class="col-md-12">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i> @lang('Payment::label.DUELIST')
            </h1>
        </div>
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <div class="col-4">
                    <h2>
                        @lang('Payment::label.DUE') <span class="fw-300"><i>@lang('Student::label.LIST')</i></span>
                    </h2>
                </div>
            </div>
