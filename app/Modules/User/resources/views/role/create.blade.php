...
@endpush
    ...
    <div class="subheader">
        ...
        <a style="margin-left: 10px;" href="{{route('role.index')}}"
            class="btn btn-success btn-sm waves-effect pull-right">@lang('User::label.ALL') @lang('User::label.ROLES')</a>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('User::label.ROLE') <span class="fw-300"><i>@lang('User::label.ADD')</i></span>
                    </h2>
                </div>
