    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('Mark::label.MARK') @lang('Mark::label.ATTRIBUTE') <span class="fw-300"><i>@lang('Academic::label.EDIT')</i></span>
                    </h2>
                </div>
                <div class="panel-container show">
                    <div class="panel-content">

                    {!! Form::model($data, ['method' => 'PATCH', 'route' => ['mark.attribute.update',$data->id], 'id' => 'markAttribute']) !!}
