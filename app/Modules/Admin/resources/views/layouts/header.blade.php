@if (!empty(Auth::guard()->user()) > 0)
    <header class="page-header" role="banner">
        ...
        <div class="page-logo">
            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative"
                ...
                <img src="{{ asset(config('app.asset') . 'img/logo.png') }}" alt="SmartAdmin WebApp"
                    aria-roledescription="logo">
                <span class="page-logo-text mr-1">DMS</span>
        ...
        <div class="ml-auto d-flex">
            ...
            <!-- app settings -->
            <div class="hidden-md-down mt-4">
                <span>Welcome! {{ Auth::guard()->user()->first_name }} {{ Auth::guard()->user()->last_name }}</span>
                        ...
                        <div class="tab-pane active p-3 text-center">
                            <h5 class="mt-4 pt-4 fw-500">
                                ...
                                <small class="mt-3 fs-b fw-400 text-muted">
                                    ...
                                    message here automatically through
                            ...
                            <div class="custom-scroll h-100">
                                <ul class="notification">
                                    ...
                                    <li>
                                        <a href="#" class="d-flex align-items-center">
                                            <span class="status status-success mr-2">
                                                <img src="img/demo/avatars/avatar-m.png"
                                                    data-src="img/demo/avatars/avatar-h.png"
                                                    class="profile-image rounded-circle" alt="Sarah McBrook" />
                                                <span class="profile-image rounded-circle d-inline-block"
            ...
            <!-- app user menu -->
            <div>
                <a href="#" data-toggle="dropdown" title="{{ Auth::guard()->user()->email }}"
                    class="header-icon d-flex align-items-center justify-content-center ml-2">
                    @if (Auth::guard()->user()->image != null &&
                            File::exists(public_path('backend/images/users/' . Auth::guard()->user()->image)))
                        <img src="{{ asset(config('app.asset') . 'backend/images/users/' . Auth::guard()->user()->image) }}"
                            class="profile-image rounded-circle" alt="{{ Auth::guard()->user()->email }}">
                    @else
                ...
                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                            ...
                            File::exists(public_path('backend/images/users/' . Auth::guard()->user()->image)))
                                    <img src="{{ asset(config('app.asset') . 'backend/images/users/' . Auth::guard()->user()->image) }}"
                                        class="rounded-circle profile-image" alt="{{ Auth::guard()->user()->email }}">
                                @else
                                    <img src="{{ asset(config('app.asset') . 'backend/images/users/profile.png') }}"
                                        class="rounded-circle profile-image"
                                        alt="{{ Auth::guard()->user()->email }}">
                                @endif
                            ...
                            <div class="info-card-text">
                                ...
                                <span
                                    class="text-truncate text-truncate-md opacity-80">{{ Auth::guard()->user()->email }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="{{ route('user.profile.edit', Auth::guard()->user()->id) }}" class="dropdown-item">
                        <span>Edit Profile</span>
                    </a>
                    <a href="{{ route('user.password.edit', Auth::guard()->user()->id) }}" class="dropdown-item">
    ...
    {{-- <a type="button" href="{{ route('logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();" class="btn btn-danger"
                           style="margin-top: 17px;height: 40px;background: #f44336;">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Release History</h2>
...
<div class="modal fade" id="default-example-modal-lg-center" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">EMI Canculator</h2>
                {{-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fal fa-times"></i></span>
                    </button> --}}
            </div>
                ...
                <table class="table table-display">
                    <form action="">
                        <tr>
                            ...
                            <td>Select EMI Type</td>
                            <td>Interest Rate</td>
                        </tr>
                        <tr>
                            <td><input type="text" class="only-number-accept-in form-control" required
                                    name="principal" id="principal_id" placeholder="Enter The Principal Amount"
                                    value="0">
                                <span class="principal_err text-danger"></span>
                            </td>
                            <td>
                                <select name="emi" required class="form-control" id="emi_option">
                                    <option value="1">Flat Rate</option>
                                    <option value="2">Balance Reducing</option>
                                </select>
                            </td>
                            <td><input required type="text" name=""
                                    class="only-number-accept-in form-control" id="interest_rate">
                                <span class="interest_err text-danger"></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><input type="text" required name="" id="number_of_installment"
                                    class="only-number-accept-in form-control">
                                <span class="installment_err text-danger"></span>
                            </td>
                            <td>
                                <select name="" required class="form-control" id="interest_period">
                            ...
                            <td>
                                <select name="" required class="form-control" id="payment_process">
                                    <option value="1">Weekly</option>
                                    <option value="2">Bi-Weekly</option>
                                    <option value="3">Monthly</option>
                                    <option value="4">Yearly</option>
                        ...
                        <tr>
                            <td><input type="button" class="emi_calculator" name="calculate_emi"
                                    onclick="calculateEmi()" value="Calculate" id="cal_emi"></td>
                        </tr>
                    </form>
                </table>
                <h3>Total Payable Amount: <span class="total_payable"></span>Tk/-</h3>
                <h4>Payable Amount/Installment: <span class="per_installment"></span>Tk/-</h4>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
...
<script>
    function calculateEmi() {
        let principal_amount = $("#principal_id").val();
        let emi = $("select#emi_option option").filter(":selected").val();
        let interest_rate = $("#interest_rate").val();
        let number_of_installment = $("#number_of_installment").val();
        let payment_process = $("select#payment_process option").filter(":selected").val();
        let interest_period = $("select#interest_period option").filter(":selected").val();
        // console.log(payment_process);
        var installment_payable;
        var total_payable;
        var monthly_emi;
        var weekly_emi;
        var by_weekly_emi;
        ...
        if (interest_period == '2') {
            interest_rate = interest_rate * 26;
        }
        if (interest_period == '3') {
            interest_rate = interest_rate * 12;
        }
        if (interest_period == '4') {
            interest_rate = interest_rate * 1;
        }
        // var yearly_emi;
        if (number_of_installment && emi && principal_amount && interest_rate && payment_process) {
            $(".installment_err").html('');
            $(".principal_err").html('');
            $(".interest_err").html('');
            if (emi == 1) {
                //    console.log('yes');
                if (payment_process == 3) {
                    payment_process = parseInt(payment_process);
                    principal_amount = parseInt(principal_amount);
                    interest_rate = parseInt(interest_rate);
                    interest_rate = interest_rate / 100;
                    number_of_installment = parseInt(number_of_installment);
                    let yr = number_of_installment / 12;
                    monthly_emi = (principal_amount * (1 + (interest_rate * yr)));
                    total_payable = monthly_emi;
                    monthly_emi = monthly_emi / number_of_installment;
                    installment_payable = monthly_emi;
                    $(".total_payable").html(total_payable);
                    $(".per_installment").html(installment_payable);
                    console.log(monthly_emi);
                }
                if (payment_process == 1) {
                    ...
                    interest_rate = interest_rate / 100;
                    number_of_installment = parseInt(number_of_installment);
                    let yr = number_of_installment / 52;
                    total_payable = (principal_amount * (1 + (interest_rate * yr)));
                    installment_payable = (total_payable / number_of_installment);
                    $(".total_payable").html(total_payable);
                    $(".per_installment").html(installment_payable);
                    console.log(installment_payable);
                }
                if (payment_process == 2) {
                    ...
                    $(".total_payable").html(total_payable);
                    $(".per_installment").html(installment_payable);
                    console.log(by_weekly_emi);

                }
                if (payment_process == 4) {
                    payment_process = parseInt(payment_process);
                    principal_amount = parseInt(principal_amount);
                    interest_rate = parseInt(interest_rate);
                    interest_rate = interest_rate / 100;
                    number_of_installment = parseInt(number_of_installment);
                    let yr = number_of_installment;
                    total_payable = (principal_amount * (1 + (interest_rate * yr)));
                    installment_payable = total_payable / number_of_installment;
                    $(".total_payable").html(total_payable);
                    $(".per_installment").html(installment_payable);
        ...
        if (!number_of_installment || number_of_installment <= 0) {
            $(".installment_err").html("Please Insert a Valid Number of Installment");
        }
        if (!principal_amount || principal_amount <= 0) {
            $(".principal_err").html("Please Insert a Valid Principal Amount");
        }
        if (!interest_rate || interest_rate <= 0) {
            $(".interest_err").html("Please Insert Number of install ment");
        }
