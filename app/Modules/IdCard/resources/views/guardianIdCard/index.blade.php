...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Admin::label.GUARDIAN') @lang('Admin::label.ID_CARD_GENERATE')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i>@lang('Admin::label.GUARDIAN') @lang('Admin::label.ID_CARD_GENERATE')
        </h1>
                    ...
                    <div class="body">
                        <div class="">
                            <div class="table-responsive">
                                {!! Form::open([
                                    'id' => 'guardianIdCardGenerate',
                                    'route' => 'generate.guardian.id.card',
            ...
            $(document).on('click', '#searchBtn', function() {
                ...
                if ($("#class_id").val() != 0 && $("#academicYearId").val() != 0) {
                    ...
                    var table = $('#yajraTable').DataTable({
                        ...
                        iDisplayLength: 50,
                        ajax: {
                            "url": "{{ route('all.guardian.id.card.index') }}",
                            "data": function(e) {
