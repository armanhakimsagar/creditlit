    ...
    <div class="col-xl-12">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-th-list text-primary"></i> @lang('Item::label.CATEGORY') @lang('Academic::label.LIST')
            </h1>
            <a href="{{route('category.create')}}" class="btn btn-primary  btn-sm waves-effect pull-right m-l-10">@lang('Academic::label.ADD')
                @lang('Item::label.CATEGORY')</a>
        </div>
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    @lang('Item::label.CATEGORY') <span class="fw-300"><i>List</i></span>
                </h2>
