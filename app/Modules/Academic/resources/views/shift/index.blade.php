    ...
    <div class="col-xl-12">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-th-list text-primary"></i> @lang('Academic::label.SHIFT_LIST')
            </h1>
            <a href="{{ route('shift.create') }}" class="btn btn-primary  btn-sm waves-effect pull-right m-l-10">Add
                Shift</a>
        </div>
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <div class="col-4">
                    <h2>
                        @lang('Academic::label.SHIFT') <span class="fw-300"><i>@lang('Academic::label.LIST')</i></span>
                    </h2>
                </div>
                <div class="col-8">
                    <a href="{{ route('shift.trash') }}" class="btn btn-danger btn-sm waves-effect float-right"
