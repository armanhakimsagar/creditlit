...
@section('body')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Academic::label.EDIT_ACADEMIC_YEAR')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i> @lang('Academic::label.EDIT_ACADEMIC_YEAR')
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('Academic::label.ACADEMIC_YEAR') <span class="fw-300"><i>Edit</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        {!! Form::model($data, ['method' => 'PATCH', 'route'=> ['academic.year.update', $data->id]," class"=>"", 'id' => 'academicYear']) !!}
