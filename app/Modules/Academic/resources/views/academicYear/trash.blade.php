...
@section('body')
    <div class="col-xl-12">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('Academic::label.DELETED') @lang('Academic::label.ACADEMIC_YEAR')</li>
        ...
        <div class="subheader">
            ...
            <a href="{{ route('academic.year.index') }}" class="btn btn-primary  btn-sm waves-effect pull-right m-l-10">
                @lang('Academic::label.TRANSPORT')</a>
        </div>
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    @lang('Academic::label.ACADEMIC_YEAR') <span class="fw-300"><i>List</i></span>
                </h2>
            </div>
        ...
        <script type="text/javascript">
            $(function() {
                var table = $('#yajraTable').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('academic.year.trash') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex'
                        },
