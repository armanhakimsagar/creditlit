    ...
    <div class="col-xl-12">
        ...
        <div class="subheader">
            ...
            <a href="{{ route('group.create') }}"
                class="btn btn-sm btn-primary waves-effect pull-right m-l-10">@lang('Academic::label.ADD_GROUP')</a>
        </div>
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <div class="col-4">
                    <h2>
                        @lang('Academic::label.GROUP') <span class="fw-300"><i>@lang('Academic::label.LIST')</i></span>
                    </h2>
                </div>
                <div class="col-8">
