...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="form-line">
                {!! Form::label('name', 'Student Type Name', array('class' => 'col-form-label')) !!}<span
                        class="required"> *</span>
           ...
           <div class="col-md-10">
            ...
            <div class="col-md-2">
                ...
                <div class=" float-right mt-5">
                    <button class="btn btn-primary btn-sm ml-auto waves-effect waves-themed"  id="btnsm"   type="submit">Save</button>
                </div>
            </div>    
        </div>   
    </div>
