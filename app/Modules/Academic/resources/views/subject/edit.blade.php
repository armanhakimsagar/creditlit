...
@section('body')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">@lang('Academic::label.SUBJECT_SETUP')</li>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('Academic::label.SUBJECT') <span class="fw-300"><i>@lang('Academic::label.EDIT')</i></span>
                    </h2>
                </div>
                <div class="panel-container show">
                    <div class="panel-content">

                    {!! Form::model($subject, ['method' => 'PATCH', 'route' => ['subject.update',$subject->id], 'id' => 'subject']) !!}
