...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Academic::label.ADD_VERSION')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i> @lang('Academic::label.ADD_VERSION')
            {{-- <small>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('Academic::label.VERSION') <span class="fw-300"><i>Add</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    ...
                    {!! Form::open([ 'route'=> 'version.store', 'files'=> true, 'id'=>'version', 'class' => 'form-horizontal']) !!}
