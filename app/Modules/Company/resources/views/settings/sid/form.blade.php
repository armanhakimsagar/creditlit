        ...
        <div class="form-group">
            <div class="form-line">
                <div class="custom-control custom-switch">
                    <br>
                          <br>
                    <input type="radio" class="custom-control-input" value="1" id="customSwitch2radio" name="defaultManualCustomizeSID" onclick="forSIDShow();">
            ...
            <div class="form-line">
                <div class="form-line">
                    <div class="custom-control custom-switch">
                        <br>
                      <br>
                        <input type="radio" class="custom-control-input"  value="2" checked id="customSwitch1radio" name="defaultManualCustomizeSID" onclick="forSIDShow();">
            ...
            <div class="form-line">
                <div class="form-line">
                    <div class="custom-control custom-switch">
                        <br>
                      <br>
                        <input type="radio" class="custom-control-input" value="3" id="customSwitch1" name="defaultManualCustomizeSID" onclick="forSIDShow();">
        ...
        <div class="form-group">
            <div class="form-line">
                ...
                <input id="digit" name="digits" type="number" value="{{ !empty($data->digits) ? $data->digits : '' }}" class="form-control"
                       required="required" autocomplete="off" placeholder="0000"
                       aria-required="true" required="">
                <div class="input-group-append">
                    {{-- <span class="input-group-text">px</span> --}}
                </div>
...
function SalesDateSignShow()
{
var cbs = $("input[name='sales_date_format']");

if (cbs.is(":checked")) {
$('.sales_date_sign').show();
// $('#viewcal').show();
} 
else {
    $('.sales_date_sign').hide();
