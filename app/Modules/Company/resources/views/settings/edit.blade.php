...
@section('body')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Company::label.UPDATE') @lang('Company::label.SETTINGS')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i> @lang('Company::label.UPDATE') @lang('Company::label.INSTITUTION')
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('Company::label.INSTITUTION') <span class="fw-300"><i>@lang('Company::label.UPDATE')</i></span>
                    </h2>
