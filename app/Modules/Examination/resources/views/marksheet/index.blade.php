...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Examination::label.ALL_STUDENT_RESULT')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i>@lang('Examination::label.ALL_STUDENT_RESULT')
        </h1>
                ...
                <div class="card-body">
                    <div class="row" id="notPrintDiv">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <div class="form-line">
                                    <label for="examId" class='col-form-label'>Select Exam</label><span class="required">
                                        *</span>
            ...
            $(document).on('click', '#searchBtn', function() {
                ...
                if ($("#class_id").val() != 0 && $("#academicYearId").val() != 0 && $("#examId").val() !=
                    ...
                    var table = $('#yajraTable').DataTable({
                        ...
                        iDisplayLength: 50,
                        ajax: {
                            "url": "{{ route('all.student.result.index') }}",
                            "data": function(e) {
