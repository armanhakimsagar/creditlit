...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Examination::label.ADD_EXAM_TYPE')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i> @lang('Examination::label.ADD_EXAM_TYPE')
            {{-- <small>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        @lang('Examination::label.EXAM_TYPE') <span class="fw-300"><i>@lang('Academic::label.ADD')</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    ...
                    {!! Form::open([ 'route'=> 'exam_type.store', 'files'=> true, 'id'=>'exam_type', 'class' => 'form-horizontal']) !!}
