...
@section('body')
    <div class="col-xl-12">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"> @lang('Examination::label.SUBJECT_WISE_RESULT')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date">Sunday, April 12,
                    2020</span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-th-list text-primary"></i> @lang('Examination::label.SUBJECT_WISE_RESULT')
            </h1>
        </div>
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    @lang('Examination::label.SUBJECT_WISE_RESULT') <span class="fw-300"><i> @lang('Examination::label.LIST')</i></span>
                </h2>
