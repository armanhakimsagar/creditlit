...
@section('body')
    ...
    <div class="col-md-3l-12">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('Contact::label.DELIVERED') @lang('Contact::label.ORDER')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i> @lang('Contact::label.DELIVERED') @lang('Contact::label.ORDER') @lang('Student::label.DETAILS')
            </h1>
        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <div class="col-4">
                    <h2>
                        @lang('Contact::label.DELIVERED') @lang('Contact::label.ORDER') <span class="fw-300"><i>@lang('Student::label.LIST')</i></span>
                    </h2>
                </div>
            </div>
