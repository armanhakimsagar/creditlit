...
@section('body')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-list'></i> Download Report
        </h1>
                            ...
                            <tbody>
                                @foreach ($reports as $report)
                                    <tr>
                                        ...
                                        <td>{{ $report->orgId }}</td>
                                        <td><a href="{{ route('download.report', ['orderId' => $report->orderId]) }}"
                                                class="btn btn-success btn-sm">Download Now</a></td>
