...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">@lang('Report::label.REPORTS')</li>
        <li class="breadcrumb-item active">@lang('Report::label.ACCOUNT') @lang('Report::label.CLEARENCE') @lang('Report::label.REPORTS')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i>@lang('Report::label.ACCOUNT') @lang('Report::label.CLEARENCE') @lang('Report::label.REPORTS')
        </h1>
                    ...
                    <div class="body">
                        <div class="">
                            <div class="table-responsive">
                                {!! Form::open([
                                    'route' => 'account.clearence.generate',
                                    'id' => 'accountClearenceGenerate',
                                ...
                                <table class="table table-bordered myTable show-table" id="yajraTable">
                                    <thead class="">
                                        <tr>
                                            ...
                                            <th width="5%" class="">Photo</th>
                                            <th width="30%" class="">Student Name</th>
                                            <th width="15%" class="">Session/Year</th>
                                            <th width="20%" class="">Class Name</th>
    ...
    <script>
        $(function() {
            $(document).on('click', '#searchBtn', function() {
                ...
                if ($("#class_id").val() != 0 && $("#academicYearId").val() != 0) {
                    ...
                    var table = $('#yajraTable').DataTable({
                        ...
                        iDisplayLength: 50,
                        ajax: {
                            "url": "{{ route('account.clearence.index') }}",
                            "data": function(e) {
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, row) {
                                    if(data){
                                        return '<img src="{{ asset(config('app.asset')) }}/backend/images/students/' + data + '" height="30" />';
                                    }else{
                                        return '<img src="{{ asset(config('app.asset')) }}/backend/images/students/profile.png" height="30" />';
                                    }
                                }
                            },
                            {
            ...
            $(document).on('click', '.generate-button', function(e) {
                ...
                if (countChecked > 0) {
                    $("#accountClearenceGenerate").submit();
                    return (true);
                } else {
                    return (false);
                }
