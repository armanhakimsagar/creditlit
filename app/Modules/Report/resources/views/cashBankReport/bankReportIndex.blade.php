...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active"> @lang('Report::label.BANK') @lang('Report::label.BOOK') @lang('Student::label.REPORTS')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-list'></i> @lang('Report::label.BANK') @lang('Report::label.BOOK') @lang('Student::label.REPORTS')
        </h1>
                    ...
                    <div class="panel-content">
                        ...
                        @if ($request->search == 'true')
                            ...
                            <div id='printMe'>
                                ...
                                <center>
                                    <h5 style="margin-bottom: 0px;"><strong>@lang('Report::label.BANK') @lang('Report::label.BOOK')
                                                                ...
                                                                <td class="text-center">
                                                                    @if (isset($values->customer_id))
                                                                        @if ($customerName->type == 1)
                                                                            <a href="{{ route(app('studentName'), $customerName->id) }}"
                                                                                target="_blank"
