...
@section('body')
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('Sms::label.GUARDIAN') @lang('Sms::label.SMS')</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i>@lang('Sms::label.GUARDIAN') @lang('Sms::label.SMS')
        </h1>
